...
---
<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `AuthenticationListener`
- [← 本领域 / 返回 campaign-ext](./)
- [↑ API 目录](../)
- [🏠 首页 v1.4.5](../../)
- [⭐ 版本架构](../../architecture/)
...
**File:** `Bannerlord.Source/bin/TaleWorlds.PlatformService.GOG/TaleWorlds.PlatformService.GOG/AuthenticationListener.cs`
