...
**Purpose:** Reads and returns the available ranked game modes value held by the this instance.
...
**Purpose:** Reads and returns the available custom game modes value held by the this instance.
...
**Purpose:** Reads and returns the available quick play game modes value held by the this instance.
...
**Purpose:** Reads and returns the available matchmaker regions value held by the this instance.
...
**Purpose:** Reads and returns the user default region value held by the this instance.
...
**Purpose:** Reads and returns the user current region value held by the this instance.
...
**Purpose:** Reads and returns the user selected game types value held by the this instance.
