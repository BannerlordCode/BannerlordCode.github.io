...
**File:** `bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.GameMenu.TownManagement/SettlementBuildingProjectVM.cs`
...
// Obtain an instance of SettlementBuildingProjectVM from the subsystem API first
SettlementBuildingProjectVM settlementBuildingProjectVM = ...;
settlementBuildingProjectVM.ExecuteAddRemoveToQueue();
```
