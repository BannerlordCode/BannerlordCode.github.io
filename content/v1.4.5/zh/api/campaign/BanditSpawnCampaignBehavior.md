...
**用途 / Purpose:** **用途 / Purpose:** 为 initial hideouts 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnBanditsAroundHideoutAtNewGame 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnLootersAtNewGame 对应的操作。
