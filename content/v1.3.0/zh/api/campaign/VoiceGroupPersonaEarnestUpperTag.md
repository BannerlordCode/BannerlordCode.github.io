...
description: "VoiceGroupPersonaEarnestUpperTag 的自动生成类参考。"
---
...
**File:** `TaleWorlds.CampaignSystem/Conversation/Tags/VoiceGroupPersonaEarnestUpperTag.cs`
...
```csharp
// 先通过子系统 API 拿到 VoiceGroupPersonaEarnestUpperTag 实例
