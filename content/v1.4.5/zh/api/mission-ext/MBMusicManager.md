...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 campaign theme 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 campaign dramatic theme with culture 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 sea campign music 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 battle theme 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 siege theme 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 battle end theme 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 creation completed 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 在 campaign music handler init 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 campaign music handler finalize 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 battle music handler init 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 battle music handler finalize 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 silenced music handler init 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 silenced music handler finalize 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 激活battle mode对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 停用battle mode对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 激活campaign mode对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 停用campaign mode对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 停用current mode对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 UnpauseMusicManagerSystem 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PauseMusicManagerSystem 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 启动theme流程或状态机。
...
**用途 / Purpose:** **用途 / Purpose:** 启动theme with constant intensity流程或状态机。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ForceStopThemeWithFadeOut 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChangeCurrentThemeIntensity 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 battle turns one side theme 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 campaign music theme 的结果。
