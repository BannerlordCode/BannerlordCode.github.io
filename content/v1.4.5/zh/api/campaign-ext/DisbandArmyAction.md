...
**用途 / Purpose:** 将 by released by player after battle 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by army leader is dead 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by not enough party 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by objective finished 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by player taken prisoner 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by food problem 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by inactivity 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by cohesion depleted 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by no active war 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by unknown reason 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by leader party removed 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by no ship 的效果应用到当前对象。
