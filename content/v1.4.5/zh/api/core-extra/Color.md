...
**用途 / Purpose:** 调用 FromVector3 对应的操作。
...
**用途 / Purpose:** 调用 ToUnsignedInteger 对应的操作。
...
**用途 / Purpose:** 把string to color转换为另一种表示或类型。
...
**用途 / Purpose:** 调用 UIntToColorString 对应的操作。
