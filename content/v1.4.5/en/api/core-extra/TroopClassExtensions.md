...
**Purpose:** Determines whether the this instance is in the mounted state or condition.
...
**Purpose:** Determines whether the this instance is in the melee infantry state or condition.
...
**Purpose:** Determines whether the this instance is in the melee cavalry state or condition.
...
**Purpose:** Executes the DefaultClass logic.
...
**Purpose:** Executes the AlternativeClass logic.
...
**Purpose:** Executes the DismountedClass logic.
...
**Purpose:** Determines whether the this instance is in the default troop class state or condition.
...
**Purpose:** Determines whether the this instance is in the regular troop class state or condition.
...
**Purpose:** Reads and returns the next spawn prioritized class value held by the this instance.
