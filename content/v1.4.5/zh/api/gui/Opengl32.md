...
**用途 / Purpose:** **用途 / Purpose:** 调用 DrawArrays 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 integer 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Scissor 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PixelStore 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PixelZoom 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取pixels的数据或状态。
...
**用途 / Purpose:** **用途 / Purpose:** 把当前对象的pixels状态复制到目标对象。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DeleteTextures 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BlendFunc 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Viewport 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MultMatrix 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 从持久化存储或流中读取 matrix。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ColorMaterial 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TexCoordPointer 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 VertexPointer 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 NormalPointer 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DrawElements 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DisableClientState 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EnableClientState 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Translate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Lightfv 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Hint 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MatrixMode 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DepthFunc 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ShadeModel 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的depth。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PopMatrix 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PushMatrix 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 从持久化存储或流中读取 identity。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Begin 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Vertex 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Color 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的color。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TexImage2D 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GenTextures 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BindTexture 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TexCoord 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TexParameteri 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 error 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Flush 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 wglCreateContext 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 wglMakeCurrent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 wglGetProcAddress 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 wglDeleteContext 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 wglGetCurrentContext 对应的操作。
