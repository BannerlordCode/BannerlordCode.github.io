...
description: "ScrollablePanelFixedHeaderWidget 的自动生成类参考。"
---
...
**Base:** `Widget`
**File:** `bin/TaleWorlds.GauntletUI/TaleWorlds.GauntletUI.BaseTypes/ScrollablePanelFixedHeaderWidget.cs`
