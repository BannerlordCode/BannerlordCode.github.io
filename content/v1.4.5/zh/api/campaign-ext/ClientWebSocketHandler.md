...
**用途 / Purpose:** **用途 / Purpose:** 调用 MessageReceivedDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 在 error delegate 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DisconnectedDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ConnectedDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SendTextMessage 对应的操作。
