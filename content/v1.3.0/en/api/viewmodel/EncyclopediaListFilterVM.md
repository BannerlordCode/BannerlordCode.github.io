...
**Purpose:** **Purpose:** Copies the filter from state of the this instance to a target.
...
**Purpose:** **Purpose:** Runs the operation or workflow associated with on filter activated.
