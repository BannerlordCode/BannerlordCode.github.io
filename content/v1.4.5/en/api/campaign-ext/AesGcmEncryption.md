---
title: "AesGcmEncryption"
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `AesGcmEncryption`
...
**Namespace:** Jose
**Module:** Jose
**Type:** `public class AesGcmEncryption : IJweAlgorithm`
**Base:** `IJweAlgorithm`
**File:** `Bannerlord.Source/bin/jose-jwt/Jose/AesGcmEncryption.cs`

## Overview

`AesGcmEncryption` lives in `Jose` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
```csharp
var value = new AesGcmEncryption();
value.Encrypt(0, 0, 0);
```
