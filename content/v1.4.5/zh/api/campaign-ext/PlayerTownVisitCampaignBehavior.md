...
**用途 / Purpose:** 调用 wait_menu_prisoner_wait_on_init 对应的操作。
...
**用途 / Purpose:** 调用 wait_menu_prisoner_settlement_wait_ui_on_init 对应的操作。
...
**用途 / Purpose:** 调用 wait_menu_prisoner_wait_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 wait_menu_prisoner_wait_on_tick 对应的操作。
...
**用途 / Purpose:** 调用 wait_menu_settlement_wait_on_tick 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_manage_town_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_manage_town_cheat_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 settlement_player_unconscious_continue_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_menu_arena_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_village_menu_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_menu_keep_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_ui_town_manage_town_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_ui_town_castle_manage_town_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_menu_backstreet_sound_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_menu_keep_sound_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_menu_sound_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_menu_enter_sound_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_village_menu_sound_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_village__enter_menu_sound_on_init 对应的操作。
