...
**用途 / Purpose:** **用途 / Purpose:** 在 alliance offered to player 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 alliance offered to player kingdom 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 call to war agreement proposed to player 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 call to war agreement proposed to player kingdom 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 call to war agreement proposed by player 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 alliance end date 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DenyCallToWarAgreement 对应的操作。
