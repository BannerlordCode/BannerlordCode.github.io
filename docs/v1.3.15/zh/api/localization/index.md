...
\|------------\|-------------------\|
\| [LanguageData.md](./LanguageData.md) \| 语言数据类 \|
\| [LocalizedTextManager.md](./LocalizedTextManager.md) \| 本地化文本管理器 \|
\| [MBTextManager.md](./MBTextManager.md) \| 文本管理器 \|
\| [TextObject.md](./TextObject.md) \| 文本对象类 \|
