...
description: "RetreatVisualOrder 的自动生成类参考。"
---
# RetreatVisualOrder
...
**Base:** `VisualOrder`
**File:** `Modules.Native/TaleWorlds.MountAndBlade.View/TaleWorlds.MountAndBlade.ViewModelCollection.Order.Visual.Default.Orders.MovementOrders/RetreatVisualOrder.cs`
...
```csharp
// 先通过子系统 API 拿到 RetreatVisualOrder 实例
