...
**Purpose:** Removes all requests from the this instance.
...
**Purpose:** Checks whether the this instance meets the preconditions for cel request.
...
**Purpose:** Determines whether the this instance is in the memory cleared state or condition.
