...
**Type:** static class
**File:** `TaleWorlds.CampaignSystem/Actions/ChangeClanLeaderAction.cs`
...
**用途 / Purpose:** 将 with selected new leader 的效果应用到当前对象。
...
**用途 / Purpose:** 将 without selected new leader 的效果应用到当前对象。
