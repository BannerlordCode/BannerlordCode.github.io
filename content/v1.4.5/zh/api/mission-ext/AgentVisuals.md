...
**用途 / Purpose:** **用途 / Purpose:** 返回action continue with current action对当前对象是否成立的布尔结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 random gloss factor 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 random clothing colors 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 agent lod zero or max external 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 将 armor multi meshes to agent entity 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MakeRandomVoiceForFacegen 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 team color to mesh 添加到当前容器或状态中。
