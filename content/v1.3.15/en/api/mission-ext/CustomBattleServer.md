...
**Purpose:** **Purpose:** Invoked when the player disconnected from lobby message event is raised.
...
**Purpose:** **Purpose:** Registers game with the current system so it can later be observed or dispatched.
...
**Purpose:** **Purpose:** Concludes the as idle flow and performs any cleanup.
...
**Purpose:** **Purpose:** Concludes the game flow and performs any cleanup.
...
**Purpose:** **Purpose:** Recalculates and stores the latest representation of game properties.
...
**Purpose:** **Purpose:** Executes the BeforeStartingNextBattle logic.
...
**Purpose:** **Purpose:** Executes the BattleFinished logic.
