...
**Purpose:** Reads and returns the town food and market stocks value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the there anyone to meet in town state or condition.
...
**Purpose:** Reads and returns the heroes to meet in town value held by the this instance.
...
**Purpose:** Reads and returns the heroes in settlement value held by the this instance.
...
**Purpose:** Executes the RequestAMeetingPartyCondition logic.
...
**Purpose:** Executes the RequestAMeetingHeroWithoutPartyCondition logic.
