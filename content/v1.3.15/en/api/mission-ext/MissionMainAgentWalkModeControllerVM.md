...
**Purpose:** Reads and returns the is walk mode activated delegate value held by the this instance.
...
**Purpose:** Reads and returns the can change walk mode activated delegate value held by the this instance.
