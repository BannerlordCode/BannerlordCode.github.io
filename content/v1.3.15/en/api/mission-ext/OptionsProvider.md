...
**Purpose:** Reads and returns the video option category value held by the this instance.
...
**Purpose:** Reads and returns the performance option category value held by the this instance.
...
**Purpose:** Reads and returns the performance graphics options value held by the this instance.
...
**Purpose:** Reads and returns the performance resolution scaling options value held by the this instance.
...
**Purpose:** Reads and returns the performance gameplay options value held by the this instance.
...
**Purpose:** Reads and returns the performance audio options value held by the this instance.
...
**Purpose:** Reads and returns the audio option category value held by the this instance.
...
**Purpose:** Reads and returns the gameplay option category value held by the this instance.
...
**Purpose:** Reads and returns the game key categories list value held by the this instance.
...
**Purpose:** Reads and returns the hidden game keys value held by the this instance.
...
**Purpose:** Reads and returns the controller option category value held by the this instance.
...
**Purpose:** Reads and returns the default native options value held by the this instance.
...
**Purpose:** Reads and returns the default managed options value held by the this instance.
