...
**用途 / Purpose:** **用途 / Purpose:** 将 by king decision 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by siege 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by leave faction 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by barter 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by destroy clan 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by gift 的效果应用到当前对象。
