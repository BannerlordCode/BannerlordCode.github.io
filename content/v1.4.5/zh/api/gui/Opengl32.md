...
**用途 / Purpose:** 把当前对象的「pixels」状态复制到目标对象。
...
**用途 / Purpose:** 获取或维护 「wgl get current context」 数据。
