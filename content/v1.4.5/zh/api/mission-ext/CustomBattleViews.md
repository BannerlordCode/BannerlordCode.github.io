...
---
<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `CustomBattleViews`
- [← 本领域 / 返回 mission-ext](./)
- [↑ API 目录](../)
- [🏠 首页 v1.4.5](../../)
- [⭐ 版本架构](../../architecture/)
...
**类型:** `public class CustomBattleViews`
**领域:** mission-ext

## 概述

`CustomBattleViews` 位于 `TaleWorlds.MountAndBlade.CustomBattle`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
...
**用途 / Purpose:** 处理 `open custom siege battle mission` 相关逻辑。
