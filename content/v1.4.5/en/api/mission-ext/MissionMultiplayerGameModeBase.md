...
**Purpose:** Removes all peer counts from the this instance.
...
**Purpose:** Executes the ShouldSpawnVisualsForServer logic.
...
**Purpose:** Reads and returns the score for kill value held by the this instance.
...
**Purpose:** Reads and returns the current gold for peer value held by the this instance.
...
**Purpose:** Executes the ChangeCurrentGoldForPeer logic.
...
**Purpose:** Reads and returns the used cosmetics from peer value held by the this instance.
