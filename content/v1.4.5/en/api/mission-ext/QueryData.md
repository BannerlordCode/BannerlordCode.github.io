...
**Purpose:** Executes the Evaluate logic.
...
**Purpose:** Reads and returns the cached value value held by the this instance.
...
**Purpose:** Reads and returns the cached value unless too old value held by the this instance.
...
**Purpose:** Reads and returns the cached value with max age value held by the this instance.
