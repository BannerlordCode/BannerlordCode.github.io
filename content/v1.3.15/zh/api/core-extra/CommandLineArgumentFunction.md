---
title: "CommandLineArgumentFunction"
---
<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `CommandLineArgumentFunction`
- [← 本领域 / 返回 core-extra](./)
- [↑ API 目录](../)
- [🏠 首页 v1.3.15](../../)
...
**类型:** `public class CommandLineArgumentFunction : Attribute`
**Base:** `Attribute`
**领域:** core-extra

## 概述

`CommandLineArgumentFunction` 位于 `TaleWorlds.Library`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
...
CommandLineArgumentFunction.CollectCommandLineFunctions();
```
