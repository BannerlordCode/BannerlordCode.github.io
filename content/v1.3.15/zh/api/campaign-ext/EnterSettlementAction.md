...
**用途 / Purpose:** **用途 / Purpose:** 将 for party 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 for party enters alley 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 for character only 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 for prisoner 的效果应用到当前对象。
