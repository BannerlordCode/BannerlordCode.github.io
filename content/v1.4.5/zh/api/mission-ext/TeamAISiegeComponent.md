...
**用途 / Purpose:** 计算is charge past walls applicable的当前值或结果。
...
**用途 / Purpose:** 计算is any lane open to get inside的当前值或结果。
...
**用途 / Purpose:** 计算is any lane open to go outside的当前值或结果。
