...
**Purpose:** Reads and returns the `nav mesh m t` value held by the current object.
...
**Purpose:** Reads and returns the `nearest nav mesh` value held by the current object.
...
**Purpose:** Reads and returns the `nav mesh z` value held by the current object.
...
**Purpose:** Reads and returns the `nav mesh z m t` value held by the current object.
...
**Purpose:** Reads and returns the `ground z` value held by the current object.
...
**Purpose:** Reads and returns the `ground z m t` value held by the current object.
...
**Purpose:** Reads and returns the `nav mesh vec3 m t` value held by the current object.
...
**Purpose:** Reads and returns the `ground vec3` value held by the current object.
...
**Purpose:** Reads and returns the `ground vec3 m t` value held by the current object.
...
**Purpose:** Reads and returns the `vec3 without validity` value held by the current object.
