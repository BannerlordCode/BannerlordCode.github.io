...
```csharp
// MultiplayerLobbyClassFilterFactionItemButtonWidget (Widget) 的典型用法
// 声明/访问一个 MultiplayerLobbyClassFilterFactionItemButtonWidget
var widget = root.GetChild("multiplayerLobbyClassFilterFactionItemButtonWidget");;
```
