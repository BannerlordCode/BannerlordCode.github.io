...
**Purpose:** Verifies whether gold for alternative solution holds true for the this instance.
...
**Purpose:** Reads and returns the alternative solution melee skills value held by the this instance.
...
**Purpose:** Verifies whether roster for alternative solution holds true for the this instance.
...
**Purpose:** Reads and returns the alternative solution ranged skills value held by the this instance.
...
**Purpose:** Verifies whether minor major coercion holds true for the this instance.
...
**Purpose:** Applies the effect of generic minor major coercion consequences to the this instance.
...
**Purpose:** Reads and returns the average price of item in the world value held by the this instance.
...
**Purpose:** Verifies whether war declaration and fail or cancel the quest holds true for the this instance.
