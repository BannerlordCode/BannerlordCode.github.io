...
**Purpose:** Reads and returns the tutorial scores value held by the this instance.
...
**Purpose:** Executes the CompleteTutorialPhase logic.
...
**Purpose:** Executes the CompleteFirstPhase logic.
...
**Purpose:** Executes the CompleteSecondPhase logic.
...
**Purpose:** Checks whether the this instance meets the preconditions for cel second and third phase.
