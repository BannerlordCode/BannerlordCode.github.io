...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `ArmyCohesionStep2Tutorial`
...
**File:** `Bannerlord.Source/Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/ArmyCohesionStep2Tutorial.cs`
...
```csharp
var value = new ArmyCohesionStep2Tutorial();
