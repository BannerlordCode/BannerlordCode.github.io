...
description: "BehaviorDestroySiegeWeapons 的自动生成类参考。"
---
...
**File:** `bin/TaleWorlds.MountAndBlade/TaleWorlds.MountAndBlade/BehaviorDestroySiegeWeapons.cs`
...
```csharp
// 先通过子系统 API 拿到 BehaviorDestroySiegeWeapons 实例
