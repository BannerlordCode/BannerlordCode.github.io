<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `IssueQuestStartLogEntry`
...
**Base:** `LogEntry`
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.LogEntries/IssueQuestStartLogEntry.cs`
