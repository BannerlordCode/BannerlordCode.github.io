...
**用途 / Purpose:** 处理与 「select formation at index」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「deselect formation at index」 相关的逻辑。
...
**用途 / Purpose:** 在 「activate toggle order」 事件触发时调用此回调。
...
**用途 / Purpose:** 在 「deactivate toggle order」 事件触发时调用此回调。
