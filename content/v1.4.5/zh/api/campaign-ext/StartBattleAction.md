...
**用途 / Purpose:** 将 start battle 的效果应用到当前对象。
...
**用途 / Purpose:** 将 start raid 的效果应用到当前对象。
...
**用途 / Purpose:** 将 start sally out 的效果应用到当前对象。
...
**用途 / Purpose:** 将 start assault against walls 的效果应用到当前对象。
