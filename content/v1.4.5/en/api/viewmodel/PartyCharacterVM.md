...
**Base:** `ViewModel`
**File:** `bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.Party/PartyCharacterVM.cs`
...
**Purpose:** Reads and returns the `num of category item party has` value held by the current object.
