...
**用途 / Purpose:** 调用 ToggleIncludeCombatLog 对应的操作。
...
**用途 / Purpose:** 调用 SendMessageToChannel 对应的操作。
...
**用途 / Purpose:** 检查chat fading在当前对象中是否成立。
...
**用途 / Purpose:** 调用 TypeToChannelAll 对应的操作。
...
**用途 / Purpose:** 调用 TypeToChannelTeam 对应的操作。
...
**用途 / Purpose:** 启动inspecting messages流程或状态机。
...
**用途 / Purpose:** 停止inspecting messages流程或状态机。
...
**用途 / Purpose:** 调用 SendCurrentlyTypedMessage 对应的操作。
