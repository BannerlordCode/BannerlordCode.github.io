...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item usage index 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item holster index 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item is passive usage 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 holster frame by index 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item usage set flags 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item usage reload action code 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item usage strike type 的结果。
