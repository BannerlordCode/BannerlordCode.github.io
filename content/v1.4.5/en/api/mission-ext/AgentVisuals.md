...
**Purpose:** **Purpose:** Returns a boolean answer to whether action continue with current action is true for the this instance.
...
**Purpose:** **Purpose:** Advances the visuals state each frame or update cycle.
...
**Purpose:** **Purpose:** Reads and returns the random gloss factor value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the random clothing colors value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to agent lod zero or max external and updates the object's internal state.
...
**Purpose:** **Purpose:** Adds armor multi meshes to agent entity to the current collection or state.
...
**Purpose:** **Purpose:** Executes the MakeRandomVoiceForFacegen logic.
...
**Purpose:** **Purpose:** Adds team color to mesh to the current collection or state.
