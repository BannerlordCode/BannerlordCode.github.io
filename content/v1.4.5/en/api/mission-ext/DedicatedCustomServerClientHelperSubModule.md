...
**Purpose:** Executes the DownloadMapFromHost logic.
...
**Purpose:** Reads and returns the map list from host value held by the this instance.
...
**Purpose:** Executes the DownloadMapCommand logic.
...
**Purpose:** Reads and returns the map list command value held by the this instance.
