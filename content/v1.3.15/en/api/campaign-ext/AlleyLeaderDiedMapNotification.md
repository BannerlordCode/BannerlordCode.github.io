...
**File:** `TaleWorlds.CampaignSystem/MapNotificationTypes/AlleyLeaderDiedMapNotification.cs`

## Overview

`AlleyLeaderDiedMapNotification` lives in `TaleWorlds.CampaignSystem.MapNotificationTypes` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
```csharp
var value = new AlleyLeaderDiedMapNotification();
```
