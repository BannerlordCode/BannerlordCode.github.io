...
**Purpose:** Determines whether the this instance already holds secondary interaction message.
...
**Purpose:** Removes all forced interaction texts from the this instance.
