...
**Purpose:** Reads and returns the `random item modifier loot score based` value held by the current object.
...
**Purpose:** Reads and returns the `random item modifier production score based` value held by the current object.
...
**Purpose:** Reads and returns the `modifiers based on quality` value held by the current object.
