...
**Base:** none
**File:** `TaleWorlds.CampaignSystem/TradeRumor.cs`
...
**Purpose:** Determines whether the this instance is in the compatable state or condition.
...
**Purpose:** Determines whether the this instance is in the expired state or condition.
