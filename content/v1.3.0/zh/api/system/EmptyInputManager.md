...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 controller type 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 mouse position x 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 mouse position y 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 mouse scroll value 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 any touch active 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 controller connected 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 mouse active 状态或条件。
