...
description: "StealthDarkZoneTutorial 的自动生成类参考。"
---
...
**File:** `Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/StealthDarkZoneTutorial.cs`
...
```csharp
// 先通过子系统 API 拿到 StealthDarkZoneTutorial 实例
