...
**Purpose:** Reads and returns the ship size weather factor value held by the this instance.
...
**Purpose:** Reads and returns the default combat factor value held by the this instance.
...
**Purpose:** Reads and returns the campaign speed bonus factor value held by the this instance.
...
**Purpose:** Reads and returns the crew capacity bonus factor value held by the this instance.
...
**Purpose:** Reads and returns the ship weight factor value held by the this instance.
...
**Purpose:** Reads and returns the forward drag factor value held by the this instance.
...
**Purpose:** Reads and returns the crew shield hit points factor value held by the this instance.
...
**Purpose:** Reads and returns the additional ammo bonus value held by the this instance.
...
**Purpose:** Reads and returns the max oar power factor value held by the this instance.
...
**Purpose:** Reads and returns the max oar force factor value held by the this instance.
...
**Purpose:** Reads and returns the sail force factor value held by the this instance.
...
**Purpose:** Reads and returns the crew melee damage factor value held by the this instance.
...
**Purpose:** Reads and returns the additional archer quivers value held by the this instance.
...
**Purpose:** Reads and returns the additional throwing weapon stack value held by the this instance.
...
**Purpose:** Reads and returns the sail rotation speed factor value held by the this instance.
...
**Purpose:** Reads and returns the furl unfurl speed factor value held by the this instance.
