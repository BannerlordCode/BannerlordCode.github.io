...
**Purpose:** Reads and returns the `default occupation` value held by the current object.
...
**Purpose:** Determines whether the current object already holds `throwing weapon`.
...
**Purpose:** Reads and returns the `upgrade xp cost` value held by the current object.
...
**Purpose:** Reads and returns the `upgrade gold cost` value held by the current object.
...
**Purpose:** Reads and returns the `simulation attack power` value held by the current object.
...
**Purpose:** Reads and returns the `body armor sum` value held by the current object.
...
**Purpose:** Reads and returns the `total armor sum` value held by the current object.
...
**Purpose:** Reads and returns the `persona` value held by the current object.
