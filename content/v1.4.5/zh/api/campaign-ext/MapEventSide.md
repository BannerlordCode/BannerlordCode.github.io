...
**用途 / Purpose:** 计算renown and influence values的当前值或结果。
...
**用途 / Purpose:** 调用 DistributeRenownAndInfluence 对应的操作。
...
**用途 / Purpose:** 调用 ItemRosterForPlayerLootShare 对应的操作。
...
**用途 / Purpose:** 调用 MemberRosterForPlayerLootShare 对应的操作。
...
**用途 / Purpose:** 调用 PrisonerRosterForPlayerLootShare 对应的操作。
