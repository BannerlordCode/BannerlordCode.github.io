...
**用途 / Purpose:** 将 「map arrow from point to target」 添加到当前容器或状态中。
...
**用途 / Purpose:** 检查「gold for alternative solution」在当前对象中是否成立。
...
**用途 / Purpose:** 读取并返回当前对象中 「alternative solution melee skills」 的结果。
...
**用途 / Purpose:** 检查「roster for alternative solution」在当前对象中是否成立。
...
**用途 / Purpose:** 读取并返回当前对象中 「alternative solution ranged skills」 的结果。
...
**用途 / Purpose:** 检查「minor major coercion」在当前对象中是否成立。
...
**用途 / Purpose:** 将 「generic minor major coercion consequences」 的效果应用到当前对象。
...
**用途 / Purpose:** 读取并返回当前对象中 「average price of item in the world」 的结果。
...
**用途 / Purpose:** 检查「war declaration and fail or cancel the quest」在当前对象中是否成立。
