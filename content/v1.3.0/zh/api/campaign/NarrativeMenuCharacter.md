...
**用途 / Purpose:** **用途 / Purpose:** 为 animation id 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 right hand item 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 left hand item 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EquipRightHandItemWithEquipmentIndex 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EquipLeftHandItemWithEquipmentIndex 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 spawn point entity id 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChangeAge 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 horse item id 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 harness item id 赋新值，并同步更新对象内部状态。
