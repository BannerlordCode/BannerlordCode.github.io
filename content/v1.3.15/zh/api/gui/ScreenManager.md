...
**用途 / Purpose:** 调用 ScreenTypeExistsAtList 对应的操作。
...
**用途 / Purpose:** 调用 ReplaceTopScreen 对应的操作。
...
**用途 / Purpose:** 调用 CleanAndPushScreen 对应的操作。
...
**用途 / Purpose:** 清空当前对象中的siege machine selection。
...
**用途 / Purpose:** 把当前对象的custom battle状态复制到目标对象。
...
**用途 / Purpose:** 调用 PushScreen 对应的操作。
...
**用途 / Purpose:** 调用 CleanScreens 对应的操作。
...
**用途 / Purpose:** 调用 EarlyUpdate 对应的操作。
