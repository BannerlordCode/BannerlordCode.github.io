...
**用途 / Purpose:** 调用 BeginEndMission 对应的操作。
...
**用途 / Purpose:** 调用 BattleCancelledForPlayerLeaving 对应的操作。
...
**用途 / Purpose:** 调用 BattleStarted 对应的操作。
...
**用途 / Purpose:** 调用 DoNotAcceptNewPlayers 对应的操作。
...
**用途 / Purpose:** 调用 AllPlayersConnected 对应的操作。
