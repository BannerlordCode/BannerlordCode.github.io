...
description: "EnterCustomBattleWithPartyAnswer 的自动生成类参考。"
---
...
**Base:** `Message`
**File:** `TaleWorlds.MountAndBlade.Diamond/Messages/FromLobbyServer/ToClient/EnterCustomBattleWithPartyAnswer.cs`
