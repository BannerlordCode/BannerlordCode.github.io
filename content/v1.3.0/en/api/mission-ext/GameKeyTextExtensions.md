...
**Purpose:** Reads and returns the hot key game text value held by the this instance.
...
**Purpose:** Reads and returns the hot key game text from key i d value held by the this instance.
