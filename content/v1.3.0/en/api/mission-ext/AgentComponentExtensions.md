...
**Purpose:** Reads and returns the morale value held by the this instance.
...
**Purpose:** Executes the ChangeMorale logic.
...
**Purpose:** Executes the AIMoveToGameObjectEnable logic.
...
**Purpose:** Executes the AIMoveToGameObjectDisable logic.
...
**Purpose:** Executes the AIMoveToGameObjectIsEnabled logic.
...
**Purpose:** Executes the AIDefendGameObjectEnable logic.
...
**Purpose:** Executes the AIDefendGameObjectDisable logic.
...
**Purpose:** Executes the AIDefendGameObjectIsEnabled logic.
...
**Purpose:** Executes the AIInterestedInAnyGameObject logic.
...
**Purpose:** Executes the AIInterestedInGameObject logic.
...
**Purpose:** Executes the AIUseGameObjectEnable logic.
...
**Purpose:** Executes the AIUseGameObjectDisable logic.
...
**Purpose:** Executes the AIUseGameObjectIsEnabled logic.
...
**Purpose:** Reads and returns the followed unit value held by the this instance.
