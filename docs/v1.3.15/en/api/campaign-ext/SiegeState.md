...
`SiegeState` lives in `TaleWorlds.CampaignSystem.Settlements`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
```csharp
SiegeState example = SiegeState.OnTheWalls;
```
