...
**Purpose:** Gets the current value of `companion with most kills`.

### GetCompanionWithMostIssuesSolved
`public ValueTuple<string, int> GetCompanionWithMostIssuesSolved()`

**Purpose:** Gets the current value of `companion with most issues solved`.
...
**Purpose:** Gets the current value of `most expensive item crafted`.
