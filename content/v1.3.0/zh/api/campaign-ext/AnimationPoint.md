...
**用途 / Purpose:** **用途 / Purpose:** 调用 RequestResync 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 random wait in seconds 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 alternatives 的结果。
