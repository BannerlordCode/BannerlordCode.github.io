...
description: "Auto-generated class reference for TextureMagFilter."
---
# TextureMagFilter
...
`TextureMagFilter` lives in `TaleWorlds.TwoDimension.Standalone.Native.OpenGL` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
