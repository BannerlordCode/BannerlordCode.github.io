...
description: "Auto-generated class reference for BasicTypeDefinition."
---
# BasicTypeDefinition
...
`BasicTypeDefinition` lives in `TaleWorlds.SaveSystem.Definition` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
| Name | Signature |
|------|-----------|
| `Serializer` | `public IBasicTypeSerializer Serializer { get; }` |

## Usage Example

```csharp
// Obtain an instance from the relevant subsystem API
BasicTypeDefinition instance = ...;
```
