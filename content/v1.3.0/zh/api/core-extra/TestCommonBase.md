...
**用途 / Purpose:** 启动timeout timer流程或状态机。
...
**用途 / Purpose:** 调用 ToggleTimeoutTimer 对应的操作。
...
**用途 / Purpose:** 检查timeout timer在当前对象中是否成立。
...
**用途 / Purpose:** 暂停当前流程，直到for async条件满足。
