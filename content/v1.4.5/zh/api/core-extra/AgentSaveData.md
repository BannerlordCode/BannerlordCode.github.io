...
**用途 / Purpose:** **用途 / Purpose:** 调用 AgentSaveData 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 重新计算并更新 spawn frame 的最新表示。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AutoGeneratedStaticCollectObjectsAgentSaveData 对应的操作。
