...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.ComponentInterfaces/SettlementMenuOverlayModel.cs`
...
**用途 / Purpose:** 获取 `overlay heroes` 的当前值。
