...
description: "PlayerCaptivityCampaignBehavior 的自动生成类参考。"
---
...
**File:** `TaleWorlds.CampaignSystem/CampaignBehaviors/PlayerCaptivityCampaignBehavior.cs`
...
**用途 / Purpose:** 检查captivity change在当前对象中是否成立。
