<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `VassalAndMercenaryOfferCampaignBehavior`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CampaignBehaviors/VassalAndMercenaryOfferCampaignBehavior.cs`
...
**Purpose:** Checks whether the current object can `cel vassal or mercenary service offer`.

### CreateMercenaryOffer
`public void CreateMercenaryOffer(Kingdom kingdom)`

**Purpose:** Creates a new `mercenary offer` instance or object.

### CreateVassalOffer
`public void CreateVassalOffer(Kingdom kingdom)`

**Purpose:** Creates a new `vassal offer` instance or object.
