...
| TaleWorlds.CampaignSystem | [CampaignInformationManager](./CampaignInformationManager); [CampaignMission](./CampaignMission); [CampaignObjectBase](./CampaignObjectBase); [CampaignObjectManager](./CampaignObjectManager); [CampaignOptions](./CampaignOptions) | Covers campaign lifecycle state and coordination used by CampaignSystem consumers; mutations stay in Actions or registered behaviors. | Campaign startup or clock tick |
