...
**Purpose:** **Purpose:** Reads and returns the default material value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the outline material value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the default tableau sample material value held by the this instance.
...
**Purpose:** **Purpose:** Constructs a new tableau material entity and returns it to the caller.
...
**Purpose:** **Purpose:** Assigns a new value to shader and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the alpha mask tableau material value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the alpha blend mode value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to alpha blend mode and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to alpha test value and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the alpha test value value held by the this instance.
