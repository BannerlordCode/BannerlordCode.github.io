...
**Purpose:** Reads and returns the version str value held by the this instance.
...
**Purpose:** Reads and returns the application platform name value held by the this instance.
...
**Purpose:** Reads and returns the modules version str value held by the this instance.
