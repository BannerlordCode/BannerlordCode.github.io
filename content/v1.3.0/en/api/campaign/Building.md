...
**Purpose:** Reads and returns the construction cost value held by the this instance.
...
**Purpose:** Executes the LevelUp logic.
...
**Purpose:** Executes the LevelDown logic.
...
**Purpose:** Executes the HitPointChanged logic.
...
**Purpose:** Reads and returns the bonus explanation value held by the this instance.
