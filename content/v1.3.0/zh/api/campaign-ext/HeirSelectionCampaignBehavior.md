...
description: "HeirSelectionCampaignBehavior 的自动生成类参考。"
---
...
**File:** `SandBox/CampaignBehaviors/HeirSelectionCampaignBehavior.cs`
...
```csharp
// 先通过子系统 API 拿到 HeirSelectionCampaignBehavior 实例
