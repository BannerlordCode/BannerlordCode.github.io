...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 troops 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 计算renown and influence values on party involved的当前值或结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CommitXpGains 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CommitRenownChanges 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CommitInfluenceChanges 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CommitMoraleChanges 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CommitGoldChanges 对应的操作。
