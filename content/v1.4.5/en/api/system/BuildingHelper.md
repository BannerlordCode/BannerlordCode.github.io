...
**Purpose:** Verifies whether if building is complete holds true for the this instance.
...
**Purpose:** Executes the ChangeDefaultBuilding logic.
...
**Purpose:** Executes the ChangeCurrentBuildingQueue logic.
...
**Purpose:** Reads and returns the progress of building value held by the this instance.
...
**Purpose:** Reads and returns the days to complete value held by the this instance.
...
**Purpose:** Reads and returns the tier of building value held by the this instance.
