...
**Base:** none
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CharacterDevelopment/TraitLevelingHelper.cs`
...
**Purpose:** Called when the `trade agreement broken` event is raised.
...
**Purpose:** Called when the `alliance broken through hostility` event is raised.
