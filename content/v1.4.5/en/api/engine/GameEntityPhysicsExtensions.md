...
**Purpose:** Determines whether the this instance already holds body.
...
**Purpose:** Executes the PushCapsuleShapeToEntityBody logic.
...
**Purpose:** Executes the PopCapsuleShapeFromEntityBody logic.
...
**Purpose:** Reads and returns the physics state value held by the this instance.
...
**Purpose:** Reads and returns the physics triangle count value held by the this instance.
...
**Purpose:** Determines whether the this instance already holds physics definition without flags.
...
**Purpose:** Determines whether the this instance already holds physics body.
...
**Purpose:** Determines whether the this instance already holds dynamic rigid body.
...
**Purpose:** Determines whether the this instance already holds kinematic rigid body.
...
**Purpose:** Determines whether the this instance already holds static physics body.
...
**Purpose:** Determines whether the this instance already holds dynamic rigid body and active simulation.
...
**Purpose:** Determines whether the this instance is in the engine body sleeping state or condition.
...
**Purpose:** Determines whether the this instance is in the dynamic body stationary state or condition.
...
**Purpose:** Determines whether the this instance is in the dynamic body stationary m t state or condition.
...
**Purpose:** Executes the ReplacePhysicsBodyWithQuadPhysicsBody logic.
...
**Purpose:** Reads and returns the body shape value held by the this instance.
...
**Purpose:** Applies the effect of local impulse to dynamic body to the this instance.
...
**Purpose:** Applies the effect of force to dynamic body to the this instance.
...
**Purpose:** Applies the effect of global force at local pos to dynamic body to the this instance.
...
**Purpose:** Applies the effect of torque to dynamic body to the this instance.
...
**Purpose:** Applies the effect of local force at local pos to dynamic body to the this instance.
...
**Purpose:** Applies the effect of acceleration to dynamic body to the this instance.
...
**Purpose:** Executes the DisableDynamicBodySimulation logic.
...
**Purpose:** Executes the DisableDynamicBodySimulationMT logic.
...
**Purpose:** Executes the EnableDynamicBody logic.
...
**Purpose:** Reads and returns the mass value held by the this instance.
...
**Purpose:** Reads and returns the mass space inertia value held by the this instance.
...
**Purpose:** Reads and returns the mass space inverse inertia value held by the this instance.
...
**Purpose:** Executes the DisableGravity logic.
...
**Purpose:** Determines whether the this instance is in the gravity disabled state or condition.
...
**Purpose:** Reads and returns the linear velocity value held by the this instance.
...
**Purpose:** Reads and returns the linear velocity m t value held by the this instance.
...
**Purpose:** Reads and returns the angular velocity value held by the this instance.
...
**Purpose:** Reads and returns the angular velocity m t value held by the this instance.
...
**Purpose:** Reads and returns the local physics bounding box value held by the this instance.
...
**Purpose:** Reads and returns the linear velocity at global point for entity with dynamic body value held by the this instance.
...
**Purpose:** Executes the ComputeVelocityDeltaFromImpulse logic.
