...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `ItemProsperityComparer`
...
**Type:** `public class ItemProsperityComparer : KingdomSettlementSortControllerVM.ItemComparerBase`
**Base:** `KingdomSettlementSortControllerVM.ItemComparerBase`
**Area:** campaign-ext

## Overview

`ItemProsperityComparer` lives in `TaleWorlds.CampaignSystem.ViewModelCollection.KingdomManagement.Settlements`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
```csharp
// First obtain a ItemProsperityComparer instance from game state, then call one of its public methods
var value = new ItemProsperityComparer();
