...
**用途 / Purpose:** 调用 ChangePrimaryColor 对应的操作。
...
**用途 / Purpose:** 调用 ChangeBackgroundColor 对应的操作。
...
**用途 / Purpose:** 调用 ChangeIconColors 对应的操作。
...
**用途 / Purpose:** 调用 RotateBackgroundToRight 对应的操作。
...
**用途 / Purpose:** 调用 RotateBackgroundToLeft 对应的操作。
