<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `LadysKnightOutIssueBehavior`
...
> This is an auto-generated stub. `LadysKnightOutIssueBehavior` is a class in the `TaleWorlds.CampaignSystem.Issues` namespace.
