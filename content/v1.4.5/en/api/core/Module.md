...
**Purpose:** Executes the CollectSubModules logic.
...
**Purpose:** Reads and returns the meta mesh package mapping value held by the this instance.
...
**Purpose:** Reads and returns the item mesh names value held by the this instance.
...
**Purpose:** Reads and returns the crafted item mesh names value held by the this instance.
...
**Purpose:** Reads and returns the sub module type value held by the this instance.
...
**Purpose:** Verifies whether if submodule can be loadable holds true for the this instance.
...
**Purpose:** Removes all state options from the this instance.
...
**Purpose:** Executes the OverrideInitialStateOption logic.
...
**Purpose:** Reads and returns the initial state options value held by the this instance.
...
**Purpose:** Reads and returns the initial state option with id value held by the this instance.
...
**Purpose:** Reads and returns the multiplayer game mode value held by the this instance.
...
**Purpose:** Reads and returns the multiplayer game types value held by the this instance.
...
**Purpose:** Executes the ShutDownWithDelay logic.
...
**Purpose:** Executes the DeactiveModule logic.
