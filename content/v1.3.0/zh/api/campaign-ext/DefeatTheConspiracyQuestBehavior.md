...
description: "DefeatTheConspiracyQuestBehavior 的自动生成类参考。"
---
...
```csharp
// 先通过子系统 API 拿到 DefeatTheConspiracyQuestBehavior 实例
...
**用途 / Purpose:** 计算reinforced war score的当前值或结果。
...
DefeatTheConspiracyQuestBehavior defeatTheConspiracyQuestBehavior = ...;
defeatTheConspiracyQuestBehavior.IsMobilePartyCreatedForQuest(mobileParty);
```
