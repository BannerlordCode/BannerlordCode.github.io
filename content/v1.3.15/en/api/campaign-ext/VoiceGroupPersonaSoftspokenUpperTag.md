...
description: "Auto-generated class reference for VoiceGroupPersonaSoftspokenUpperTag."
---
...
**File:** `TaleWorlds.CampaignSystem/Conversation/Tags/VoiceGroupPersonaSoftspokenUpperTag.cs`

## Overview

`VoiceGroupPersonaSoftspokenUpperTag` lives in `TaleWorlds.CampaignSystem.Conversation.Tags` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
```csharp
// Obtain an instance of VoiceGroupPersonaSoftspokenUpperTag from the subsystem API first
