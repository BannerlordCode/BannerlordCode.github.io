...
description: "GettingCompanionsStep2Tutorial 的自动生成类参考。"
---
...
**File:** `StoryMode.GauntletUI/Tutorial/GettingCompanionsStep2Tutorial.cs`
...
```csharp
// 先通过子系统 API 拿到 GettingCompanionsStep2Tutorial 实例
