<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `RenderCallbackCollection`
- [← 本领域 / 返回 mission-ext](./)
- [↑ API 目录](../)
- [🏠 首页 v1.4.5](../../)
- [⭐ 版本架构](../../architecture/)
...
**命名空间:** TaleWorlds.MountAndBlade.View.Tableaus
**模块:** TaleWorlds.MountAndBlade
**类型:** `public struct RenderCallbackCollection`
**领域:** mission-ext

## 概述

`RenderCallbackCollection` 位于 `TaleWorlds.MountAndBlade.View.Tableaus`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
