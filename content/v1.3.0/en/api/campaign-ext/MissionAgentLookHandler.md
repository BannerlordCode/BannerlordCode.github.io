...
**Purpose:** Reads and returns the basic position value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the visible for state or condition.
...
**Purpose:** Determines whether the this instance is in the relevant state or condition.
