...
**用途 / Purpose:** 调用 NpcLineWithVariation 对应的操作。
...
**用途 / Purpose:** 调用 PlayerLine 对应的操作。
...
**用途 / Purpose:** 调用 BeginPlayerOptions 对应的操作。
...
**用途 / Purpose:** 调用 BeginNpcOptions 对应的操作。
...
**用途 / Purpose:** 调用 PlayerOption 对应的操作。
...
**用途 / Purpose:** 调用 PlayerSpecialOption 对应的操作。
...
**用途 / Purpose:** 调用 PlayerRepeatableOption 对应的操作。
...
**用途 / Purpose:** 调用 NpcOptionWithVariation 对应的操作。
...
**用途 / Purpose:** 调用 EndPlayerOptions 对应的操作。
...
**用途 / Purpose:** 调用 EndNpcOptions 对应的操作。
...
**用途 / Purpose:** 调用 ClickableCondition 对应的操作。
...
**用途 / Purpose:** 构建一个新的 dialog flow 实体并返回给调用方。
...
**用途 / Purpose:** 调用 NpcDefaultOption 对应的操作。
...
**用途 / Purpose:** 调用 GotoDialogState 对应的操作。
...
**用途 / Purpose:** 调用 GotoDialogStateBranched 对应的操作。
...
**用途 / Purpose:** 读取并返回当前对象中 output token 的结果。
...
**用途 / Purpose:** 调用 GoBackToDialogState 对应的操作。
