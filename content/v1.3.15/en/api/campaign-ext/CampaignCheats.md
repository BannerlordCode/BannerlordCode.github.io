...
**Purpose:** **Purpose:** Executes the ImportMainHero logic.
...
**Purpose:** **Purpose:** Executes the ExportMainHero logic.
...
**Purpose:** **Purpose:** Adds skill xp to hero to the current collection or state.
...
**Purpose:** **Purpose:** Executes the PrintPlayerTrait logic.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the party suitable to use cheat state or condition.
