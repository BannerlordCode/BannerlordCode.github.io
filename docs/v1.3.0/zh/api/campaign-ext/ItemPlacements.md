...
**命名空间:** SandBox.ViewModelCollection.Tutorial
**模块:** SandBox.ViewModelCollection
**类型:** `public enum ItemPlacements`
**领域:** campaign-ext

## 概述

`ItemPlacements` 位于 `SandBox.ViewModelCollection.Tutorial`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
