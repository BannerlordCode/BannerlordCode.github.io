...
**用途 / Purpose:** 调用 TransformToParentDouble 对应的操作。
...
**用途 / Purpose:** 调用 TransformToLocalNonUnit 对应的操作。
...
**用途 / Purpose:** 调用 TransformToLocalNonOrthogonal 对应的操作。
...
**用途 / Purpose:** 调用 LerpNonOrthogonal 对应的操作。
...
**用途 / Purpose:** 调用 TransformToParentWithW 对应的操作。
...
**用途 / Purpose:** 读取并返回当前对象中 unit rot frame 的结果。
...
**用途 / Purpose:** 调用 InverseFast 对应的操作。
...
**用途 / Purpose:** 调用 Determinant4X4 对应的操作。
...
**用途 / Purpose:** 构建一个新的 look at 实体并返回给调用方。
...
**用途 / Purpose:** 调用 CenterFrameOfTwoPoints 对应的操作。
