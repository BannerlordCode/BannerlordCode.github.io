...
**Purpose:** Determines whether the this instance already holds only start suitability.
...
**Purpose:** Determines whether the this instance already holds only middle suitability.
...
**Purpose:** Determines whether the this instance already holds only end suitability.
...
**Purpose:** Removes all segment suitability flag from the this instance.
...
**Purpose:** Determines whether the this instance is in the bridge snippet to any group state or condition.
...
**Purpose:** Determines whether the this instance is in the manual bridge snippet for any group state or condition.
...
**Purpose:** Determines whether the this instance is in the manual bridge segment for source group state or condition.
...
**Purpose:** Reads and returns the example snippet1 value held by the this instance.
...
**Purpose:** Reads and returns the example snippet2 value held by the this instance.
...
**Purpose:** Reads and returns the example snippet3 value held by the this instance.
...
**Purpose:** Reads and returns the example snippet4 value held by the this instance.
