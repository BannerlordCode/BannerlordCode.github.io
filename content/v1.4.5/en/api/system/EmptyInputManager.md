...
**Purpose:** Reads and returns the controller type value held by the this instance.
...
**Purpose:** Reads and returns the mouse position x value held by the this instance.
...
**Purpose:** Reads and returns the mouse position y value held by the this instance.
...
**Purpose:** Reads and returns the mouse scroll value value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the any touch active state or condition.
...
**Purpose:** Determines whether the this instance is in the controller connected state or condition.
...
**Purpose:** Determines whether the this instance is in the mouse active state or condition.
