<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `PortSounds`
...
`PortSounds` lives in `TaleWorlds.MountAndBlade.View`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
PortSounds.PlayUISound("example");
```
