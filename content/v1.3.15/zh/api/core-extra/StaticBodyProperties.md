...
**用途 / Purpose:** **用途 / Purpose:** 调用 AutoGeneratedStaticCollectObjectsStaticBodyProperties 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 random static body properties 的结果。
