...
**Base:** none
**File:** `Modules.Native/TaleWorlds.MountAndBlade.View/TaleWorlds.MountAndBlade.View/ItemCollectionElementViewExtensions.cs`
...
**Purpose:** Reads and returns the material cache i d value held by the this instance.
...
**Purpose:** Reads and returns the item mesh for inventory value held by the this instance.
...
**Purpose:** Reads and returns the holster mesh copy value held by the this instance.
...
**Purpose:** Reads and returns the holster mesh if exists value held by the this instance.
...
**Purpose:** Reads and returns the holster with weapon mesh copy value held by the this instance.
...
**Purpose:** Reads and returns the holster with weapon mesh if exists value held by the this instance.
...
**Purpose:** Reads and returns the camera frame for inventory value held by the this instance.
...
**Purpose:** Reads and returns the item frame for inventory value held by the this instance.
...
**Purpose:** Reads and returns the item frame for item tooltip value held by the this instance.
