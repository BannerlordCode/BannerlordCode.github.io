...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `NotificationSounds`
...
`NotificationSounds` lives in `TaleWorlds.MountAndBlade.View`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
NotificationSounds.PlayUISound("example");
```
