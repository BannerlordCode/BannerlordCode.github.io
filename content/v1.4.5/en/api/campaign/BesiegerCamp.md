...
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Siege/BesiegerCamp.cs`
...
**Purpose:** **Purpose:** Verifies whether besieger parties and make them leave holds true for the this instance.
