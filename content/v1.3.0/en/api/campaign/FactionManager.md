...
**Purpose:** Determines whether the this instance is in the at war against faction state or condition.
...
**Purpose:** Determines whether the this instance is in the at constant war against faction state or condition.
...
**Purpose:** Determines whether the this instance is in the neutral with faction state or condition.
...
**Purpose:** Reads and returns the relation between clans value held by the this instance.
