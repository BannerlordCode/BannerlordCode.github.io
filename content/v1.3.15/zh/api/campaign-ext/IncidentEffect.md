...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 hint 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WithChance 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WithCustomInformation 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WithHint 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GoldChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TraitChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 组装并返回ing level change的构建结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SiegeProgressChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WorkshopProfitabilityChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SkillChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MoraleChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 HealthChance 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenownChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CrimeRatingChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InfluenceChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 tlement relation change 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TownBoundVillageRelationChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TownBoundVillageHearthChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 VillageHearthChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TownSecurityChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 HeroRelationChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TownProsperityChange 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 tlement militia change 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InfestNearbyHideout 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WoundTroopsRandomly 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WoundTroopsRandomlyWithChanceOfDeath 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BreachSiegeWall 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WoundTroopsRandomlyByChance 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillTroopsRandomlyOrderedByTier 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillTroopsRandomly 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillTroopsRandomlyByChance 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillTroop 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChangeTroopAmount 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 UpgradeTroop 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 prisoners randomly with predicate。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChangeItemsAmount 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChangeItemAmount 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PartyExperienceChance 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DisorganizeParty 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 HealTroopsRandomly 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DemoteTroopsRandomlyWithPredicate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Group 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Custom 对应的操作。
