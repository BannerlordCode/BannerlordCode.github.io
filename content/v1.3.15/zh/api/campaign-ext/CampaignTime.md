...
**用途 / Purpose:** 调用 AutoGeneratedStaticCollectObjectsCampaignTime 对应的操作。
...
**用途 / Purpose:** 调用 MinutesFromNow 对应的操作。
...
**用途 / Purpose:** 调用 HoursFromNow 对应的操作。
...
**用途 / Purpose:** 调用 DaysFromNow 对应的操作。
...
**用途 / Purpose:** 调用 WeeksFromNow 对应的操作。
...
**用途 / Purpose:** 调用 YearsFromNow 对应的操作。
...
**用途 / Purpose:** 调用 StringSameAs 对应的操作。
