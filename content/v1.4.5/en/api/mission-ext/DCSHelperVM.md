...
**Purpose:** Reads and returns the panel subtitle value held by the this instance.
...
**Purpose:** Reads and returns the progress counter value held by the this instance.
...
**Purpose:** Reads and returns the download complete message singular value held by the this instance.
...
**Purpose:** Reads and returns the download complete message plural value held by the this instance.
...
**Purpose:** Reads and returns the replacement confirmation message value held by the this instance.
