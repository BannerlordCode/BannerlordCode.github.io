...
**Purpose:** Determines whether the this instance is in the position in range state or condition.
...
**Purpose:** Reads and returns the usable machines with tag in range value held by the this instance.
...
**Purpose:** Reads and returns the game entities with tag in range value held by the this instance.
