...
description: "PressLeaveToReturnFromMissionTutorial1 的自动生成类参考。"
---
...
**File:** `Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/PressLeaveToReturnFromMissionTutorial1.cs`
...
```csharp
// 先通过子系统 API 拿到 PressLeaveToReturnFromMissionTutorial1 实例
