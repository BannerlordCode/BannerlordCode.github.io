<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `GauntletMapCampaignOptionsView`
...
**File:** `Bannerlord.Source/Modules.SandBox/SandBox.GauntletUI/SandBox.GauntletUI.Map/GauntletMapCampaignOptionsView.cs`
