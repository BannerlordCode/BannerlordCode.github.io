---
title: "EcdhKeyManagement"
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `EcdhKeyManagement`
...
**Namespace:** Jose
**Module:** Jose
**Type:** `public class EcdhKeyManagement : IKeyManagement`
**Base:** `IKeyManagement`
**File:** `Bannerlord.Source/bin/jose-jwt/Jose/EcdhKeyManagement.cs`

## Overview

`EcdhKeyManagement` lives in `Jose` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
**Purpose:** Handles logic related to `wrap`.
...
```csharp
var value = new EcdhKeyManagement();
