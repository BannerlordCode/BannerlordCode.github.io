...
**Purpose:** Sets the value or state of `up additional bone buffer for meshes`.

### CreatePhysxCookingInstance
`public static UIntPtr CreatePhysxCookingInstance()`

**Purpose:** Creates a new `physx cooking instance` instance or object.

### DeletePhysxCookingInstance
`public static void DeletePhysxCookingInstance(UIntPtr pointer)`

**Purpose:** Handles logic related to `delete physx cooking instance`.

### DeleteEmptyShape
`public void DeleteEmptyShape(UIntPtr shape1, UIntPtr shape2)`

**Purpose:** Handles logic related to `delete empty shape`.
...
**Purpose:** Handles logic related to `swap physx shape in entity`.
...
**Purpose:** Handles logic related to `cook triangle physx mesh`.
