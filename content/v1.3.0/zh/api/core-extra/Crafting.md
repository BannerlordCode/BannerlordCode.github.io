...
**用途 / Purpose:** 调用 SwitchToCraftedItem 对应的操作。
...
**用途 / Purpose:** 调用 ScaleThePiece 对应的操作。
...
**用途 / Purpose:** 生成crafted item的实例、数据或表示。
...
**用途 / Purpose:** 调用 FillWeapon 对应的操作。
