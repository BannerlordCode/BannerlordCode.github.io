...
`SkillObjectComparer` lives in `TaleWorlds.CampaignSystem.ViewModelCollection`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
SkillObjectComparer.GetTooltipForAccumulatingProperty("example", 0, explainedNumber);
```
