...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CampaignBehaviors/EncounterGameMenuBehavior.cs`
...
**Purpose:** Handles logic related to `game_menu_encounter_naval_disengaged_init`.
