...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 random stuff 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest settlement to settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest settlement to mobile party。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest settlement to point。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest hideout to settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest hideout to mobile party。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest town to settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest town to mobile party。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的next settlement around mobile party。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest castle to settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest castle to mobile party。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest fortification to settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest fortification to mobile party。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的furthest fortification to settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest village to settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的nearest village to mobile party。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的random settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的random hideout。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TakeEnemyVillagersOutsideSettlements 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 random town 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 best settlement to spawn around 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 all heroes of settlement 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 garrison starving 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnNotablesIfNeeded 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 neighbor score for considering clan 的结果。
