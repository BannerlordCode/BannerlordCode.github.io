...
description: "CommentOnEndPlayerBattleBehavior 的自动生成类参考。"
---
...
**File:** `TaleWorlds.CampaignSystem/CampaignBehaviors/CommentBehaviors/CommentOnEndPlayerBattleBehavior.cs`
...
```csharp
// 先通过子系统 API 拿到 CommentOnEndPlayerBattleBehavior 实例
