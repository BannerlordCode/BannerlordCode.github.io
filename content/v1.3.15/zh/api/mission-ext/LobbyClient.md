...
**用途 / Purpose:** **用途 / Purpose:** 把若干channel连接成一个整体。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 LeaveChannel 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 other players state 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 login 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BuyCosmetic 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 cosmetics info 的结果。
