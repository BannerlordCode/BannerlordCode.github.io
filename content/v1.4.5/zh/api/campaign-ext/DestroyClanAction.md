...
**Type:** static class
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Actions/DestroyClanAction.cs`
...
**用途 / Purpose:** **用途 / Purpose:** 将 by failed rebellion 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by clan leader death 的效果应用到当前对象。
