...
- Mutations: [Actions](../../api/campaign-ext/actions-index) · [`GiveGoldAction`](../../api/campaign-ext/GiveGoldAction) · [`KillCharacterAction`](../../api/campaign-ext/KillCharacterAction) · [`ChangeKingdomAction`](../../api/campaign-ext/ChangeKingdomAction)
