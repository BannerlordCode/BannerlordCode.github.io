...
> 本页为自动生成的存根。`AcceptingCallToWarAgreementDecisionItemVM` 是 `TaleWorlds.CampaignSystem.ViewModelCollection.KingdomManagement.Decisions.ItemTypes` 命名空间下的一个类 class。
