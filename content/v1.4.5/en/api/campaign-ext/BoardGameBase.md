...
**Purpose:** Determines whether the this instance already holds moves available.
...
**Purpose:** Reads and returns the total moves available value held by the this instance.
...
**Purpose:** Executes the PlayDiceRollSound logic.
...
**Purpose:** Reads and returns the player one units alive value held by the this instance.
...
**Purpose:** Reads and returns the player two units alive value held by the this instance.
...
**Purpose:** Reads and returns the player one units dead value held by the this instance.
...
**Purpose:** Reads and returns the player two units dead value held by the this instance.
...
**Purpose:** Executes the ForceDice logic.
