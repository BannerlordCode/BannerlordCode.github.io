...
description: "ChoosingSkillFocusStep1Tutorial 的自动生成类参考。"
---
...
**File:** `StoryMode.GauntletUI/Tutorial/ChoosingSkillFocusStep1Tutorial.cs`
...
```csharp
// 先通过子系统 API 拿到 ChoosingSkillFocusStep1Tutorial 实例
