...
**命名空间:** TaleWorlds.MountAndBlade.ViewModelCollection.HUD.KillFeed.General
...
> 本页为自动生成的存根。`SPGeneralKillNotificationVM` 是 `TaleWorlds.MountAndBlade.ViewModelCollection.HUD.KillFeed.General` 命名空间下的一个类 class。
