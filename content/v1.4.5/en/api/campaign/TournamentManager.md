...
**Purpose:** Reads and returns the `tournament game` value held by the current object.
...
**Purpose:** Reads and returns the `leaderboard` value held by the current object.
...
**Purpose:** Reads and returns the `leader board rank` value held by the current object.
...
**Purpose:** Reads and returns the `leader board leader` value held by the current object.
