...
**用途 / Purpose:** **用途 / Purpose:** 从持久化存储或流中读取 context extension。
...
**用途 / Purpose:** **用途 / Purpose:** 从持久化存储或流中读取 extensions。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ShaderSource 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 uniform location 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 UniformMatrix4fv 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BlendFuncSeparateDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ActiveTextureDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BindVertexArrayDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GenVertexArraysDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 VertexAttribPointerDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EnableVertexAttribArrayDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DisableVertexAttribArrayDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GenBuffersDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BindBufferDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BufferDataDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BufferSubDataDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DetachShaderDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DeleteShaderDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 program info log delegate 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 shader info log delegate 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 programiv delegate 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 shaderiv delegate 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Uniform4fDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Uniform1iDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Uniform1fDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Uniform2fDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 UseProgramDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DeleteProgramDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 LinkProgramDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AttachShaderDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CompileShaderDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 program object delegate 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 shader object delegate 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 wglCreateContextAttribsDelegate 对应的操作。
