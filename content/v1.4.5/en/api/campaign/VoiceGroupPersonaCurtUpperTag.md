...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `VoiceGroupPersonaCurtUpperTag`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Conversation.Tags/VoiceGroupPersonaCurtUpperTag.cs`
