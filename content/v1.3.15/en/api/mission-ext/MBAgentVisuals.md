...
**Purpose:** **Purpose:** Constructs a new agent visuals entity and returns it to the caller.
...
**Purpose:** **Purpose:** Reads and returns the weak entity value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the global stable eye point value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the global stable neck point value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to attached position for mesh after animation post integrate and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the current head look direction value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the movement mode value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the visual strength of agent visual value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the real bone index value held by the this instance.
...
**Purpose:** **Purpose:** Adds prefab to agent visual bone by bone type to the current collection or state.
...
**Purpose:** **Purpose:** Adds prefab to agent visual bone by real bone index to the current collection or state.
...
**Purpose:** **Purpose:** Reads and returns the attached weapon entity value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to entity and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the FillEntityWithBodyMeshesWithoutAgentVisuals logic.
...
**Purpose:** **Purpose:** Reads and returns the bone type data value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the skeleton value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to skeleton and updates the object's internal state.
...
**Purpose:** **Purpose:** Constructs a new particle system attached to bone entity and returns it to the caller.
...
**Purpose:** **Purpose:** Adds child entity to the current collection or state.
...
**Purpose:** **Purpose:** Assigns a new value to cloth wind to weapon at index and updates the object's internal state.
...
**Purpose:** **Purpose:** Removes child entity from the current collection or state.
...
**Purpose:** **Purpose:** Adds skin meshes to the current collection or state.
...
**Purpose:** **Purpose:** Assigns a new value to lod atlas shading index and updates the object's internal state.
...
**Purpose:** **Purpose:** Removes all visual components from the this instance.
...
**Purpose:** **Purpose:** Executes the LazyUpdateAgentRendererData logic.
...
**Purpose:** **Purpose:** Applies the effect of skeleton scale to the this instance.
...
**Purpose:** **Purpose:** Recalculates and stores the latest representation of skeleton scale.
...
**Purpose:** **Purpose:** Adds horse reins cloth mesh to the current collection or state.
...
**Purpose:** **Purpose:** Executes the BatchLastLodMeshes logic.
...
**Purpose:** **Purpose:** Adds weapon to agent entity to the current collection or state.
...
**Purpose:** **Purpose:** Recalculates and stores the latest representation of quiver meshes without agent.
...
**Purpose:** **Purpose:** Assigns a new value to wielded weapon indices and updates the object's internal state.
...
**Purpose:** **Purpose:** Removes all all weapon meshes from the this instance.
...
**Purpose:** **Purpose:** Removes all weapon meshes from the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to setup morph node and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the facegen scaling matrix value held by the this instance.
...
**Purpose:** **Purpose:** Executes the ReplaceMeshWithMesh logic.
...
**Purpose:** **Purpose:** Assigns a new value to voice definition index and updates the object's internal state.
...
**Purpose:** **Purpose:** Starts the rhubarb record flow or state machine.
...
**Purpose:** **Purpose:** Assigns a new value to enable occlusion culling and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to agent lod zero or max and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to agent local speed and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to look direction and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the body mesh index value held by the this instance.
...
**Purpose:** **Purpose:** Returns next frame to its default or initial condition.
