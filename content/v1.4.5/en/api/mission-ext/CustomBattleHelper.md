...
**Purpose:** Reads and returns the index from game type string id value held by the this instance.
...
**Purpose:** Reads and returns the troop counts value held by the this instance.
...
**Purpose:** Reads and returns the wall hitpoint percentages value held by the this instance.
...
**Purpose:** Reads and returns the siege weapon type value held by the this instance.
...
**Purpose:** Reads and returns the custom battle parties value held by the this instance.
...
**Purpose:** Executes the AssertMissingTroopsForDebug logic.
...
**Purpose:** Reads and returns the default troop of formation for faction value held by the this instance.
