...
**用途 / Purpose:** 将 by released after battle 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by ransom 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by peace 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by escape 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by released by choice 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by released by compensation 的效果应用到当前对象。
