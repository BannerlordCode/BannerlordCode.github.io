...
**用途 / Purpose:** **用途 / Purpose:** 将key type注册到当前系统，以便后续监听或分发。
...
**用途 / Purpose:** **用途 / Purpose:** 将value type注册到当前系统，以便后续监听或分发。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 key type 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 value type 的结果。
