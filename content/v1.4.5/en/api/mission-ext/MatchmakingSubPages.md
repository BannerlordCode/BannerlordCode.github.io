---
title: "MatchmakingSubPages"
description: "Auto-generated class reference for MatchmakingSubPages."
---
# MatchmakingSubPages

**Namespace:** TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Lobby
**Module:** TaleWorlds.MountAndBlade
**Type:** `public enum MatchmakingSubPages`
**Base:** none
...
`MatchmakingSubPages` lives in `TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Lobby` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
