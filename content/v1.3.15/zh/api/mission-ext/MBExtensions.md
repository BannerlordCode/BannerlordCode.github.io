...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 global organic direction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 global head direction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的all with compatible type。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 first child entity with name 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否已经持有 parent of type。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 opponent of 状态或条件。
