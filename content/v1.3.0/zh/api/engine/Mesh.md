...
**用途 / Purpose:** 调用 ComputeNormals 对应的操作。
...
**用途 / Purpose:** 调用 HintIndicesDynamic 对应的操作。
...
**用途 / Purpose:** 调用 HintVerticesDynamic 对应的操作。
...
**用途 / Purpose:** 调用 DisableContour 对应的操作。
...
**用途 / Purpose:** 调用 LockEditDataWrite 对应的操作。
...
**用途 / Purpose:** 调用 UnlockEditDataWrite 对应的操作。
