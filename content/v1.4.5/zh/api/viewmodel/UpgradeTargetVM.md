...
**Base:** `ViewModel`
**File:** `bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.Party/UpgradeTargetVM.cs`
...
**用途 / Purpose:** **用途 / Purpose:** 执行 upgrade encyclopedia link 对应的操作或工作流。
