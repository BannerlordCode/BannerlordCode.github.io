...
**Purpose:** **Purpose:** Reads and returns the companion with most kills value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the companion with most issues solved value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the most expensive item crafted value held by the this instance.
