...
`DiplomacyModel` is a game Model — a rules/override point. Subclass it and register via `Game.Current.ReplaceModel<DiplomacyModel>(new MyDiplomacyModel())` to change how it computes.
...
```csharp
// Typical usage of DiplomacyModel (Model)
