...
**Purpose:** Reads and returns the `script count` value held by the current object.
...
**Purpose:** Reads and returns the `script at index` value held by the current object.
...
**Purpose:** Reads and returns the `first script with name hash` value held by the current object.
...
**Purpose:** Reads and returns the `global wind velocity with gust noise of scene` value held by the current object.
