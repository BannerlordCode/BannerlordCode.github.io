...
**Purpose:** Reads and returns the election outcome support value held by the this instance.
...
**Purpose:** Assigns a new value to up result without player support and updates the object's internal state.
...
**Purpose:** Reads and returns the likelihood for sponsor value held by the this instance.
...
**Purpose:** Reads and returns the win chance for sponsor value held by the this instance.
...
**Purpose:** Reads and returns the decision outcome support for sponsor value held by the this instance.
...
**Purpose:** Reads and returns the relation change with sponsor value held by the this instance.
...
**Purpose:** Reads and returns the win chance with player support value held by the this instance.
...
**Purpose:** Reads and returns the influence cost of outcome value held by the this instance.
...
**Purpose:** Invoked when the player abstained as ruler event is raised.
...
**Purpose:** Applies the effect of selection to the this instance.
...
**Purpose:** Reads and returns the sorted decision outcomes value held by the this instance.
...
**Purpose:** Reads and returns the title value held by the this instance.
