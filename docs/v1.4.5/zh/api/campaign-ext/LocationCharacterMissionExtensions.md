<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `LocationCharacterMissionExtensions`
- [← 本领域 / 返回 campaign-ext](./)
- [↑ API 目录](../)
- [🏠 首页 v1.4.5](../../)
- [⭐ 版本架构](../../architecture/)
...
**命名空间:** SandBox
**模块:** SandBox
**类型:** `public static class LocationCharacterMissionExtensions`
**领域:** campaign-ext

## 概述

`LocationCharacterMissionExtensions` 位于 `SandBox`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
...
**用途 / Purpose:** 获取 `agent build data` 的当前值。
