...
**用途 / Purpose:** 调用 ForceCloseContextMenus 对应的操作。
...
**用途 / Purpose:** 调用 RequestExit 对应的操作。
...
**用途 / Purpose:** 调用 ConnectionStateUpdated 对应的操作。
...
**用途 / Purpose:** 显示options changed inquiry对应的界面或元素。
