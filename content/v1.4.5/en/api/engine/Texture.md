...
**Purpose:** Reads and returns the pixel data value held by the this instance.
...
**Purpose:** Executes the TransformRenderTargetToResource logic.
...
**Purpose:** Reads and returns the s d f bounding box data value held by the this instance.
...
**Purpose:** Verifies whether and get from resource holds true for the this instance.
...
**Purpose:** Executes the ScaleTextureWithRatio logic.
...
**Purpose:** Executes the PreloadTexture logic.
...
**Purpose:** Executes the ReleaseImmediately logic.
...
**Purpose:** Executes the ReleaseAfterNumberOfFrames logic.
...
**Purpose:** Executes the ReleaseGpuMemories logic.
