...
**Purpose:** Determines whether the this instance is in the default editor scene state or condition.
...
**Purpose:** Determines whether the this instance is in the multiplayer scene state or condition.
...
**Purpose:** Executes the TakePhotoModePicture logic.
...
**Purpose:** Reads and returns the all color grade names value held by the this instance.
...
**Purpose:** Reads and returns the all filter names value held by the this instance.
...
**Purpose:** Reads and returns the photo mode roll value held by the this instance.
...
**Purpose:** Reads and returns the photo mode orbit value held by the this instance.
...
**Purpose:** Reads and returns the photo mode on value held by the this instance.
...
**Purpose:** Reads and returns the photo mode focus value held by the this instance.
...
**Purpose:** Reads and returns the scene color grade index value held by the this instance.
...
**Purpose:** Reads and returns the scene filter index value held by the this instance.
...
**Purpose:** Executes the EnableFixedTick logic.
...
**Purpose:** Reads and returns the loading state name value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the loading finished state or condition.
...
**Purpose:** Reads and returns the fall density value held by the this instance.
...
**Purpose:** Reads and returns the photo mode fov value held by the this instance.
...
**Purpose:** Determines whether the this instance already holds decal renderer.
...
**Purpose:** Reads and returns the terrain height data value held by the this instance.
...
**Purpose:** Reads and returns the terrain physics material index data value held by the this instance.
...
**Purpose:** Reads and returns the terrain data value held by the this instance.
...
**Purpose:** Reads and returns the terrain node data value held by the this instance.
...
**Purpose:** Reads and returns the terrain physics material at layer value held by the this instance.
...
**Purpose:** Reads and returns the water level value held by the this instance.
...
**Purpose:** Reads and returns the water speed at position value held by the this instance.
...
**Purpose:** Reads and returns the bulk water level at positions value held by the this instance.
...
**Purpose:** Reads and returns the interpolation factor for body world transform smoothing value held by the this instance.
...
**Purpose:** Reads and returns the bulk water level at volumes value held by the this instance.
...
**Purpose:** Reads and returns the water strength value held by the this instance.
...
**Purpose:** Executes the DeRegisterShipVisual logic.
...
**Purpose:** Reads and returns the path between a i faces value held by the this instance.
...
**Purpose:** Determines whether the this instance already holds navmesh face unshared edges.
...
**Purpose:** Reads and returns the navmesh face count between two ids value held by the this instance.
...
**Purpose:** Reads and returns the navmesh face records between two ids value held by the this instance.
...
**Purpose:** Reads and returns the path distance between a i faces value held by the this instance.
...
**Purpose:** Reads and returns the nav mesh face index value held by the this instance.
...
**Purpose:** Reads and returns the wind flow map data value held by the this instance.
...
**Purpose:** Reads and returns the entity with guid value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the entity frame changed state or condition.
...
**Purpose:** Reads and returns the terrain height and normal value held by the this instance.
...
**Purpose:** Reads and returns the flora instance count value held by the this instance.
...
**Purpose:** Reads and returns the flora renderer texture usage value held by the this instance.
...
**Purpose:** Reads and returns the terrain memory usage value held by the this instance.
...
**Purpose:** Reads and returns the scene x m l c r c value held by the this instance.
...
**Purpose:** Reads and returns the navigation mesh c r c value held by the this instance.
...
**Purpose:** Reads and returns the global wind strength vector value held by the this instance.
...
**Purpose:** Reads and returns the global wind velocity value held by the this instance.
...
**Purpose:** Reads and returns the engine physics enabled value held by the this instance.
...
**Purpose:** Removes all nav mesh from the this instance.
...
**Purpose:** Executes the StallLoadingRenderingsUntilFurtherNotice logic.
...
**Purpose:** Reads and returns the nav mesh face count value held by the this instance.
...
**Purpose:** Executes the ResumeLoadingRenderings logic.
...
**Purpose:** Reads and returns the id of nav mesh face value held by the this instance.
...
**Purpose:** Reads and returns the nav mesh center position value held by the this instance.
...
**Purpose:** Reads and returns the nav mesh path face record value held by the this instance.
...
**Purpose:** Reads and returns the path face record from nav mesh face pointer value held by the this instance.
...
**Purpose:** Reads and returns the all navmesh face records value held by the this instance.
...
**Purpose:** Reads and returns the first entity with name value held by the this instance.
...
**Purpose:** Reads and returns the campaign entity with name value held by the this instance.
...
**Purpose:** Reads and returns the first entity with script component value held by the this instance.
...
**Purpose:** Reads and returns the upgrade level mask of level name value held by the this instance.
...
**Purpose:** Reads and returns the upgrade level name of index value held by the this instance.
...
**Purpose:** Reads and returns the upgrade level count value held by the this instance.
...
**Purpose:** Reads and returns the winter time factor value held by the this instance.
...
**Purpose:** Reads and returns the nav mesh face first vertex z value held by the this instance.
...
**Purpose:** Reads and returns the fog value held by the this instance.
...
**Purpose:** Reads and returns the rain density value held by the this instance.
...
**Purpose:** Reads and returns the snow density value held by the this instance.
...
**Purpose:** Executes the AttachEntity logic.
...
**Purpose:** Reads and returns the path distance between positions value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the line to point clear state or condition.
...
**Purpose:** Reads and returns the last point on navigation mesh from position to destination value held by the this instance.
...
**Purpose:** Reads and returns the last position on nav mesh face for point and direction value held by the this instance.
...
**Purpose:** Reads and returns the last point on navigation mesh from world position to destination value held by the this instance.
...
**Purpose:** Returns a boolean answer to whether path exist between faces is true for the this instance.
...
**Purpose:** Reads and returns the height at point value held by the this instance.
...
**Purpose:** Reads and returns the normal at value held by the this instance.
...
**Purpose:** Reads and returns the entities value held by the this instance.
...
**Purpose:** Reads and returns the root entities value held by the this instance.
...
**Purpose:** Executes the SelectEntitiesCollidedWith logic.
...
**Purpose:** Executes the RayCastExcludingTwoEntities logic.
...
**Purpose:** Executes the InvalidateTerrainPhysicsMaterials logic.
...
**Purpose:** Executes the OptimizeScene logic.
...
**Purpose:** Reads and returns the terrain height value held by the this instance.
...
**Purpose:** Executes the ForceLoadResources logic.
...
**Purpose:** Reads and returns the ground height at position value held by the this instance.
...
**Purpose:** Reads and returns the ground height and body flags at position value held by the this instance.
...
**Purpose:** Executes the PauseSceneSounds logic.
...
**Purpose:** Executes the ResumeSceneSounds logic.
...
**Purpose:** Executes the BoxCastOnlyForCamera logic.
...
**Purpose:** Executes the BoxCast logic.
...
**Purpose:** Executes the RayCastForClosestEntityOrTerrainFixedPhysics logic.
...
**Purpose:** Executes the FocusRayCastForFixedPhysics logic.
...
**Purpose:** Executes the RayCastForRamming logic.
...
**Purpose:** Executes the RayCastForClosestEntityOrTerrainIgnoreEntity logic.
...
**Purpose:** Executes the ImportNavigationMeshPrefab logic.
...
**Purpose:** Executes the ImportNavigationMeshPrefabWithFrame logic.
...
**Purpose:** Executes the MarkFacesWithIdAsLadder logic.
...
**Purpose:** Assigns a new value to blocker direction for faces with id and updates the object's internal state.
...
**Purpose:** Executes the SwapFaceConnectionsWithID logic.
...
**Purpose:** Executes the MergeFacesWithId logic.
...
**Purpose:** Executes the SeparateFacesWithId logic.
...
**Purpose:** Determines whether the this instance is in the any face with id state or condition.
...
**Purpose:** Reads and returns the navigation mesh for position value held by the this instance.
...
**Purpose:** Reads and returns the nearest navigation mesh for position value held by the this instance.
...
**Purpose:** Returns a boolean answer to whether path exist between positions is true for the this instance.
...
**Purpose:** Reads and returns the sun direction value held by the this instance.
...
**Purpose:** Reads and returns the north angle value held by the this instance.
...
**Purpose:** Reads and returns the north rotation value held by the this instance.
...
**Purpose:** Reads and returns the terrain min max height value held by the this instance.
...
**Purpose:** Reads and returns the physics min max value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the editor scene state or condition.
...
**Purpose:** Reads and returns the soft boundary vertex count value held by the this instance.
...
**Purpose:** Reads and returns the hard boundary vertex count value held by the this instance.
...
**Purpose:** Reads and returns the soft boundary vertex value held by the this instance.
...
**Purpose:** Reads and returns the hard boundary vertex value held by the this instance.
...
**Purpose:** Reads and returns the path with name value held by the this instance.
...
**Purpose:** Executes the DeletePathWithName logic.
...
**Purpose:** Reads and returns the scene limits value held by the this instance.
...
**Purpose:** Reads and returns the module path value held by the this instance.
...
**Purpose:** Reads and returns the paths with name prefix value held by the this instance.
...
**Purpose:** Verifies whether point can see point holds true for the this instance.
...
**Purpose:** Executes the DisableStaticShadows logic.
...
**Purpose:** Reads and returns the skybox mesh value held by the this instance.
...
**Purpose:** Executes the FillEntityWithHardBorderPhysicsBarrier logic.
...
**Purpose:** Removes all decals from the this instance.
...
**Purpose:** Determines whether the this instance is in the position on a dynamic nav mesh state or condition.
...
**Purpose:** Executes the EnableInclusiveAsyncPhysx logic.
...
**Purpose:** Executes the DeleteWaterWakeRenderer logic.
...
**Purpose:** Executes the SceneHadWaterWakeRenderer logic.
...
**Purpose:** Executes the response logic associated with current frame tick entities.
...
**Purpose:** Removes all current frame tick entities from the this instance.
...
**Purpose:** Assigns a new value to use advanced water rendering and updates the object's internal state.
