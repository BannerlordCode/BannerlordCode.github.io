...
**Purpose:** Executes the FormOrderCustom logic.
...
**Purpose:** Reads and returns the unit count of value held by the this instance.
...
**Purpose:** Reads and returns the max file count static value held by the this instance.
