...
**Purpose:** Reads and returns the last seen text value held by the this instance.
...
**Purpose:** Reads and returns the closest settlement value held by the this instance.
...
**Purpose:** Executes the LordWillConspireWithLord logic.
...
**Purpose:** Executes the UnderPlayerCommand logic.
...
**Purpose:** Reads and returns the title in indefinite case value held by the this instance.
...
**Purpose:** Reads and returns the character type name value held by the this instance.
...
**Purpose:** Reads and returns the occupied event reason text value held by the this instance.
...
**Purpose:** Executes the OrderHeroesOnPlayerSideByPriority logic.
...
**Purpose:** Executes the WillLordAttack logic.
...
**Purpose:** Executes the SpawnHeroForTheFirstTime logic.
...
**Purpose:** Executes the DefaultRelation logic.
...
**Purpose:** Determines whether the this instance is in the companion in player party state or condition.
...
**Purpose:** Executes the NPCPoliticalDifferencesWithNPC logic.
...
**Purpose:** Executes the NPCPersonalityClashWithNPC logic.
...
**Purpose:** Executes the TraitHarmony logic.
...
**Purpose:** Executes the HeroCanRecruitFromHero logic.
...
**Purpose:** Reads and returns the volunteer troops of hero for recruitment value held by the this instance.
...
**Purpose:** Reads and returns the random clan for notable value held by the this instance.
...
**Purpose:** Reads and returns the random birth day for age value held by the this instance.
...
**Purpose:** Reads and returns the random death day and birth day value held by the this instance.
...
**Purpose:** Reads and returns the personality trait change name value held by the this instance.
...
**Purpose:** Looks up the matching a suitable settlement to teleport for hero in the current collection or scope.
