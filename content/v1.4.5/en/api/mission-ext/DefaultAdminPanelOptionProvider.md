...
**Purpose:** Reads and returns the option with id value held by the this instance.
...
**Purpose:** Reads and returns the action with id value held by the this instance.
...
**Purpose:** Applies the effect of options to the this instance.
...
**Purpose:** Reads and returns the option groups value held by the this instance.
