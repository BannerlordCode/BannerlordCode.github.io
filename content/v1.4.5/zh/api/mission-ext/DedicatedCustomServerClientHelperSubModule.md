...
**用途 / Purpose:** **用途 / Purpose:** 在 create state 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 pop state 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 push state 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 clean states 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DownloadMapFromHost 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 map list from host 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DownloadMapCommand 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 map list command 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 打开download panel对应的资源或界面。
