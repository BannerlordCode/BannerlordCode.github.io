...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 zero corner bodies。
...
**用途 / Purpose:** **用途 / Purpose:** 从持久化存储或流中读取 atmosphere data。
...
**用途 / Purpose:** **用途 / Purpose:** 在每一帧或每个更新周期内推进step sound的状态。
...
**用途 / Purpose:** **用途 / Purpose:** 在每一帧或每个更新周期内推进ambient sounds的状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 apply rain color grade 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SendMouseKeyEvent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 mouse pos 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 在每一帧或每个更新周期内推进visuals的状态。
...
**用途 / Purpose:** **用途 / Purpose:** 检查terrain sound ids是否满足约束条件，通常返回布尔值。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 global illumination of string 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 color grade grid data 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 battle scene index map 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 frame for atmosphere 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 terrain dynamic params 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 season time factor 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 season time factor 的结果。
