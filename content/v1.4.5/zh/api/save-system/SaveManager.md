...
**用途 / Purpose:** **用途 / Purpose:** 为 global definition context 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** **用途 / Purpose:** 检查saveable types在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ShouldResolveConflicts 对应的操作。
