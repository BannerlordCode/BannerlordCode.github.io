...
**Purpose:** Determines whether the this instance is in the channel modified state or condition.
...
**Purpose:** Executes the PlayConversationSoundEvent logic.
...
**Purpose:** Executes the FadeOutCharacter logic.
...
**Purpose:** Invoked when the game state changed event is raised.
