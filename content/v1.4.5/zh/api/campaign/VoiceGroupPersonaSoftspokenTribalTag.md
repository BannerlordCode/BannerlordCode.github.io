...
description: "VoiceGroupPersonaSoftspokenTribalTag 的自动生成类参考。"
---
...
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Conversation.Tags/VoiceGroupPersonaSoftspokenTribalTag.cs`
...
```csharp
// 先通过子系统 API 拿到 VoiceGroupPersonaSoftspokenTribalTag 实例
