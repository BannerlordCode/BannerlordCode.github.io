...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `SourceTypes`
...
**Type:** `public enum SourceTypes`
**Area:** mission-ext

## Overview

`SourceTypes` lives in `TaleWorlds.MountAndBlade.View.Tableaus.Thumbnails`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
```csharp
SourceTypes example = SourceTypes.Undefined;
```
