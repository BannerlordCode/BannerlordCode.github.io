...
description: "EncyclopediaHomeTutorial 的自动生成类参考。"
---
...
**File:** `Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/EncyclopediaHomeTutorial.cs`
...
```csharp
// 先通过子系统 API 拿到 EncyclopediaHomeTutorial 实例
