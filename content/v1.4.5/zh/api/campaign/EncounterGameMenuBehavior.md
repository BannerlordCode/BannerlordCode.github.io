...
**用途 / Purpose:** 调用 game_menu_captivity_taken_prisoner_cheat_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_captivity_castle_taken_prisoner_cont_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 menu_sneak_into_town_succeeded_continue_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 menu_sneak_into_town_succeeded_continue_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_sneak_into_town_caught_on_init 对应的操作。
...
**用途 / Purpose:** 调用 mno_sneak_caught_surrender_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 mno_sneak_caught_surrender_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_captivity_taken_prisoner_cheat_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_captivity_castle_taken_prisoner_cont_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_request_entry_to_castle_approved_continue_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_request_entry_to_castle_approved_continue_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 game_request_entry_to_castle_rejected_continue_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 menu_castle_entry_denied_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_castle_menu_sound_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_encounter_naval_disengaged_init 对应的操作。
