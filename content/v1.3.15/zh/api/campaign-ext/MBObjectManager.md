...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的registered class prefix。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的registered type。
...
**用途 / Purpose:** 调用 MergeElementAttributes 对应的操作。
...
**用途 / Purpose:** 调用 MergeElements 对应的操作。
...
**用途 / Purpose:** 调用 MergeTwoXmls 对应的操作。
...
**用途 / Purpose:** 调用 ToXDocument 对应的操作。
...
**用途 / Purpose:** 调用 ToXmlDocument 对应的操作。
...
**用途 / Purpose:** 清空当前对象中的all objects。
...
**用途 / Purpose:** 清空当前对象中的all objects with type。
...
**用途 / Purpose:** 从当前实例读取object reference from xml相关数据。
...
**用途 / Purpose:** 调用 DebugPrint 对应的操作。
...
**用途 / Purpose:** 调用 ReInitialize 对应的操作。
