...
**Base:** none
**File:** `TaleWorlds.TwoDimension/TextOutput.cs`
...
| `LastLineWidth` | `public float LastLineWidth { get; }` |
...
**Purpose:** Reads and returns the line value held by the this instance.
