...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `RewardType`
...
**Type:** `public enum RewardType`
**Area:** mission-ext

## Overview

`RewardType` lives in `TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Lobby.AfterBattle`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
```csharp
RewardType example = RewardType.Loot;
```
