...
`StreamHelpers` lives in `TaleWorlds.Library`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
StreamHelpers.ParseStream(subtitleStream, encoding);
```
