...
**用途 / Purpose:** 调用 BeginPlayerBarter 对应的操作。
...
**用途 / Purpose:** 启动barter offer流程或状态机。
...
**用途 / Purpose:** 执行 ai barter 对应的操作或工作流。
...
**用途 / Purpose:** 执行 a i barter 对应的操作或工作流。
...
**用途 / Purpose:** 判断当前对象是否处于 offer acceptable 状态或条件。
...
**用途 / Purpose:** 读取并返回当前对象中 offer value for faction 的结果。
...
**用途 / Purpose:** 读取并返回当前对象中 offer value 的结果。
...
**用途 / Purpose:** 将 and finalize player barter 的效果应用到当前对象。
...
**用途 / Purpose:** 检查当前对象是否满足 cel and finalize player barter 的前置条件。
...
**用途 / Purpose:** 检查当前对象是否满足 player barter with hero 的前置条件。
...
**用途 / Purpose:** 为 marriage barter context 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** 为 join faction barter context 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** 为 make peace barter context 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** 为 safe passage barter context 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** 调用 BarterContextInitializer 对应的操作。
...
**用途 / Purpose:** 调用 BarterCloseEventDelegate 对应的操作。
...
**用途 / Purpose:** 调用 BarterBeginEventDelegate 对应的操作。
