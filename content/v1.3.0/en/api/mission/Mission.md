...
**Purpose:** Reads and returns the battle size offset value held by the this instance.
...
**Purpose:** Reads and returns the path offset from distance value held by the this instance.
...
**Purpose:** Reads and returns the battle size factor value held by the this instance.
