...
description: "BombardmentStep1Tutorial 的自动生成类参考。"
---
...
**File:** `Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/BombardmentStep1Tutorial.cs`
...
```csharp
// 先通过子系统 API 拿到 BombardmentStep1Tutorial 实例
