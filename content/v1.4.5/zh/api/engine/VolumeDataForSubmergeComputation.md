...
---
<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `VolumeDataForSubmergeComputation`
- [← 本领域 / 返回 engine](./)
- [↑ API 目录](../)
- [🏠 首页 v1.4.5](../../)
- [⭐ 版本架构](../../architecture/)
...
**Base:** 无
**File:** `Bannerlord.Source/bin/TaleWorlds.Engine/TaleWorlds.Engine/VolumeDataForSubmergeComputation.cs`
...
```csharp
var example = new VolumeDataForSubmergeComputation();
```
