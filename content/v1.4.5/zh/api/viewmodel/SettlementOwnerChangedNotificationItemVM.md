...
description: "SettlementOwnerChangedNotificationItemVM 的自动生成类参考。"
---
...
**File:** `bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.Map.MapNotificationTypes/SettlementOwnerChangedNotificationItemVM.cs`
...
```csharp
// 先通过子系统 API 拿到 SettlementOwnerChangedNotificationItemVM 实例
