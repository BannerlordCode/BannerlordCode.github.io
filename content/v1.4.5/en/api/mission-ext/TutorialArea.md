...
**Purpose:** Executes the MarkTrainingIcons logic.
...
**Purpose:** Reads and returns the active training icon value held by the this instance.
...
**Purpose:** Reads and returns the index from tag value held by the this instance.
...
**Purpose:** Reads and returns the sub training tags value held by the this instance.
...
**Purpose:** Executes the EquipWeaponsToPlayer logic.
...
**Purpose:** Reads and returns the breakables count value held by the this instance.
...
**Purpose:** Executes the MakeDestructible logic.
...
**Purpose:** Executes the MarkAllTargets logic.
...
**Purpose:** Executes the MakeInDestructible logic.
...
**Purpose:** Executes the AllBreakablesAreBroken logic.
...
**Purpose:** Reads and returns the broken breakable count value held by the this instance.
...
**Purpose:** Reads and returns the unbroken breakable count value held by the this instance.
...
**Purpose:** Determines whether the this instance already holds main agent picked all.
...
**Purpose:** Verifies whether main agent equipment holds true for the this instance.
...
**Purpose:** Verifies whether weapons holds true for the this instance.
...
**Purpose:** Determines whether the this instance is in the position inside tutorial area state or condition.
