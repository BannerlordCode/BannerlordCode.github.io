...
**Purpose:** Reads and returns the save files value held by the this instance.
...
**Purpose:** Reads and returns the save file names value held by the this instance.
...
**Purpose:** Reads and returns the save file with name value held by the this instance.
...
**Purpose:** Executes the AutoSaveCurrentGame logic.
...
**Purpose:** Executes the DeleteSaveGame logic.
...
**Purpose:** Determines whether the this instance is in the save file name reserved state or condition.
...
**Purpose:** Reads and returns the max number of saves value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the max number of saves reached state or condition.
