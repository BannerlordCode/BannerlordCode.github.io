...
**用途 / Purpose:** 清空当前对象中的party notification。
...
**用途 / Purpose:** 清空当前对象中的character notification。
...
**用途 / Purpose:** 调用 InventorySetSortPreference 对应的操作。
...
**用途 / Purpose:** 调用 InventoryGetSortPreference 对应的操作。
