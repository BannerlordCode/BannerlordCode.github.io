...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 battle size offset 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 path offset from distance 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 battle size factor 的结果。
