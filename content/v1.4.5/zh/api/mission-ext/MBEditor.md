...
**用途 / Purpose:** 调用 RenderEditorMesh 对应的操作。
...
**用途 / Purpose:** 在每一帧或每个更新周期内推进edit mode的状态。
...
**用途 / Purpose:** 调用 EnterEditMissionMode 对应的操作。
...
**用途 / Purpose:** 调用 LeaveEditMissionMode 对应的操作。
...
**用途 / Purpose:** 激活scene editor presentation对应的资源、状态或功能。
...
**用途 / Purpose:** 停用scene editor presentation对应的资源、状态或功能。
...
**用途 / Purpose:** 在每一帧或每个更新周期内推进scene editor presentation的状态。
...
**用途 / Purpose:** 调用 HelpersEnabled 对应的操作。
...
**用途 / Purpose:** 调用 BorderHelpersEnabled 对应的操作。
...
**用途 / Purpose:** 调用 ZoomToPosition 对应的操作。
...
**用途 / Purpose:** 调用 ExitEditMode 对应的操作。
...
**用途 / Purpose:** 调用 ToggleEnableEditorPhysics 对应的操作。
