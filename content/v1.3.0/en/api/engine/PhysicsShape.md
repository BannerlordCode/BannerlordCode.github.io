...
**Purpose:** Executes the ProcessPreloadQueue logic.
...
**Purpose:** Executes the UnloadDynamicBodies logic.
...
**Purpose:** Executes the SphereCount logic.
...
**Purpose:** Reads and returns the sphere value held by the this instance.
...
**Purpose:** Reads and returns the dominant material for triangle mesh value held by the this instance.
...
**Purpose:** Executes the TriangleMeshCount logic.
...
**Purpose:** Executes the TriangleCountInTriangleMesh logic.
...
**Purpose:** Reads and returns the triangle value held by the this instance.
...
**Purpose:** Executes the CapsuleCount logic.
...
**Purpose:** Reads and returns the capsule value held by the this instance.
...
**Purpose:** Reads and returns the bounding box center value held by the this instance.
...
**Purpose:** Executes the Transform logic.
