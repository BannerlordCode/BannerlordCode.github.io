...
**用途 / Purpose:** **用途 / Purpose:** 将 by setting to normal 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by setting to being raided 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by setting to being forced for supplies 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by setting to being forced for volunteers 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by setting to looted 的效果应用到当前对象。
