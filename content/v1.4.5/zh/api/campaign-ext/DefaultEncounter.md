...
**用途 / Purpose:** 调用 game_menu_taken_prisoner_ui_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_defeat_and_taken_prisoner_ui_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_taken_prisoner_town_ui_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_attackers_left_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_new_game_begin_on_init 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_kingdom_mno_call_to_arms_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_encyclopedia_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_town_menu_request_meeting_on_init 对应的操作。
