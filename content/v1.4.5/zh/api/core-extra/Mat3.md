...
**用途 / Purpose:** 调用 RotateAboutSide 对应的操作。
...
**用途 / Purpose:** 调用 RotateAboutForward 对应的操作。
...
**用途 / Purpose:** 调用 RotateAboutUp 对应的操作。
...
**用途 / Purpose:** 调用 Orthonormalize 对应的操作。
...
**用途 / Purpose:** 调用 OrthonormalizeAccordingToForwardAndKeepUpAsZAxis 对应的操作。
...
**用途 / Purpose:** 调用 ToQuaternion 对应的操作。
