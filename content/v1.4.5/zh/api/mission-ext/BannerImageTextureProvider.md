...
**File:** `Modules.Native/TaleWorlds.MountAndBlade.GauntletUI/TaleWorlds.MountAndBlade.GauntletUI.TextureProviders.ImageIdentifiers/BannerImageTextureProvider.cs`
...
```csharp
// 从对应子系统 API 获取实例
BannerImageTextureProvider instance = ...;
```
