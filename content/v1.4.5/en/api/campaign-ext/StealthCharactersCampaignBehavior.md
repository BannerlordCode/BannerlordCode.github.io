...
description: "Auto-generated class reference for StealthCharactersCampaignBehavior."
---
...
`StealthCharactersCampaignBehavior` lives in `SandBox.CampaignBehaviors` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
```csharp
// Obtain an instance of StealthCharactersCampaignBehavior from the subsystem API first
