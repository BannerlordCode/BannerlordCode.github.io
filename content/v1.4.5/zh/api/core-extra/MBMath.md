...
**用途 / Purpose:** **用途 / Purpose:** 调用 ToRadians 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ToDegrees 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ApproximatelyEqualsTo 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ApproximatelyEquals 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClampIndex 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClampInt 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClampFloat 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClampUnit 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 number of bits to represent number 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 LerpFPSIndependent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 LinearExtrapolation 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Map 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 LerpRadians 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将lerp拆分为多个部分或子项。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InverseLerp 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SmoothStep 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 BilinearLerp 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 smallest difference between two angles 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClampAngle 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WrapAngle 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WrapAngleSafe 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 between 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 between inclusive 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ColorFromRGBA 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 HSBtoRGB 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RGBtoHSB 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GammaCorrectRGB 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 signed distance of point to line segment 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 distance square of point to line segment 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ProjectPointOntoLine 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClampToAxisAlignedRectangle 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 ray plane intersection point 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PointLiesAheadOfPlane 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 closest point on line segment to point 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 检查line to line segment intersection在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 IntersectLineSegmentWithTriangle 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 IntersectLineSegmentWithBoundingBox 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 检查line segment to line segment intersection在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 检查point inside polygon在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 检查polygon intersection在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 检查polygon line segment intersection在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 IntersectRayWithPolygon 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ToOrdinal 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的plane line intersection point with normal。
