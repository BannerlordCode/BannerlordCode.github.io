...
**用途 / Purpose:** **用途 / Purpose:** 调用 DownloadStringTaskAsync 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DownloadDataTaskAsync 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PostStringAsync 对应的操作。
