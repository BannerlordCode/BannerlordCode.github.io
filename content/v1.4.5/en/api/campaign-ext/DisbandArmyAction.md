...
**Type:** static class
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Actions/DisbandArmyAction.cs`
...
**Purpose:** Applies the effect of by released by player after battle to the this instance.
...
**Purpose:** Applies the effect of by army leader is dead to the this instance.
...
**Purpose:** Applies the effect of by not enough party to the this instance.
...
**Purpose:** Applies the effect of by objective finished to the this instance.
...
**Purpose:** Applies the effect of by player taken prisoner to the this instance.
...
**Purpose:** Applies the effect of by food problem to the this instance.
...
**Purpose:** Applies the effect of by inactivity to the this instance.
...
**Purpose:** Applies the effect of by cohesion depleted to the this instance.
...
**Purpose:** Applies the effect of by no active war to the this instance.
...
**Purpose:** Applies the effect of by unknown reason to the this instance.
...
**Purpose:** Applies the effect of by leader party removed to the this instance.
...
**Purpose:** Applies the effect of by no ship to the this instance.
