...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 active party state 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as cheat对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as normal对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as ransom对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as manage troops and prisoners对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as manage player clan party closed对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as receive troops对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as manage troops对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as donate troops对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as donate garrison with current settlement对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as donate prisoners对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DonatePrisonerTransferableDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as manage prisoners对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TroopTransferableDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClanManageTroopAndPrisonerTransferableDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ClanManageTroopTransferableDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DonateModeTroopTransferableDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen with condition对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as quest对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen with dummy roster对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen with dummy roster with main party对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开screen as create clan party for hero对应的资源或界面。
