...
**Purpose:** Reads and returns the action for visiting settlement value held by the this instance.
...
**Purpose:** Reads and returns the action for patrolling around settlement value held by the this instance.
...
**Purpose:** Reads and returns the action for patrolling around point value held by the this instance.
...
**Purpose:** Reads and returns the action for raiding settlement value held by the this instance.
...
**Purpose:** Reads and returns the action for besieging settlement value held by the this instance.
...
**Purpose:** Reads and returns the action for engaging party value held by the this instance.
...
**Purpose:** Reads and returns the action for going around party value held by the this instance.
...
**Purpose:** Reads and returns the action for defending settlement value held by the this instance.
...
**Purpose:** Reads and returns the action for escorting party value held by the this instance.
...
**Purpose:** Reads and returns the action for moving to nearest land value held by the this instance.
