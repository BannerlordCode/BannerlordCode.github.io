...
description: "GatherArmyLogEntry 的自动生成类参考。"
---
# GatherArmyLogEntry
...
**Base:** `LogEntry`
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.LogEntries/GatherArmyLogEntry.cs`
...
```csharp
// 先通过子系统 API 拿到 GatherArmyLogEntry 实例
