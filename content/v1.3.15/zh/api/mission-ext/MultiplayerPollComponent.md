...
**用途 / Purpose:** **用途 / Purpose:** 调用 Vote 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RequestKickPlayerPoll 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 cancelled 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 poll progress receivers 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将 vote 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GotEnoughAcceptVotesToEnd 对应的操作。
