...
**Purpose:** Reads and returns the `companion with most kills` value held by the current object.
...
**Purpose:** Reads and returns the `companion with most issues solved` value held by the current object.
...
**Purpose:** Reads and returns the `most expensive item crafted` value held by the current object.
