...
**用途 / Purpose:** **用途 / Purpose:** 将 skill bonus for skill level 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 skill bonus for party 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 skill bonus for town 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 skill bonus for character 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 effect description for skill level 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 effective party leader for skill 的结果。
