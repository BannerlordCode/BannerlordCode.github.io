---
title: "PixelFormatDescriptorFlags"
description: "Auto-generated class reference for PixelFormatDescriptorFlags."
---
...
`PixelFormatDescriptorFlags` lives in `TaleWorlds.TwoDimension.Standalone.Native.Windows` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
PixelFormatDescriptorFlags instance = ...;
```
