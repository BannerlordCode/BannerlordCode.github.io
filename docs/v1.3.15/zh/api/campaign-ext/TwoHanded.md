...
**类型:** `public static class TwoHanded`
**领域:** campaign-ext

## 概述

`TwoHanded` 位于 `TaleWorlds.CampaignSystem.CharacterDevelopment`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
