...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 boundary radius 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 oriented boundaries box 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 在 before agent removed delegate 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 add sound alarm factor to agents delegate 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 main agent changed delegate 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 camera shake triggered delegate 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ComputeTroopBodyPropertiesDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 active mission object 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 激活mission object对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 停用mission object对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 为 mission combat type 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ConversationCharacterChanged 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 mission mode 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 average fps 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 fall avoid system active 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 fall avoid system active 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 position inside boundaries 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 position inside hard boundaries 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 position inside any blocker nav mesh face2 d 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 position on any blocker nav mesh face 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RayCastForClosestAgent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RayCastForClosestAgentsLimbs 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RayCastForGivenAgentsLimbs 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 biggest agent collision padding 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 mission corpse fade out time in seconds 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 override corpse count 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 report stuck agents mode 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 将 mission 重置回默认或初始状态。
...
**用途 / Purpose:** **用途 / Purpose:** 在每一帧或每个更新周期内推进agents and teams async的状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MakeSound 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MakeSoundOnlyOnRelatedPeer 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 dynamically spawned mission object info 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 missile collision point 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 missile as client。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 missile vertical aim correction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为即将执行的missile weapon for drop操作完成前置准备工作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 particle system burst by name 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 closest boundary position 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 free runtime mission object id 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 free scene mission object id 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 camera frame 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 camera frame 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将 first third person view 重置回默认或初始状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera local offset 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera target local offset 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera local offset2 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera local rotational offset 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera global offset 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera fov multiplier 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera fixed distance 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 ignored entity for camera 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 custom camera ignore collision 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 listener and attenuation pos blend factor 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 将 time speed request 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 time speed request。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 requested time speed 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的agent actions。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的missiles。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的corpses。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 agent in proximity map 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 在 mission state activate 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 mission state deactivate 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 mission state finalize 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的unreferenced resources。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 main agent max camera zoom 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 best slope towards direction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 best slope angle height pos for defending 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 average position of agents 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 random decide time of agents with indices 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 bow missile speed modifier 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 crossbow missile speed modifier 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 throwing missile speed modifier 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 missile range modifier 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 last movement key pressed 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 weighted point of enemies 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 path between positions 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 navigation face cost with id around position 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 straight path to target 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SkipForwardMissionReplay 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 debug agent 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将 ai debug text 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 为 debug agent 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 first person fov 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 water level at position m t 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 physics collide between two entities 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 removed agent ratio for side 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 attacker weapons for friendly fire preventing 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 alternate position for navmeshless or out of bounds position 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 next dynamic nav mesh id start 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 agent troop class 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 closest flee position for agent 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 closest flee position for formation 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 flee positions for side 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将 to weapon list for friendly fire preventing 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 为 close proximity wave sounds enabled 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ForceDisableOcclusion 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 flee position 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RetreatMission 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SurrenderMission 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnAttachedWeaponOnCorpse 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 mount without rider 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 mount without rider。
...
**用途 / Purpose:** **用途 / Purpose:** 重新计算并更新 mount reservations after rider mounts 的最新表示。
...
**用途 / Purpose:** **用途 / Purpose:** 在 object disabled 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 尝试获取 get missile velocity from missile index 的值，通常通过 out 参数返回是否成功。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnWeaponAsDropFromMissile 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnWeaponAsDropFromAgentAux 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnAttachedWeaponOnSpawnedWeapon 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnWeaponWithNewEntity 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnWeaponWithNewEntityAux 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AttachWeaponWithNewEntityToSpawnedWeapon 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 在 equip items from spawn equipment begin 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 equip items from spawn equipment 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 current volume generator version 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MakeEnemiesFleeCheat 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MakeTeamFleeCheat 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 重新计算body以反映最新状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 facial anim to agent 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 在每一帧或每个更新周期内推进agents and teams imp的状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EnableSpeedAdjustmentCommand 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 tick action 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 tick action m t 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 spawned items and missiles。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 mission end time in seconds 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 mission end timer value 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 member count of side 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 initial spawn path 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 initial spawn path data 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 troop spawn frame with index 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 formation spawn frame 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 spawn path frame 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 battle agent count 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 formation spawn position 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 formation spawn class 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnAgent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 initial agent count for side 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 formation positioning from deployment plan 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnMonster 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SpawnTroop 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ReplaceBotWithPlayer 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 mission behavior 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 mission behavior。
...
**用途 / Purpose:** **用途 / Purpose:** 把若干enemy team连接成一个整体。
...
**用途 / Purpose:** **用途 / Purpose:** 在 end mission result 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 agent interaction allowed 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 order gestures enabled 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 player close to an enemy 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 random position around point 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的best defending position。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的position with biggest slope towards direction in square。
...
**用途 / Purpose:** **用途 / Purpose:** 将 custom missile 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 为 starting behaviors 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 closest enemy agent 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 closest ally agent 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 nearby enemy agent count 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否已经持有 any agents of side in range。
...
**用途 / Purpose:** **用途 / Purpose:** 将 sound alarm factor to agents 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 在 mission object removed 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AgentLookingAtAgent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的agent with index。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 under attack type of agents 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 agent team 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 team 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 teams of side 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ComputeSpawnPathDeploymentOffset 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 movement type of agents 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 显示in mission loading screen对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 执行与 missile collision reaction 相关的响应逻辑。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillAgentsOnEntity 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillAgentCheat 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillCheats 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 take control of agent 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 为 player can take control of another agent when dead 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TakeControlOfAgent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 shoot difficulty 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将 combat log safe 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission object from prefab 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 nearby ally agents count 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 nearby ally agents 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 nearby enemy agents 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 nearby agents 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 formation unit position available m t 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 order position available 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 formation unit position available 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否已经持有 scene map patch。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 patch scene encounter position 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 patch scene encounter direction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将 timer to dynamic entity 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 listener 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 listener。
...
**用途 / Purpose:** **用途 / Purpose:** 在 formation captain changed 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 为 fast forwarding from u i 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 检查if battle in retreat在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 将 spawned item entity created at runtime 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 触发on item pick up event对应的逻辑或事件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillNAllies 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillAllAllies 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ToggleDisableDying 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ToggleDisableDyingTeam 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KillAgent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 IncreaseBatteringRamSpeeds 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 IncreaseSiegeTowerSpeed 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 从持久化存储或流中读取 params debug。
