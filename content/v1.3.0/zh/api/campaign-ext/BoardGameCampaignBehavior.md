...
**用途 / Purpose:** **用途 / Purpose:** 为 conversation vars 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 taverngamehost_player_sitting_now_on_condition 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PlayerWonAgainstTavernChampion 对应的操作。
