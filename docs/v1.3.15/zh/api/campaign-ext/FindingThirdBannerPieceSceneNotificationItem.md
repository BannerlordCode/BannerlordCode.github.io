<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `FindingThirdBannerPieceSceneNotificationItem`
- [← 本领域 / 返回 campaign-ext](./)
- [↑ API 目录](../)
...
> 本页为自动生成的存根。`FindingThirdBannerPieceSceneNotificationItem` 是 `TaleWorlds.CampaignSystem.SceneInformationPopupTypes` 命名空间下的一个类 class。
