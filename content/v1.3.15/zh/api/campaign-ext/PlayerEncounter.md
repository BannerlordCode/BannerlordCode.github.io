...
**用途 / Purpose:** 调用 RestartPlayerEncounter 对应的操作。
...
**用途 / Purpose:** 调用 ProtectPlayerSide 对应的操作。
...
**用途 / Purpose:** 调用 EndBattleByCheat 对应的操作。
...
**用途 / Purpose:** 检查if leading avaliable在当前对象中是否成立。
...
**用途 / Purpose:** 启动attack mission流程或状态机。
...
**用途 / Purpose:** 调用 FinalizeBattle 对应的操作。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的non attached npc parties who will join event。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的all npc parties who will join event。
...
**用途 / Purpose:** 调用 EnterSettlement 对应的操作。
...
**用途 / Purpose:** 调用 LeaveBattle 对应的操作。
...
**用途 / Purpose:** 调用 LeaveSettlement 对应的操作。
...
**用途 / Purpose:** 调用 InterruptEncounter 对应的操作。
...
**用途 / Purpose:** 启动siege ambush mission流程或状态机。
...
**用途 / Purpose:** 启动village battle mission流程或状态机。
...
**用途 / Purpose:** 启动combat mission with dialogue in town center流程或状态机。
...
**用途 / Purpose:** 启动hostile action流程或状态机。
