<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `PeaceNotificationItemVM`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.Map.MapNotificationTypes/PeaceNotificationItemVM.cs`
...
```csharp
var value = new PeaceNotificationItemVM();
value.OnFinalize();
```
