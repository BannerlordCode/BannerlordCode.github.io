...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 order of battle formation class 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 formation classes 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 filter name 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 filter description 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 class name 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 hero agents 的结果。
