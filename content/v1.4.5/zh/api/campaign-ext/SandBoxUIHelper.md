...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 explained number tooltip 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 battle loot award tooltip 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 figurehead tooltip 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 recruit notification text 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item sold notification text 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 ship sold notification text 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 troop given to settlement notification text 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 siege engine in progress tooltip 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 siege engine tooltip 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 wall section tooltip 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 prisoners sold notification text 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 party healthy count 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 party wounded text 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 party prisoner text 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 all wounded members amount 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 all prisoner members amount 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 map event visual type from map event 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 agent in visibility range approximate 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 agent be alarmed 的前置条件。
