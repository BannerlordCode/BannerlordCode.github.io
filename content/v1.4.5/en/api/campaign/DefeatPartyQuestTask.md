...
**Base:** `QuestTaskBase`
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Issues.IssueQuestTasks/DefeatPartyQuestTask.cs`
...
value.PartyConditionDelegateType(defeatedParty);
```
