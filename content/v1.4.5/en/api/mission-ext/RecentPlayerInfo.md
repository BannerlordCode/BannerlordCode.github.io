...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `RecentPlayerInfo`
...
**Base:** none
**File:** `Bannerlord.Source/bin/TaleWorlds.MountAndBlade.Diamond/TaleWorlds.MountAndBlade.Diamond/RecentPlayerInfo.cs`
...
```csharp
var example = new RecentPlayerInfo();
```
