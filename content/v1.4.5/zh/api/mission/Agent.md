...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 base formation frame 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 在 conversation started 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 为 scripted target entity 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 ground material for collision effect 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 total mass 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 重新计算并更新 direction change tendency 的最新表示。
...
**用途 / Purpose:** **用途 / Purpose:** 尝试获取 attach to formation 的值，通常通过 out 参数返回是否成功。
...
**用途 / Purpose:** **用途 / Purpose:** 尝试获取 remove all detachment scores 的值，通常通过 out 参数返回是否成功。
...
**用途 / Purpose:** **用途 / Purpose:** 尝试获取 set formation frame 的值，通常通过 out 参数返回是否成功。
...
**用途 / Purpose:** **用途 / Purpose:** 为 is physics force closed 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 perform brace 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 sound parameter for armor type 的结果。
