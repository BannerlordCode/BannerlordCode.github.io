...
`PerkAlternativeType` lives in `TaleWorlds.CampaignSystem.ViewModelCollection.CharacterDeveloper`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
```csharp
PerkAlternativeType example = PerkAlternativeType.NoAlternative;
```
