...
**Purpose:** Reads and returns the launch entitial frame for siege engine value held by the this instance.
...
**Purpose:** Reads and returns the scale for siege engine value held by the this instance.
