...
description: "RandomParticleSpawner 的自动生成类参考。"
---
...
**File:** `bin/TaleWorlds.MountAndBlade/TaleWorlds.MountAndBlade/RandomParticleSpawner.cs`
...
```csharp
// 先通过子系统 API 拿到 RandomParticleSpawner 实例
