...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Naval/AnchorPoint.cs`
...
**用途 / Purpose:** 获取 `last used disembark position` 的当前值。
...
**用途 / Purpose:** 将 `move target` 重置为初始状态。
