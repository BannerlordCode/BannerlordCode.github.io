...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 skeleton name 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 animation name 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AreActionsAlternatives 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 number of action sets 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 number of monster usage sets 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 action set with index 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 bone index with id 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 bone has parent bone 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 action displacement vector 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 action animation flags 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 检查action animation clip exists在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 animation index of action 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 action animation name 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 action animation duration 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 action animation continue to action 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 total animation duration with continue to action 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 action blend out start progress 的结果。
