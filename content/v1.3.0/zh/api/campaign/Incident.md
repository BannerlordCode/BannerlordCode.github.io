...
Incident incident = ...;
incident.Initialize("example", "example", trigger, type, cooldown, func<TextObject, false, consequence);
```
...
**用途 / Purpose:** 调用 InvokeOption 对应的操作。
...
**用途 / Purpose:** 调用 IncidentOptionConditionDelegate 对应的操作。
...
**用途 / Purpose:** 调用 IncidentOptionConsequenceDelegate 对应的操作。
