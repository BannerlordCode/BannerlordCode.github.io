...
**Purpose:** Adds ignored agents for alarm to the current collection or state.
...
**Purpose:** Reads and returns the visual factor value held by the this instance.
...
**Purpose:** Reads and returns the closest alarm source value held by the this instance.
...
**Purpose:** Executes the AlarmAgent logic.
