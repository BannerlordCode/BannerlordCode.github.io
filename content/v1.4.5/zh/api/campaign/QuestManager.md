...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 there active quest with type 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 quest giver 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 检查quest for menu locations在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 在 quest finalized 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 将 tracked object for quest 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 tracked object for quest。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 all tracked objects for quest。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 all tracked objects of a quest 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 quest giver quests 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 QuestExistInSettlementNotables 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 QuestExistInClan 对应的操作。
