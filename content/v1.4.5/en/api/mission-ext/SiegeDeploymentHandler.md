...
**Purpose:** Executes the DeployAllSiegeWeaponsOfPlayer logic.
...
**Purpose:** Reads and returns the max deployable weapon count of player value held by the this instance.
...
**Purpose:** Executes the DeployAllSiegeWeaponsOfAi logic.
...
**Purpose:** Executes the UnHideDeploymentPoints logic.
...
**Purpose:** Reads and returns the deployable weapon count of player value held by the this instance.
...
**Purpose:** Executes the AutoDeployTeamUsingTeamAI logic.
...
**Purpose:** Executes the AutoAssignDetachmentsForDeployment logic.
...
**Purpose:** Reads and returns the estimated average defender position value held by the this instance.
