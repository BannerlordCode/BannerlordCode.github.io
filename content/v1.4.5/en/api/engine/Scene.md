...
**Purpose:** **Purpose:** Determines whether the this instance is in the default editor scene state or condition.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the multiplayer scene state or condition.
...
**Purpose:** **Purpose:** Executes the TakePhotoModePicture logic.
...
**Purpose:** **Purpose:** Reads and returns the all color grade names value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the all filter names value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the photo mode roll value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the photo mode orbit value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the photo mode on value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the photo mode focus value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the scene color grade index value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the scene filter index value held by the this instance.
...
**Purpose:** **Purpose:** Executes the EnableFixedTick logic.
...
**Purpose:** **Purpose:** Reads and returns the loading state name value held by the this instance.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the loading finished state or condition.
...
**Purpose:** **Purpose:** Assigns a new value to photo mode roll and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to photo mode orbit and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the fall density value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to photo mode on and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to photo mode focus and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to photo mode fov and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the photo mode fov value held by the this instance.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds decal renderer.
...
**Purpose:** **Purpose:** Assigns a new value to photo mode vignette and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to scene color grade index and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to scene filter index and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to scene color grade and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to upgrade level and updates the object's internal state.
...
**Purpose:** **Purpose:** Constructs a new burst particle entity and returns it to the caller.
...
**Purpose:** **Purpose:** Reads and returns the terrain height data value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the terrain physics material index data value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the terrain data value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the terrain node data value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the terrain physics material at layer value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the water level value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the water speed at position value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the bulk water level at positions value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the interpolation factor for body world transform smoothing value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the bulk water level at volumes value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the water strength value held by the this instance.
...
**Purpose:** **Purpose:** Executes the DeRegisterShipVisual logic.
...
**Purpose:** **Purpose:** Registers ship visual to water renderer with the current system so it can later be observed or dispatched.
...
**Purpose:** **Purpose:** Assigns a new value to water strength and updates the object's internal state.
...
**Purpose:** **Purpose:** Adds water wake with sphere to the current collection or state.
...
**Purpose:** **Purpose:** Adds water wake with capsule to the current collection or state.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds navmesh face unshared edges.
...
**Purpose:** **Purpose:** Reads and returns the navmesh face count between two ids value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the navmesh face records between two ids value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to fixed tick callback active and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to on collision filter callback active and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the nav mesh face index value held by the this instance.
...
**Purpose:** **Purpose:** Constructs a new new scene entity and returns it to the caller.
...
**Purpose:** **Purpose:** Adds always rendered skeleton to the current collection or state.
...
**Purpose:** **Purpose:** Removes always rendered skeleton from the current collection or state.
...
**Purpose:** **Purpose:** Constructs a new path mesh entity and returns it to the caller.
...
**Purpose:** **Purpose:** Assigns a new value to active visibility levels and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to do not wait for loading states to render and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to dynamic snow texture and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the wind flow map data value held by the this instance.
...
**Purpose:** **Purpose:** Constructs a new dynamic rain texture entity and returns it to the caller.
...
**Purpose:** **Purpose:** Reads and returns the entity with guid value held by the this instance.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the entity frame changed state or condition.
...
**Purpose:** **Purpose:** Reads and returns the flora instance count value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the flora renderer texture usage value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the terrain memory usage value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to fetch crc info of scene and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the scene x m l c r c value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the navigation mesh c r c value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to global wind strength vector and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the global wind strength vector value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the global wind velocity value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to global wind velocity and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the engine physics enabled value held by the this instance.
...
**Purpose:** **Purpose:** Removes all nav mesh from the this instance.
...
**Purpose:** **Purpose:** Executes the StallLoadingRenderingsUntilFurtherNotice logic.
...
**Purpose:** **Purpose:** Reads and returns the nav mesh face count value held by the this instance.
...
**Purpose:** **Purpose:** Executes the ResumeLoadingRenderings logic.
...
**Purpose:** **Purpose:** Reads and returns the id of nav mesh face value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to cloth simulation state and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the nav mesh center position value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the nav mesh path face record value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the path face record from nav mesh face pointer value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the all navmesh face records value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the first entity with name value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the campaign entity with name value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the first entity with script component value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the upgrade level mask of level name value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the upgrade level name of index value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the upgrade level count value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the nav mesh face first vertex z value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to winter time factor and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to dryness factor and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the fog value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to fog and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to fog advanced and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to fog ambient color and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to temperature and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to humidity and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to dynamic shadowmap cascades radius multiplier and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to environment multiplier and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sky rotation and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sky brightness and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to forced snow and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sun light and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sun direction and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sun and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sun angle altitude and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sun size and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sun shaft strength and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the rain density value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to rain density and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the snow density value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to snow density and updates the object's internal state.
...
**Purpose:** **Purpose:** Adds decal instance to the current collection or state.
...
**Purpose:** **Purpose:** Removes decal instance from the current collection or state.
...
**Purpose:** **Purpose:** Assigns a new value to shadow and updates the object's internal state.
...
**Purpose:** **Purpose:** Adds point light to the current collection or state.
...
**Purpose:** **Purpose:** Adds directional light to the current collection or state.
...
**Purpose:** **Purpose:** Assigns a new value to light position and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to light diffuse color and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to light direction and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to mie scatter focus and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to mie scatter strength and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to brightpass threshold and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to lens distortion and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to hexagon vignette alpha and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to min exposure and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to max exposure and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to target exposure and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to middle gray and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to bloom strength and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to bloom amount and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to grain amount and updates the object's internal state.
...
**Purpose:** **Purpose:** Adds item entity to the current collection or state.
...
**Purpose:** **Purpose:** Removes entity from the current collection or state.
...
**Purpose:** **Purpose:** Executes the AttachEntity logic.
...
**Purpose:** **Purpose:** Adds entity with mesh to the current collection or state.
...
**Purpose:** **Purpose:** Adds entity with multi mesh to the current collection or state.
...
**Purpose:** **Purpose:** Assigns a new value to default lighting and updates the object's internal state.
...
**Purpose:** **Purpose:** Calculates the current value or result of effective lighting.
...
**Purpose:** **Purpose:** Reads and returns the path distance between positions value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the last point on navigation mesh from world position to destination value held by the this instance.
...
**Purpose:** **Purpose:** Returns a boolean answer to whether path exist between faces is true for the this instance.
...
**Purpose:** **Purpose:** Reads and returns the normal at value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the entities value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the root entities value held by the this instance.
...
**Purpose:** **Purpose:** Executes the SelectEntitiesCollidedWith logic.
...
**Purpose:** **Purpose:** Executes the RayCastExcludingTwoEntities logic.
...
**Purpose:** **Purpose:** Generates an instance, data, or representation of contacts with capsule.
...
**Purpose:** **Purpose:** Generates an instance, data, or representation of contacts with capsule against entity.
...
**Purpose:** **Purpose:** Executes the InvalidateTerrainPhysicsMaterials logic.
...
**Purpose:** **Purpose:** Reads the data or state of and calculate initial camera.
...
**Purpose:** **Purpose:** Executes the OptimizeScene logic.
...
**Purpose:** **Purpose:** Reads and returns the terrain height value held by the this instance.
...
**Purpose:** **Purpose:** Executes the ForceLoadResources logic.
...
**Purpose:** **Purpose:** Assigns a new value to depth of field parameters and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to depth of field focus and updates the object's internal state.
...
**Purpose:** **Purpose:** Returns depth of field params to its default or initial condition.
...
**Purpose:** **Purpose:** Assigns a new value to color grade blend and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the ground height at position value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the ground height and body flags at position value held by the this instance.
...
**Purpose:** **Purpose:** Executes the PauseSceneSounds logic.
...
**Purpose:** **Purpose:** Executes the ResumeSceneSounds logic.
...
**Purpose:** **Purpose:** Concludes the scene sounds flow and performs any cleanup.
...
**Purpose:** **Purpose:** Executes the BoxCastOnlyForCamera logic.
...
**Purpose:** **Purpose:** Executes the BoxCast logic.
...
**Purpose:** **Purpose:** Executes the RayCastForClosestEntityOrTerrainFixedPhysics logic.
...
**Purpose:** **Purpose:** Executes the FocusRayCastForFixedPhysics logic.
...
**Purpose:** **Purpose:** Executes the RayCastForRamming logic.
...
**Purpose:** **Purpose:** Executes the RayCastForClosestEntityOrTerrainIgnoreEntity logic.
...
**Purpose:** **Purpose:** Executes the ImportNavigationMeshPrefab logic.
...
**Purpose:** **Purpose:** Executes the ImportNavigationMeshPrefabWithFrame logic.
...
**Purpose:** **Purpose:** Writes nav mesh prefab with frame to persistent storage or a stream.
...
**Purpose:** **Purpose:** Assigns a new value to nav mesh region map and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the MarkFacesWithIdAsLadder logic.
...
**Purpose:** **Purpose:** Assigns a new value to ability of faces with id and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to blocker direction for faces with id and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the SwapFaceConnectionsWithID logic.
...
**Purpose:** **Purpose:** Executes the MergeFacesWithId logic.
...
**Purpose:** **Purpose:** Executes the SeparateFacesWithId logic.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the any face with id state or condition.
...
**Purpose:** **Purpose:** Reads and returns the navigation mesh for position value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the nearest navigation mesh for position value held by the this instance.
...
**Purpose:** **Purpose:** Returns a boolean answer to whether path exist between positions is true for the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to landscape rain mask data and updates the object's internal state.
...
**Purpose:** **Purpose:** Ensures postfx system is in the expected state, initializing or correcting it if necessary.
...
**Purpose:** **Purpose:** Assigns a new value to bloom and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to dof mode and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to occlusion mode and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to external injection texture and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to sunshaft mode and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the sun direction value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the north angle value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the north rotation value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the terrain min max height value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the physics min max value held by the this instance.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the editor scene state or condition.
...
**Purpose:** **Purpose:** Assigns a new value to motion blur mode and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to antialiasing mode and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to d l s s mode and updates the object's internal state.
...
**Purpose:** **Purpose:** Looks up the matching weak entities with tag in the current collection or scope.
...
**Purpose:** **Purpose:** Looks up the matching weak entity with tag in the current collection or scope.
...
**Purpose:** **Purpose:** Looks up the matching entities with tag in the current collection or scope.
...
**Purpose:** **Purpose:** Looks up the matching entity with tag in the current collection or scope.
...
**Purpose:** **Purpose:** Looks up the matching entity with name in the current collection or scope.
...
**Purpose:** **Purpose:** Looks up the matching weak entities with tag expression in the current collection or scope.
...
**Purpose:** **Purpose:** Looks up the matching entities with tag expression in the current collection or scope.
...
**Purpose:** **Purpose:** Reads and returns the soft boundary vertex count value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the hard boundary vertex count value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the soft boundary vertex value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the hard boundary vertex value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the path with name value held by the this instance.
...
**Purpose:** **Purpose:** Executes the DeletePathWithName logic.
...
**Purpose:** **Purpose:** Adds path to the current collection or state.
...
**Purpose:** **Purpose:** Reads and returns the scene limits value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the module path value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to owner thread and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the paths with name prefix value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to use constant time and updates the object's internal state.
...
**Purpose:** **Purpose:** Verifies whether point can see point holds true for the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to play sound events after ready to render and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the DisableStaticShadows logic.
...
**Purpose:** **Purpose:** Reads and returns the skybox mesh value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to atmosphere with name and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the FillEntityWithHardBorderPhysicsBarrier logic.
...
**Purpose:** **Purpose:** Removes all decals from the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to photo atmosphere via tod and updates the object's internal state.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the position on a dynamic nav mesh state or condition.
...
**Purpose:** **Purpose:** Pauses the current flow until the water renderer c p u simulation condition is met.
...
**Purpose:** **Purpose:** Executes the EnableInclusiveAsyncPhysx logic.
...
**Purpose:** **Purpose:** Ensures water wake renderer is in the expected state, initializing or correcting it if necessary.
...
**Purpose:** **Purpose:** Executes the DeleteWaterWakeRenderer logic.
...
**Purpose:** **Purpose:** Executes the SceneHadWaterWakeRenderer logic.
...
**Purpose:** **Purpose:** Assigns a new value to water wake world size and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to water wake camera offset and updates the object's internal state.
...
**Purpose:** **Purpose:** Advances the wake state each frame or update cycle.
...
**Purpose:** **Purpose:** Assigns a new value to do not add entities to tick list and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to dont load invisible entities and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to uses delete later system and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the response logic associated with current frame tick entities.
...
**Purpose:** **Purpose:** Removes all current frame tick entities from the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to use advanced water rendering and updates the object's internal state.
...
**Purpose:** **Purpose:** Looks up the matching closest exit position for position on a boundary face in the current collection or scope.
