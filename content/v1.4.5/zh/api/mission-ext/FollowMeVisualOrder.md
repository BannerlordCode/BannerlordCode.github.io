...
description: "FollowMeVisualOrder 的自动生成类参考。"
---
# FollowMeVisualOrder
...
**Base:** `VisualOrder`
**File:** `Modules.Native/TaleWorlds.MountAndBlade.View/TaleWorlds.MountAndBlade.ViewModelCollection.Order.Visual.Default.Orders.MovementOrders/FollowMeVisualOrder.cs`
...
```csharp
// 先通过子系统 API 拿到 FollowMeVisualOrder 实例
