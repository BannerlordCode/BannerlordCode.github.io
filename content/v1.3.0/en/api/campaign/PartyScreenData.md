...
**Purpose:** Copies the from party and roster state of the this instance to a target.
...
**Purpose:** Copies the from screen data state of the this instance to a target.
...
**Purpose:** Executes the BindRostersFrom logic.
...
**Purpose:** Determines whether the this instance is in the there any troop trade difference between state or condition.
...
**Purpose:** Reads and returns the troop trade differences from to value held by the this instance.
