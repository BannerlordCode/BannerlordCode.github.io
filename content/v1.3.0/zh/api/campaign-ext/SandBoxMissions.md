...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 sand box mission initializer record 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 sand box training mission initializer record 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 打开town center shadow a target mission对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开village battle mission对应的资源或界面。
...
**用途 / Purpose:** **用途 / Purpose:** 打开meeting mission对应的资源或界面。
