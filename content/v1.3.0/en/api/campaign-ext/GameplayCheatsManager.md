...
**Purpose:** Reads and returns the map cheat list value held by the this instance.
...
**Purpose:** Reads and returns the mission cheat list value held by the this instance.
