...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CampaignBehaviors/MapTracksCampaignBehavior.cs`
...
value.RequestTrack(party, trackPosition, trackDirection);
```
