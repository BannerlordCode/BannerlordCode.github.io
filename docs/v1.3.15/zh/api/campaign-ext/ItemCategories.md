...
**Base:** 无
**File:** `TaleWorlds.CampaignSystem/Extensions/ItemCategories.cs`
...
| Name | Signature |
|------|-----------|
| `All` | `public static MBReadOnlyList<ItemCategory> All { get; }` |

## 使用示例

```csharp
var value = new ItemCategories();
```
