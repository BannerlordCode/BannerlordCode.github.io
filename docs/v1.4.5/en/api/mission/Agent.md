...
**Purpose:** Gets the current value of `base formation frame`.
...
**Purpose:** Updates the state or data of `direction change tendency`.
...
**Purpose:** Attempts to get `set formation frame`, usually returning the result in an out parameter.
...
**Purpose:** Checks whether the current object can `perform brace`.
