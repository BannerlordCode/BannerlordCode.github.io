...
**用途 / Purpose:** 处理 `instantiate with rest offset` 相关逻辑。
...
**用途 / Purpose:** 处理 `swap physx shape in entity` 相关逻辑。
...
**用途 / Purpose:** 处理 `cook triangle physx mesh` 相关逻辑。
