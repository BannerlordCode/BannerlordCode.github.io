...
**用途 / Purpose:** **用途 / Purpose:** 执行 on overlay closed 对应的操作或工作流。
...
**用途 / Purpose:** **用途 / Purpose:** 执行 on overlay opened 对应的操作或工作流。
...
**用途 / Purpose:** **用途 / Purpose:** 重新计算并更新 overlay type 的最新表示。
