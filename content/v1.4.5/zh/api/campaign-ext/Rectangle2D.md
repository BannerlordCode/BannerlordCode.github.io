...
**用途 / Purpose:** 调用 FillLocalValuesFrom 对应的操作。
...
**用途 / Purpose:** 读取并返回当前对象中 visual scale 的结果。
...
**用途 / Purpose:** 将 visual offset 添加到当前容器或状态中。
...
**用途 / Purpose:** 为 visual offset 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** 将 visual scale 添加到当前容器或状态中。
...
**用途 / Purpose:** 为 visual scale 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** 将 visual rotation offset 添加到当前容器或状态中。
...
**用途 / Purpose:** 为 visual rotation offset 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** 检查visuals是否满足约束条件，通常返回布尔值。
...
**用途 / Purpose:** 调用 DrawBoundingBox 对应的操作。
...
**用途 / Purpose:** 调用 DrawCorners 对应的操作。
...
**用途 / Purpose:** 计算matrix frame的当前值或结果。
...
**用途 / Purpose:** 计算visual matrix frame的当前值或结果。
...
**用途 / Purpose:** 读取并返回当前对象中 cached origin 的结果。
...
**用途 / Purpose:** 读取并返回当前对象中 cached matrix frame 的结果。
...
**用途 / Purpose:** 读取并返回当前对象中 cached visual matrix frame 的结果。
...
**用途 / Purpose:** 判断当前对象是否处于 identical 状态或条件。
...
**用途 / Purpose:** 调用 TransformScreenPositionToLocal 对应的操作。
...
**用途 / Purpose:** 调用 TransformLocalPositionToScreen 对应的操作。
...
**用途 / Purpose:** 构建一个新的 matrix frame 实体并返回给调用方。
...
**用途 / Purpose:** 调用 DoRectanglesIntersect 对应的操作。
