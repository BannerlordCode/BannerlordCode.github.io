...
**Purpose:** Executes the ToRadians logic.
...
**Purpose:** Executes the ToDegrees logic.
...
**Purpose:** Executes the ApproximatelyEqualsTo logic.
...
**Purpose:** Executes the ApproximatelyEquals logic.
...
**Purpose:** Executes the ClampIndex logic.
...
**Purpose:** Executes the ClampInt logic.
...
**Purpose:** Executes the ClampFloat logic.
...
**Purpose:** Executes the ClampUnit logic.
...
**Purpose:** Reads and returns the number of bits to represent number value held by the this instance.
...
**Purpose:** Executes the LerpFPSIndependent logic.
...
**Purpose:** Executes the LinearExtrapolation logic.
...
**Purpose:** Executes the Map logic.
...
**Purpose:** Executes the LerpRadians logic.
...
**Purpose:** Executes the InverseLerp logic.
...
**Purpose:** Executes the SmoothStep logic.
...
**Purpose:** Executes the BilinearLerp logic.
...
**Purpose:** Reads and returns the smallest difference between two angles value held by the this instance.
...
**Purpose:** Executes the ClampAngle logic.
...
**Purpose:** Executes the WrapAngle logic.
...
**Purpose:** Executes the WrapAngleSafe logic.
...
**Purpose:** Determines whether the this instance is in the between state or condition.
...
**Purpose:** Determines whether the this instance is in the between inclusive state or condition.
...
**Purpose:** Executes the ColorFromRGBA logic.
...
**Purpose:** Executes the HSBtoRGB logic.
...
**Purpose:** Executes the RGBtoHSB logic.
...
**Purpose:** Executes the GammaCorrectRGB logic.
...
**Purpose:** Reads and returns the signed distance of point to line segment value held by the this instance.
...
**Purpose:** Reads and returns the distance square of point to line segment value held by the this instance.
...
**Purpose:** Executes the ProjectPointOntoLine logic.
...
**Purpose:** Executes the ClampToAxisAlignedRectangle logic.
...
**Purpose:** Reads and returns the ray plane intersection point value held by the this instance.
...
**Purpose:** Executes the PointLiesAheadOfPlane logic.
...
**Purpose:** Reads and returns the closest point on line segment to point value held by the this instance.
...
**Purpose:** Verifies whether line to line segment intersection holds true for the this instance.
...
**Purpose:** Executes the IntersectLineSegmentWithTriangle logic.
...
**Purpose:** Executes the IntersectLineSegmentWithBoundingBox logic.
...
**Purpose:** Verifies whether line segment to line segment intersection holds true for the this instance.
...
**Purpose:** Verifies whether point inside polygon holds true for the this instance.
...
**Purpose:** Verifies whether polygon intersection holds true for the this instance.
...
**Purpose:** Verifies whether polygon line segment intersection holds true for the this instance.
...
**Purpose:** Executes the IntersectRayWithPolygon logic.
...
**Purpose:** Executes the ToOrdinal logic.
