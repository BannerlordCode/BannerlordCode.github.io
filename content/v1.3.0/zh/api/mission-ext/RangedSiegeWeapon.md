...
**用途 / Purpose:** 调用 ChangeProjectileEntityClient 对应的操作。
...
**用途 / Purpose:** 调用 GiveExactInput 对应的操作。
...
**用途 / Purpose:** 调用 AimAtThreat 对应的操作。
...
**用途 / Purpose:** 调用 AimAtTarget 对应的操作。
...
**用途 / Purpose:** 检查is target reached在当前对象中是否成立。
...
**用途 / Purpose:** 调用 AimAtRotation 对应的操作。
...
**用途 / Purpose:** 调用 ManualReload 对应的操作。
...
**用途 / Purpose:** 调用 AiRequestsShoot 对应的操作。
...
**用途 / Purpose:** 调用 AiRequestsManualReload 对应的操作。
