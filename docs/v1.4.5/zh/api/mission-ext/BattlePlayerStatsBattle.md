...
**File:** `Bannerlord.Source/bin/TaleWorlds.MountAndBlade.Diamond/TaleWorlds.MountAndBlade.Diamond/BattlePlayerStatsBattle.cs`
...
```csharp
var example = new BattlePlayerStatsBattle();
```
