...
description: "Auto-generated class reference for DefaultEncounter."
---
# DefaultEncounter
...
**Base:** none
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.GameMenus.GameMenuInitializationHandlers/DefaultEncounter.cs`

## Overview

`DefaultEncounter` lives in `TaleWorlds.CampaignSystem.GameMenus.GameMenuInitializationHandlers` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
**Purpose:** Executes the game_menu_taken_prisoner_ui_on_init logic.
...
**Purpose:** Executes the game_menu_defeat_and_taken_prisoner_ui_on_init logic.
...
**Purpose:** Executes the game_menu_taken_prisoner_town_ui_on_init logic.
...
**Purpose:** Executes the game_menu_attackers_left_on_init logic.
...
**Purpose:** Executes the game_menu_new_game_begin_on_init logic.
...
**Purpose:** Executes the game_menu_kingdom_mno_call_to_arms_on_consequence logic.
...
**Purpose:** Executes the game_menu_encyclopedia_on_consequence logic.
...
**Purpose:** Executes the game_menu_town_menu_request_meeting_on_init logic.
