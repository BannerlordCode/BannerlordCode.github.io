...
**命名空间:** SandBox.View.Missions.Tournaments
**模块:** SandBox.View
**类型:** `public class TournamentMissionViews`
**领域:** campaign-ext

## 概述

`TournamentMissionViews` 位于 `SandBox.View.Missions.Tournaments`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
