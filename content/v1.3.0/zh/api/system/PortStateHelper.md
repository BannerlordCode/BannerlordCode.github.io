...
**Base:** 无
**File:** `TaleWorlds.CampaignSystem/Helpers/PortStateHelper.cs`
...
**用途 / Purpose:** 打开as restricted对应的资源或界面。
...
**用途 / Purpose:** 打开as story mode对应的资源或界面。
...
**用途 / Purpose:** 打开as manage fleet对应的资源或界面。
...
**用途 / Purpose:** 打开as manage other fleet对应的资源或界面。
