...
description: "LandlordNeedsAccessToVillageCommonsIssue 的自动生成类参考。"
---
...
```csharp
// 先通过子系统 API 拿到 LandlordNeedsAccessToVillageCommonsIssue 实例
...
// 先通过子系统 API 拿到 LandlordNeedsAccessToVillageCommonsIssue 实例
LandlordNeedsAccessToVillageCommonsIssue landlordNeedsAccessToVillageCommonsIssue = ...;
var result = landlordNeedsAccessToVillageCommonsIssue.GetAlternativeSolutionSkill(hero);
```
