...
description: "CampaignFactionManagerBehaviour 的自动生成类参考。"
---
...
**File:** `TaleWorlds.CampaignSystem/CampaignBehaviors/CampaignFactionManagerBehaviour.cs`
...
```csharp
// 先通过子系统 API 拿到 CampaignFactionManagerBehaviour 实例
