...
**用途 / Purpose:** **用途 / Purpose:** 在 keybinds changed event 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 category 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 all categories 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将initial contexts注册到当前系统，以便后续监听或分发。
...
**用途 / Purpose:** **用途 / Purpose:** 将context注册到当前系统，以便后续监听或分发。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ShouldNotifyDocumentVersionDifferent 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MarkForSave 对应的操作。
