...
**用途 / Purpose:** 调用 UnfollowAgent 对应的操作。
...
**用途 / Purpose:** 调用 FadeOutAgents 对应的操作。
...
**用途 / Purpose:** 调用 DisableGenericMissionEventScript 对应的操作。
...
**用途 / Purpose:** 调用 SpawnPlayer 对应的操作。
...
**用途 / Purpose:** 调用 SpawnHorses 对应的操作。
...
**用途 / Purpose:** 调用 SpawnSheeps 对应的操作。
...
**用途 / Purpose:** 调用 SpawnGeese 对应的操作。
...
**用途 / Purpose:** 调用 SpawnChicken 对应的操作。
