...
**Purpose:** Reads and returns the crafted multi mesh value held by the this instance.
...
**Purpose:** Reads and returns the multi mesh copy value held by the this instance.
...
**Purpose:** Reads and returns the multi mesh copy with gender data value held by the this instance.
...
**Purpose:** Reads and returns the scaled frame value held by the this instance.
