...
**用途 / Purpose:** 调用 DeleteTournamentSetsExcept 对应的操作。
...
**用途 / Purpose:** 调用 DeleteAllTournamentSets 对应的操作。
...
**用途 / Purpose:** 调用 EndTournamentViaLeave 对应的操作。
