<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `SpawnWeaponAsDropFromAgent`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.MountAndBlade/NetworkMessages.FromServer/SpawnWeaponAsDropFromAgent.cs`
