...
description: "PatrollingGuardBehavior 的自动生成类参考。"
---
...
**Base:** `AgentBehavior`
**File:** `Modules.SandBox/SandBox/SandBox.Missions.AgentBehaviors/PatrollingGuardBehavior.cs`
...
```csharp
// 先通过子系统 API 拿到 PatrollingGuardBehavior 实例
