...
**Purpose:** Handles logic related to `invalidate`.
...
**Purpose:** Sets the value or state of `entity flags`.

### SetEntityVisibilityFlags
`public void SetEntityVisibilityFlags(EntityVisibilityFlags flags)`

**Purpose:** Sets the value or state of `entity visibility flags`.
...
**Purpose:** Sets the value or state of `global position`.
...
**Purpose:** Gets the current value of `script count`.
...
**Purpose:** Gets the current value of `script at index`.
...
**Purpose:** Gets the current value of `first script with name hash`.
...
**Purpose:** Refreshes the display or cache of `meshes to render to hull water`.

### DeRegisterWaterMeshMaterials
`public void DeRegisterWaterMeshMaterials(UIntPtr visualRecord)`

**Purpose:** Handles logic related to `de register water mesh materials`.

### SetVisualRecordWakeParams
`public void SetVisualRecordWakeParams(UIntPtr visualRecord, Vec3 wakeParams)`

**Purpose:** Sets the value or state of `visual record wake params`.
...
**Purpose:** Handles logic related to `change resolution multiplier of water visual`.

### ResetHullWater
`public void ResetHullWater(UIntPtr visualRecord)`

**Purpose:** Resets `hull water` to its initial state.

### SetWaterVisualRecordFrameAndDt
`public void SetWaterVisualRecordFrameAndDt(UIntPtr visualRecord, MatrixFrame frame, float dt)`

**Purpose:** Sets the value or state of `water visual record frame and dt`.
...
**Purpose:** Updates the state or data of `hull water effect frames`.
...
**Purpose:** Checks whether the current object has/contains `batched kinematic physics flag`.

### HasBatchedRayCastPhysicsFlag
`public bool HasBatchedRayCastPhysicsFlag()`

**Purpose:** Checks whether the current object has/contains `batched ray cast physics flag`.
...
**Purpose:** Sets the value or state of `water s d f clip data`.

### RegisterWaterSDFClip
`public int RegisterWaterSDFClip(Texture sdfTexture)`

**Purpose:** Handles logic related to `register water s d f clip`.

### DeRegisterWaterSDFClip
`public void DeRegisterWaterSDFClip(int slot)`

**Purpose:** Handles logic related to `de register water s d f clip`.
...
**Purpose:** Gets the current value of `body visual world transform`.
...
**Purpose:** Handles logic related to `compute global physics bounding box center`.
...
**Purpose:** Gets the current value of `attached navmesh face vertex indices`.

### SetCustomVertexPositionEnabled
`public void SetCustomVertexPositionEnabled(bool customVertexPositionEnabled)`

**Purpose:** Sets the value or state of `custom vertex position enabled`.
...
**Purpose:** Sets the value or state of `positions for attached navmesh vertices`.

### SetCostAdderForAttachedFaces
`public void SetCostAdderForAttachedFaces(float costs)`

**Purpose:** Sets the value or state of `cost adder for attached faces`.
...
**Purpose:** Handles logic related to `collect children entities with tag as enumarable`.
...
**Purpose:** Gets the current value of `global wind velocity with gust noise of scene`.
...
**Purpose:** Creates a new `empty physx shape` instance or object.
...
**Purpose:** Handles logic related to `check is prefab link root prefab`.
