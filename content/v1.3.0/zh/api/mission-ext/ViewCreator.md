...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 credits screen 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 options screen 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 m b face generator screen 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission agent status u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission main agent equip drop view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission siege engine marker view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission main agent equipment controller 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission main agent cheer bark controller view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission agent lock visualizer view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 options u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 singleplayer mission kill notification u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission agent label u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission order u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission order of battle u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission spectator control view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission battle score u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission boundary crossing view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission leave view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 photo mode view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission singleplayer escape menu 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 order troop placer view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission formation marker u i handler 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission hint view 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mission objective view 实体并返回给调用方。
