...
**Purpose:** Executes the Partner logic.
...
**Purpose:** Reads and returns the courted hero in other clan value held by the this instance.
...
**Purpose:** Reads and returns the romantic level value held by the this instance.
...
**Purpose:** Reads and returns the romantic state value held by the this instance.
