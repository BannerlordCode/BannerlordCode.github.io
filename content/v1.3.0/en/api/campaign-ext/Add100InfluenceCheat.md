...
description: "Auto-generated class reference for Add100InfluenceCheat."
---
...
**File:** `SandBox/Add100InfluenceCheat.cs`

## Overview

`Add100InfluenceCheat` lives in `SandBox` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
```csharp
// Obtain an instance of Add100InfluenceCheat from the subsystem API first
