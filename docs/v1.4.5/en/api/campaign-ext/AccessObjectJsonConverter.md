<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `AccessObjectJsonConverter`
...
**Base:** `JsonConverter`
**File:** `Bannerlord.Source/bin/TaleWorlds.Diamond/TaleWorlds.Diamond/AccessObjectJsonConverter.cs`
...
```csharp
var value = new AccessObjectJsonConverter();
