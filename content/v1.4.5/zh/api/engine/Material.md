...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 default material 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 outline material 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 default tableau sample material 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 tableau material 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 为 shader 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 alpha mask tableau material 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 alpha blend mode 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 alpha blend mode 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 alpha test value 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 alpha test value 的结果。
