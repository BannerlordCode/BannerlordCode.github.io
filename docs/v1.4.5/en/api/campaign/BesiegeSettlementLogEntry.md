...
**Base:** `LogEntry`
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.LogEntries/BesiegeSettlementLogEntry.cs`
...
```csharp
var value = new BesiegeSettlementLogEntry();
value.ToString();
```
