...
- [SaveManager API](../api/save-system/SaveManager/)
- [SaveAttributes API](../api/save-system/SaveAttributes/)
- [AutoGeneratedSaveManager API](../api/save-system/AutoGeneratedSaveManager/)
- [Save System Detail](../architecture/save-system/)

---

## Next Section

- [Common Patterns](common-patterns/) - Bannerlord modding best practices
- [Campaign System](campaign-system/) - Learn about the Campaign world
