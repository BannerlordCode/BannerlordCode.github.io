...
**用途 / Purpose:** 为即将执行的immediately操作完成前置准备工作。
...
**用途 / Purpose:** 调用 SkeletonType 对应的操作。
...
**用途 / Purpose:** 调用 UseMorphAnims 对应的操作。
...
**用途 / Purpose:** 调用 ClothColor1 对应的操作。
...
**用途 / Purpose:** 调用 ClothColor2 对应的操作。
...
**用途 / Purpose:** 调用 CachedWeaponEntity 对应的操作。
...
**用途 / Purpose:** 调用 UseTranslucency 对应的操作。
...
**用途 / Purpose:** 调用 UseTesselation 对应的操作。
...
**用途 / Purpose:** 调用 ActionCode 对应的操作。
...
**用途 / Purpose:** 调用 RightWieldedItemIndex 对应的操作。
...
**用途 / Purpose:** 调用 LeftWieldedItemIndex 对应的操作。
...
**用途 / Purpose:** 调用 CharacterObjectStringId 对应的操作。
...
**用途 / Purpose:** 调用 MountCreationKey 对应的操作。
