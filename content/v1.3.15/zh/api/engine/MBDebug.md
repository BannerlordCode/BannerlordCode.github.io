...
**用途 / Purpose:** **用途 / Purpose:** 调用 DisableUI 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AssertMemoryUsage 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AbortGame 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 显示warning对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ContentWarning 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ConditionalContentWarning 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 显示error对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 显示message box对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Assert 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 FailedAssert 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SilentAssert 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AssertConditionOrCallerClassName 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AssertConditionOrCallerClassNameSearchAllCallstack 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Print 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ConsolePrint 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将debug line on screen写入目标位置。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugText 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderText 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugRect 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugRectWithColor 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugFrame 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugText3D 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugDirectionArrow 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugLine 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugSphere 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugCapsule 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugBoundingBoxOfEntity 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugBoundingBox 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的render objects。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugBoxObject 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PostWarningLine 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 error report mode active 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 error report mode pause mission 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 为 error report scene 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 dump generation disabled 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EchoCommandWindow 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的console。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EchoCommandWindowTest 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 test mode 状态或条件。
