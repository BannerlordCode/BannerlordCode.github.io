...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `TakingPrisonersTutorial`
...
**File:** `Bannerlord.Source/Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/TakingPrisonersTutorial.cs`
...
```csharp
var value = new TakingPrisonersTutorial();
