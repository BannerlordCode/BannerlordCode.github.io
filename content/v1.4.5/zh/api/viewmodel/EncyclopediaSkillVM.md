...
description: "EncyclopediaSkillVM 的自动生成类参考。"
---
# EncyclopediaSkillVM
...
**Base:** `ViewModel`
**File:** `bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.Encyclopedia.Items/EncyclopediaSkillVM.cs`
...
```csharp
// 先通过子系统 API 拿到 EncyclopediaSkillVM 实例
