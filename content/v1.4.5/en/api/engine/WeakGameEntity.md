...
**Purpose:** **Purpose:** Executes the Invalidate logic.
...
**Purpose:** **Purpose:** Assigns a new value to entity flags and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to entity visibility flags and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to global position and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the script count value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the script at index value held by the this instance.
...
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
var result = weakGameEntity.HasScriptComponent(0);
```
...
**Purpose:** **Purpose:** Reads and returns the first script with name hash value held by the this instance.

```csharp
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
var result = weakGameEntity.GetFirstScriptWithNameHash(0);
```
...
**Purpose:** **Purpose:** Keeps the display or cache of meshes to render to hull water in sync with the underlying state.
...
**Purpose:** **Purpose:** Executes the DeRegisterWaterMeshMaterials logic.

```csharp
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
weakGameEntity.DeRegisterWaterMeshMaterials(visualRecord);
```

### SetVisualRecordWakeParams
`public void SetVisualRecordWakeParams(UIntPtr visualRecord, Vec3 wakeParams)`

**Purpose:** **Purpose:** Assigns a new value to visual record wake params and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the ChangeResolutionMultiplierOfWaterVisual logic.
...
**Purpose:** **Purpose:** Returns hull water to its default or initial condition.
...
**Purpose:** **Purpose:** Assigns a new value to water visual record frame and dt and updates the object's internal state.
...
**Purpose:** **Purpose:** Adds splash position to water visual record to the current collection or state.
...
**Purpose:** **Purpose:** Recalculates and stores the latest representation of hull water effect frames.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds batched kinematic physics flag.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds batched ray cast physics flag.
...
**Purpose:** **Purpose:** Assigns a new value to water s d f clip data and updates the object's internal state.
...
**Purpose:** **Purpose:** Registers water s d f clip with the current system so it can later be observed or dispatched.
...
**Purpose:** **Purpose:** Executes the DeRegisterWaterSDFClip logic.
...
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
var result = weakGameEntity.GetBodyVisualWorldTransform();
```
...
**Purpose:** **Purpose:** Executes the ComputeGlobalPhysicsBoundingBoxCenter logic.

```csharp
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
var result = weakGameEntity.ComputeGlobalPhysicsBoundingBoxCenter();
```
...
**Purpose:** **Purpose:** Reads and returns the attached navmesh face vertex indices value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to custom vertex position enabled and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to positions for attached navmesh vertices and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to cost adder for attached faces and updates the object's internal state.

```csharp
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
weakGameEntity.SetCostAdderForAttachedFaces(0);
```
...
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
weakGameEntity.SetCustomClipPlane(clipPosition, clipNormal, false);
```
...
**Purpose:** **Purpose:** Executes the CollectChildrenEntitiesWithTagAsEnumarable logic.
...
**Purpose:** **Purpose:** Reads and returns the global wind velocity with gust noise of scene value held by the this instance.

```csharp
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
var result = weakGameEntity.GetGlobalWindVelocityWithGustNoiseOfScene(0);
```
...
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
var result = weakGameEntity.CreateEmptyPhysxShape(false, 0);
```
...
// Obtain an instance of WeakGameEntity from the subsystem API first
WeakGameEntity weakGameEntity = ...;
var result = weakGameEntity.CheckIsPrefabLinkRootPrefab(0);
```
