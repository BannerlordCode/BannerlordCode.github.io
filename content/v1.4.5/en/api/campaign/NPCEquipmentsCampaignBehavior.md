...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `NPCEquipmentsCampaignBehavior`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CampaignBehaviors/NPCEquipmentsCampaignBehavior.cs`
...
```csharp
var value = new NPCEquipmentsCampaignBehavior();
