...
**File:** `Bannerlord.Source/bin/TaleWorlds.MountAndBlade/TaleWorlds.MountAndBlade/ColumnFormation.cs`
...
**Purpose:** Called when the `tick occasionally` event is raised.
