...
description: "DecisionOptionVM 的自动生成类参考。"
---
# DecisionOptionVM
...
**Base:** `ViewModel`
**File:** `bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.KingdomManagement.Decisions/DecisionOptionVM.cs`
...
**用途 / Purpose:** 调用 AfterKingChooseOutcome 对应的操作。
