...
**Purpose:** Determines whether the this instance is in the playstation state or condition.
...
**Purpose:** Reads and returns the gyro x value held by the this instance.
...
**Purpose:** Reads and returns the gyro y value held by the this instance.
...
**Purpose:** Reads and returns the gyro z value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the key down immediate state or condition.
...
**Purpose:** Determines whether the this instance is in the control or shift not down state or condition.
...
**Purpose:** Reads and returns the primary controller type value held by the this instance.
...
**Purpose:** Reads and returns the first key pressed in range value held by the this instance.
...
**Purpose:** Reads and returns the first key down in range value held by the this instance.
...
**Purpose:** Reads and returns the first key released in range value held by the this instance.
...
**Purpose:** Executes the PressKey logic.
...
**Purpose:** Removes all keys from the this instance.
...
**Purpose:** Reads and returns the virtual key code value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the down state or condition.
...
**Purpose:** Determines whether the this instance is in the pressed state or condition.
...
**Purpose:** Determines whether the this instance is in the released state or condition.
...
**Purpose:** Reads and returns the clipboard text value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the controller key state or condition.
