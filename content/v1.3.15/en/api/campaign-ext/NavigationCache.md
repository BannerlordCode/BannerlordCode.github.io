...
**Purpose:** Reads and returns the neighbors value held by the this instance.
...
**Purpose:** Reads and returns the closest settlement to face index value held by the this instance.
...
**Purpose:** Reads and returns the settlements distance cache file for capability value held by the this instance.
