...
**用途 / Purpose:** **用途 / Purpose:** 检查if building is complete在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChangeDefaultBuilding 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChangeCurrentBuildingQueue 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 progress of building 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 days to complete 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 tier of building 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 提升building process with gold的数值或强度。
