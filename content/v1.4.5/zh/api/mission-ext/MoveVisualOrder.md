...
description: "MoveVisualOrder 的自动生成类参考。"
---
# MoveVisualOrder
...
**Base:** `VisualOrder`
**File:** `Modules.Native/TaleWorlds.MountAndBlade.View/TaleWorlds.MountAndBlade.ViewModelCollection.Order.Visual.Default.Orders.MovementOrders/MoveVisualOrder.cs`
...
```csharp
// 先通过子系统 API 拿到 MoveVisualOrder 实例
