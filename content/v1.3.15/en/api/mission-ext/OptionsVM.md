...
**Purpose:** Reads and returns the active category value held by the this instance.
...
**Purpose:** Reads and returns the index of category value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the options changed state or condition.
