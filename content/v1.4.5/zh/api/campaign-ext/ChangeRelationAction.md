...
**用途 / Purpose:** **用途 / Purpose:** 将 player relation 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 relation change between heroes 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 emissary relation 的效果应用到当前对象。
