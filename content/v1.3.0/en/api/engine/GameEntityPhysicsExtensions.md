...
**Purpose:** **Purpose:** Adds distance joint to the current collection or state.
...
**Purpose:** **Purpose:** Removes joint from the current collection or state.
...
**Purpose:** **Purpose:** Converts dynamic body to kinematic into another representation or type.
