...
**用途 / Purpose:** 调用 MilitiaToSpawnAfterSiege 对应的操作。
...
**用途 / Purpose:** 计算militia change的当前值或结果。
...
**用途 / Purpose:** 计算veteran militia spawn chance的当前值或结果。
...
**用途 / Purpose:** 计算militia spawn rate的当前值或结果。
