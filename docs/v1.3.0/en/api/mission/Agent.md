...
**Purpose:** Sets the value or state of `scripted target entity and position`.
...
**Purpose:** Handles logic related to `undetach and attach to formation`.

### UndetachAndStopUsingObjects
`public void UndetachAndStopUsingObjects(bool removeDetachmentScores = true)`

**Purpose:** Handles logic related to `undetach and stop using objects`.
