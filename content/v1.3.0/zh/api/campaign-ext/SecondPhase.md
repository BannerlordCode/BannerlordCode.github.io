...
**用途 / Purpose:** 触发conspiracy对应的逻辑或事件。
...
**用途 / Purpose:** 调用 IncreaseConspiracyStrength 对应的操作。
...
**用途 / Purpose:** 调用 DecreaseConspiracyStrength 对应的操作。
...
**用途 / Purpose:** 激活conspiracy对应的资源、状态或功能。
