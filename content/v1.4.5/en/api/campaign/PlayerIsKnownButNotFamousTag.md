...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `PlayerIsKnownButNotFamousTag`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Conversation.Tags/PlayerIsKnownButNotFamousTag.cs`
