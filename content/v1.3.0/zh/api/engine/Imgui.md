...
**用途 / Purpose:** **用途 / Purpose:** 调用 BeginMainThreadScope 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EndMainThreadScope 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PushStyleColor 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PopStyleColor 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 NewFrame 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Text 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 检查box在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TreeNode 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TreePop 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Separator 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Button 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PlotLines 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ProgressBar 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 NewLine 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SameLine 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Combo 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ComboCustomSeperator 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InputInt 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SliderFloat 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 Columns 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 NextColumn 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RadioButton 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 CollapsingHeader 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 item hovered 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 为 tooltip 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SmallButton 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InputFloat 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InputText 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InputTextMultilineCopyPaste 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InputFloat2 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InputFloat3 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 InputFloat4 对应的操作。
