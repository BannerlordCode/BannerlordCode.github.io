...
**Base:** none
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem/StanceLink.cs`
...
**Purpose:** Reads and returns the remaining tribute payment count value held by the this instance.
