<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `InformationMessage`
- [← 本领域 / 返回 core-extra](./)
- [↑ API 目录](../)
- [🏠 首页 v1.4.5](../../)
- [⭐ 版本架构](../../architecture/)
...
**Base:** 无
**File:** `Bannerlord.Source/bin/TaleWorlds.Library/TaleWorlds.Library/InformationMessage.cs`
...
```csharp
var example = new InformationMessage();
```
