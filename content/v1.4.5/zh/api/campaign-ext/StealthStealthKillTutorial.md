...
description: "StealthStealthKillTutorial 的自动生成类参考。"
---
...
**File:** `Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/StealthStealthKillTutorial.cs`
...
```csharp
// 先通过子系统 API 拿到 StealthStealthKillTutorial 实例
