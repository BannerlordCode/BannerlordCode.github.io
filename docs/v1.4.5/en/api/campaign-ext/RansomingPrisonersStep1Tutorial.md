<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `RansomingPrisonersStep1Tutorial`
...
**File:** `Bannerlord.Source/Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/RansomingPrisonersStep1Tutorial.cs`
...
```csharp
var value = new RansomingPrisonersStep1Tutorial();
