...
**Purpose:** Reads and returns the item holster index value held by the this instance.
...
**Purpose:** Reads and returns the item is passive usage value held by the this instance.
...
**Purpose:** Reads and returns the holster frame by index value held by the this instance.
...
**Purpose:** Reads and returns the item usage set flags value held by the this instance.
...
**Purpose:** Reads and returns the item usage reload action code value held by the this instance.
...
**Purpose:** Reads and returns the item usage strike type value held by the this instance.
