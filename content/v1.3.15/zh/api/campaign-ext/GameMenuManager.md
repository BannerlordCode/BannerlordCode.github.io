...
**用途 / Purpose:** **用途 / Purpose:** 为 next menu 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 current repeatable index 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 使 menu option conditions 的显示或缓存与底层状态保持一致。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RunConsequencesOfMenuOption 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 menu overlay type 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual game menu option 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu option text2 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu progress 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu and option type 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu is wait active 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu target wait hours 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu option is enabled 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu option amount 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu option is leave 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 virtual menu option conditions hold 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 related game menus。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 related game menu options。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 game menu 的结果。
