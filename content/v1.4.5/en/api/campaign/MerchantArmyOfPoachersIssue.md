...
description: "Auto-generated class reference for MerchantArmyOfPoachersIssue."
---
...
`MerchantArmyOfPoachersIssue` lives in `TaleWorlds.CampaignSystem.Issues` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
```csharp
// Obtain an instance of MerchantArmyOfPoachersIssue from the subsystem API first
...
MerchantArmyOfPoachersIssue merchantArmyOfPoachersIssue = ...;
merchantArmyOfPoachersIssue.DoTroopsSatisfyAlternativeSolution(troopRoster, explanation);
```
