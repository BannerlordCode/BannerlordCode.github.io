...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 cel vassal or mercenary service offer 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 mercenary offer 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 vassal offer 实体并返回给调用方。
