<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `BannerBuilderColorSelectionVM`
- [← 本领域 / 返回 mission-ext](./)
- [↑ API 目录](../)
...
> 本页为自动生成的存根。`BannerBuilderColorSelectionVM` 是 `TaleWorlds.MountAndBlade.ViewModelCollection.BannerBuilder` 命名空间下的一个类 class。
