...
---
<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `GarrisonTroopsCampaignBehavior`
- [← 本领域 / 返回 campaign-ext](./)
- [↑ API 目录](../)
- [🏠 首页 v1.3.15](../../)
