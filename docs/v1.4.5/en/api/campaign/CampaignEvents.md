...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem/CampaignEvents.cs`
...
**Purpose:** Called when the `hero activated` event is raised.
...
**Purpose:** Handles logic related to `collect metadata entries`.
