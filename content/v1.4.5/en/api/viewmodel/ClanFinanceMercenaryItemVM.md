...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `ClanFinanceMercenaryItemVM`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.ClanManagement.ClanFinance/ClanFinanceMercenaryItemVM.cs`
