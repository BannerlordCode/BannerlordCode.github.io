...
**Purpose:** Reads and returns the default material value held by the this instance.
...
**Purpose:** Reads and returns the outline material value held by the this instance.
...
**Purpose:** Reads and returns the default tableau sample material value held by the this instance.
...
**Purpose:** Reads and returns the alpha mask tableau material value held by the this instance.
...
**Purpose:** Reads and returns the alpha blend mode value held by the this instance.
...
**Purpose:** Reads and returns the alpha test value value held by the this instance.
