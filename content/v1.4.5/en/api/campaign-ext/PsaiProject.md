...
**Purpose:** Executes the Report logic.
...
**Purpose:** Executes the ReconstructReferencesAfterXmlDeserialization logic.
...
**Purpose:** Executes the MergeProjects logic.
...
**Purpose:** Executes the ReconstructIds logic.
...
**Purpose:** Executes the DebugCheckProjectIntegrity logic.
...
**Purpose:** Reads and returns the segments of all themes value held by the this instance.
...
**Purpose:** Reads and returns the theme by id value held by the this instance.
...
**Purpose:** Reads and returns the snippet by id value held by the this instance.
...
**Purpose:** Reads and returns the group by serialization id value held by the this instance.
...
**Purpose:** Executes the DeleteMusicEntity logic.
...
**Purpose:** Reads and returns the highest segment id value held by the this instance.
...
**Purpose:** Reads and returns the next free snippet id value held by the this instance.
...
**Purpose:** Reads and returns the groups of all themes value held by the this instance.
...
**Purpose:** Verifies whether if snippet is manual bridge snippet for source group holds true for the this instance.
...
**Purpose:** Verifies whether if there is at least one bridge snippet from source group to target group holds true for the this instance.
...
**Purpose:** Verifies whether if snippet is manual bridge snippet to any group holds true for the this instance.
...
**Purpose:** Executes the DoUpdateAllParentThemeIdsAndGroupsOfChildPsaiEntities logic.
...
**Purpose:** Reads and returns the next free theme id value held by the this instance.
...
**Purpose:** Verifies whether if theme id is in use holds true for the this instance.
...
**Purpose:** Reads and returns the snippets by id value held by the this instance.
