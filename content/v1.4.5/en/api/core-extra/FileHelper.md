...
**Purpose:** Reads and returns the file full path value held by the this instance.
...
**Purpose:** Executes the FileExists logic.
...
**Purpose:** Reads and returns the file content string async value held by the this instance.
...
**Purpose:** Reads and returns the file content string value held by the this instance.
...
**Purpose:** Executes the DeleteFile logic.
...
**Purpose:** Reads and returns the meta data content value held by the this instance.
...
**Purpose:** Copies the file state of the this instance to a target.
...
**Purpose:** Copies the directory state of the this instance to a target.
