...
**Purpose:** Reads and returns the assignable party roles value held by the this instance.
...
**Purpose:** Reads and returns the relevant skill for party role value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the hero assignable for party role state or condition.
...
**Purpose:** Returns a boolean answer to whether hero have enough skill for party role is true for the this instance.
...
**Purpose:** Determines whether the this instance is in the hero assignable for party role in party state or condition.
