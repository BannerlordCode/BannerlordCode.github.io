...
**Base:** none
**File:** `TaleWorlds.Engine/FtlCapsuleData.cs`
...
**Purpose:** Reads and returns the `box min` value held by the current object.
...
**Purpose:** Reads and returns the `box max` value held by the current object.
