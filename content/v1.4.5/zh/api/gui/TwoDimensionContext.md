...
**用途 / Purpose:** 停止and remove sound event流程或状态机。
...
**用途 / Purpose:** 调用 PlaySoundEvent 对应的操作。
...
**用途 / Purpose:** 调用 BeginDebugPanel 对应的操作。
...
**用途 / Purpose:** 调用 EndDebugPanel 对应的操作。
...
**用途 / Purpose:** 调用 DrawDebugText 对应的操作。
...
**用途 / Purpose:** 调用 DrawDebugTreeNode 对应的操作。
...
**用途 / Purpose:** 调用 PopDebugTreeNode 对应的操作。
...
**用途 / Purpose:** 调用 DrawCheckbox 对应的操作。
