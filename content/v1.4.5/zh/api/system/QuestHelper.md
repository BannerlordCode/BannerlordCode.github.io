...
**用途 / Purpose:** 检查gold for alternative solution在当前对象中是否成立。
...
**用途 / Purpose:** 检查roster for alternative solution在当前对象中是否成立。
...
**用途 / Purpose:** 检查minor major coercion在当前对象中是否成立。
...
**用途 / Purpose:** 检查war declaration and fail or cancel the quest在当前对象中是否成立。
