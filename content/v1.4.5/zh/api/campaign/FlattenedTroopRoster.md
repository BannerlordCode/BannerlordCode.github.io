...
**用途 / Purpose:** **用途 / Purpose:** 生成unique no from party的实例、数据或表示。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的index of character。
...
**用途 / Purpose:** **用途 / Purpose:** 在 troop gain xp 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 将 troop x p 重置回默认或初始状态。
