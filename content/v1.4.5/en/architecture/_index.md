...
- [Developer roadmap](./developer-roadmap): connect SubModule, Campaign, Mission, UI, save, and Model/Action choices into dependency chains.
- [Noise and non-business type policy](./noise-policy): classify AutoGenerated, third-party, Native, and Provider types and return to stable managed entries.
- [SandBox/StoryMode/Native reading policy](./sandbox-native-policy): use reference modules to verify composition without treating story objects or engine bridges as daily APIs.
