...
**Purpose:** Reads and returns the `async key state` value held by the current object.
...
**Purpose:** Reads and returns the `d c` value held by the current object.
...
**Purpose:** Reads and returns the `cursor pos` value held by the current object.
...
**Purpose:** Determines whether the current object is in the `iconic` state or condition.
...
**Purpose:** Reads and returns the `desktop window` value held by the current object.
...
**Purpose:** Reads and returns the `client rect` value held by the current object.
...
**Purpose:** Reads and returns the `window rect` value held by the current object.
...
**Purpose:** Reads and returns the `monitor info` value held by the current object.
