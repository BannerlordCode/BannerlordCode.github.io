...
**Purpose:** Executes the FromParametersFile logic.
...
**Purpose:** Determines whether the this instance is in the same state or condition.
...
**Purpose:** Determines whether the this instance is in the older than state or condition.
...
**Purpose:** Determines whether the this instance is in the newer than state or condition.
...
**Purpose:** Executes the ApplicationVersionTypeFromString logic.
...
**Purpose:** Reads and returns the prefix value held by the this instance.
