...
**用途 / Purpose:** 调用 CPUBenchmarkMission 对应的操作。
...
**用途 / Purpose:** 调用 CPUBenchmark 对应的操作。
...
**用途 / Purpose:** 调用 BenchmarkStateStart 对应的操作。
...
**用途 / Purpose:** 调用 BenchmarkStateEnd 对应的操作。
...
**用途 / Purpose:** 打开c p u benchmark mission对应的资源或界面。
