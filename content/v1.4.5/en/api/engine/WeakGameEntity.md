...
**Purpose:** Executes the Invalidate logic.
...
**Purpose:** Reads and returns the script count value held by the this instance.
...
**Purpose:** Reads and returns the script at index value held by the this instance.
...
**Purpose:** Reads and returns the first script with name hash value held by the this instance.
...
**Purpose:** Executes the DeRegisterWaterMeshMaterials logic.
...
**Purpose:** Executes the ChangeResolutionMultiplierOfWaterVisual logic.
...
**Purpose:** Determines whether the this instance already holds batched kinematic physics flag.
...
**Purpose:** Determines whether the this instance already holds batched ray cast physics flag.
...
**Purpose:** Executes the DeRegisterWaterSDFClip logic.
...
**Purpose:** Executes the ComputeGlobalPhysicsBoundingBoxCenter logic.
...
**Purpose:** Reads and returns the attached navmesh face vertex indices value held by the this instance.
...
**Purpose:** Assigns a new value to cost adder for attached faces and updates the object's internal state.
...
**Purpose:** Executes the CollectChildrenEntitiesWithTagAsEnumarable logic.
...
**Purpose:** Reads and returns the global wind velocity with gust noise of scene value held by the this instance.
