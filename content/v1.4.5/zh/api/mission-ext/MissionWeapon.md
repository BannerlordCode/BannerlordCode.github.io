...
**用途 / Purpose:** 收集或汇总information from weapon到当前对象。
...
**用途 / Purpose:** 调用 ConsumeAmmo 对应的操作。
...
**用途 / Purpose:** 调用 ReloadAmmo 对应的操作。
...
**用途 / Purpose:** 调用 AttachWeapon 对应的操作。
