...
**Purpose:** Reads and returns the `tableau texture small for banner editor` value held by the current object.
...
**Purpose:** Reads and returns the `tableau texture large for banner editor` value held by the current object.
