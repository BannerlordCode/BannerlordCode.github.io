...
**Purpose:** Reads and returns the menu option text value held by the this instance.
...
**Purpose:** Reads and returns the game menu option value held by the this instance.
...
**Purpose:** Reads and returns the menu option text2 value held by the this instance.
...
**Purpose:** Reads and returns the menu option tooltip value held by the this instance.
...
**Purpose:** Reads and returns the menu option is leave value held by the this instance.
...
**Purpose:** Executes the RunOnTick logic.
...
**Purpose:** Executes the RunWaitMenuCondition logic.
...
**Purpose:** Executes the RunWaitMenuConsequence logic.
...
**Purpose:** Executes the RunMenuOptionConsequence logic.
...
**Purpose:** Executes the EndWait logic.
...
**Purpose:** Executes the RunOnInit logic.
...
**Purpose:** Executes the PreInit logic.
...
**Purpose:** Executes the AfterInit logic.
...
**Purpose:** Reads and returns the text value held by the this instance.
