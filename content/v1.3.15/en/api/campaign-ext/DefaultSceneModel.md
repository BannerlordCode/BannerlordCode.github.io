...
**Purpose:** Reads and returns the battle scene for map patch value held by the this instance.
...
**Purpose:** Reads and returns the conversation scene for map position value held by the this instance.
