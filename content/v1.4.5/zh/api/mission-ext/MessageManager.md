...
**用途 / Purpose:** **用途 / Purpose:** 调用 DisplayMultilineMessage 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EraseMessageLines 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 message manager 赋新值，并同步更新对象内部状态。
