...
**用途 / Purpose:** **用途 / Purpose:** 将 by bankruptcy 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by player buying 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by player selling 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 by war 的效果应用到当前对象。
