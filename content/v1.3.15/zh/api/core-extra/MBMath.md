...
**用途 / Purpose:** 调用 ApproximatelyEqualsTo 对应的操作。
...
**用途 / Purpose:** 调用 ApproximatelyEquals 对应的操作。
...
**用途 / Purpose:** 调用 ClampIndex 对应的操作。
...
**用途 / Purpose:** 调用 ClampFloat 对应的操作。
...
**用途 / Purpose:** 调用 LinearExtrapolation 对应的操作。
...
**用途 / Purpose:** 调用 LerpRadians 对应的操作。
...
**用途 / Purpose:** 调用 InverseLerp 对应的操作。
...
**用途 / Purpose:** 调用 SmoothStep 对应的操作。
...
**用途 / Purpose:** 调用 BilinearLerp 对应的操作。
...
**用途 / Purpose:** 调用 ClampAngle 对应的操作。
...
**用途 / Purpose:** 调用 WrapAngleSafe 对应的操作。
...
**用途 / Purpose:** 调用 ColorFromRGBA 对应的操作。
...
**用途 / Purpose:** 调用 GammaCorrectRGB 对应的操作。
...
**用途 / Purpose:** 调用 ProjectPointOntoLine 对应的操作。
...
**用途 / Purpose:** 调用 ClampToAxisAlignedRectangle 对应的操作。
...
**用途 / Purpose:** 调用 PointLiesAheadOfPlane 对应的操作。
...
**用途 / Purpose:** 检查line to line segment intersection在当前对象中是否成立。
...
**用途 / Purpose:** 调用 IntersectLineSegmentWithTriangle 对应的操作。
...
**用途 / Purpose:** 调用 IntersectLineSegmentWithBoundingBox 对应的操作。
...
**用途 / Purpose:** 检查line segment to line segment intersection在当前对象中是否成立。
...
**用途 / Purpose:** 检查point inside polygon在当前对象中是否成立。
...
**用途 / Purpose:** 检查polygon intersection在当前对象中是否成立。
...
**用途 / Purpose:** 检查polygon line segment intersection在当前对象中是否成立。
...
**用途 / Purpose:** 调用 IntersectRayWithPolygon 对应的操作。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的plane line intersection point with normal。
