...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `PropertyDataEnumerator`
...
**Type:** `public class PropertyDataEnumerator : IEnumerator`
**Base:** `IEnumerator`
**Area:** campaign-ext

## Overview

`PropertyDataEnumerator` lives in `System.Management`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
