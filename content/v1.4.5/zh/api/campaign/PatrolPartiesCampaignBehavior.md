...
description: "PatrolPartiesCampaignBehavior 的自动生成类参考。"
---
...
```csharp
// 先通过子系统 API 拿到 PatrolPartiesCampaignBehavior 实例
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 settlement patrol status 的结果。
