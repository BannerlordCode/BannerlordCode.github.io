...
**用途 / Purpose:** 设置 `blocker direction for faces with id` 的值或状态。
...
**用途 / Purpose:** 处理 `current frame tick entities` 事件或回调。
...
**用途 / Purpose:** 设置 `use advanced water rendering` 的值或状态。
