...
**Purpose:** Reads and returns the original state value held by the this instance.
...
**Purpose:** Executes the BurstHeavyHitParticles logic.
...
**Purpose:** Executes the PreDestroy logic.
