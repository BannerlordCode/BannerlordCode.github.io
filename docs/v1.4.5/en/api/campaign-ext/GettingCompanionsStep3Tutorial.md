<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `GettingCompanionsStep3Tutorial`
...
**File:** `Bannerlord.Source/Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/GettingCompanionsStep3Tutorial.cs`
...
```csharp
var value = new GettingCompanionsStep3Tutorial();
