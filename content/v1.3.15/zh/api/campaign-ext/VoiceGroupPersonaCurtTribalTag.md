...
description: "VoiceGroupPersonaCurtTribalTag 的自动生成类参考。"
---
...
**File:** `TaleWorlds.CampaignSystem/Conversation/Tags/VoiceGroupPersonaCurtTribalTag.cs`
...
```csharp
// 先通过子系统 API 拿到 VoiceGroupPersonaCurtTribalTag 实例
