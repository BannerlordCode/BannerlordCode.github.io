...
**Purpose:** Removes all g p u memory from the this instance.
...
**Purpose:** Executes the BeginParleyWith logic.
...
**Purpose:** Reads and returns the cursor intersection point value held by the this instance.
...
**Purpose:** Executes the RestartAmbientSounds logic.
...
**Purpose:** Executes the PauseAmbientSounds logic.
...
**Purpose:** Executes the DeletePeriodicUIEvent logic.
...
**Purpose:** Applies the effect of handler changes to to the this instance.
