...
description: "NavigateOnMapTutorialStep2 的自动生成类参考。"
---
...
**File:** `Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/NavigateOnMapTutorialStep2.cs`
...
```csharp
// 先通过子系统 API 拿到 NavigateOnMapTutorialStep2 实例
