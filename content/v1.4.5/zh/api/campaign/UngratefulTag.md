---
title: "UngratefulTag"
description: "UngratefulTag 的自动生成类参考。"
---
# UngratefulTag
...
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Conversation.Tags/UngratefulTag.cs`
...
```csharp
// 先通过子系统 API 拿到 UngratefulTag 实例
