...
**Base:** `IMapScene`
**File:** `Modules.SandBox/SandBox/Sandbox/MapScene.cs`
...
**Purpose:** Reads and returns the terrain size value held by the this instance.
...
**Purpose:** Reads and returns the scene level value held by the this instance.
...
**Purpose:** Reads and returns the atmosphere states value held by the this instance.
...
**Purpose:** Reads and returns the map borders value held by the this instance.
...
**Purpose:** Executes the DisableUnwalkableNavigationMeshes logic.
...
**Purpose:** Reads and returns the face index value held by the this instance.
...
**Purpose:** Reads and returns the terrain type at position value held by the this instance.
...
**Purpose:** Reads and returns the face terrain type value held by the this instance.
...
**Purpose:** Reads and returns the environment terrain types value held by the this instance.
...
**Purpose:** Reads and returns the environment terrain types count value held by the this instance.
...
**Purpose:** Reads and returns the map patch at position value held by the this instance.
...
**Purpose:** Reads and returns the navigation mesh center position value held by the this instance.
...
**Purpose:** Reads and returns the number of navigation mesh faces value held by the this instance.
...
**Purpose:** Reads and returns the face at index value held by the this instance.
...
**Purpose:** Reads and returns the face vertex z value held by the this instance.
...
**Purpose:** Reads and returns the ground normal value held by the this instance.
...
**Purpose:** Reads and returns the siege camp frames value held by the this instance.
...
**Purpose:** Reads and returns the terrain type name value held by the this instance.
...
**Purpose:** Reads and returns the scene xml crc value held by the this instance.
...
**Purpose:** Reads and returns the scene navigation mesh crc value held by the this instance.
...
**Purpose:** Reads and returns the wind at position value held by the this instance.
...
**Purpose:** Reads and returns the snow amount at position value held by the this instance.
...
**Purpose:** Reads and returns the rain amount at position value held by the this instance.
