...
**Purpose:** Reads and returns the base mesh value held by the this instance.
...
**Purpose:** Reads and returns the random mesh with vdecl value held by the this instance.
...
**Purpose:** Reads and returns the vector argument value held by the this instance.
...
**Purpose:** Reads and returns the second material value held by the this instance.
...
**Purpose:** Removes all mesh from the this instance.
...
**Purpose:** Reads and returns the face count value held by the this instance.
...
**Purpose:** Reads and returns the face corner count value held by the this instance.
...
**Purpose:** Executes the ComputeNormals logic.
...
**Purpose:** Reads and returns the bounding box width value held by the this instance.
...
**Purpose:** Reads and returns the bounding box height value held by the this instance.
...
**Purpose:** Executes the HintIndicesDynamic logic.
...
**Purpose:** Executes the HintVerticesDynamic logic.
...
**Purpose:** Reads and returns the edit data face corner vertex color value held by the this instance.
...
**Purpose:** Executes the DisableContour logic.
...
**Purpose:** Executes the LockEditDataWrite logic.
...
**Purpose:** Executes the UnlockEditDataWrite logic.
...
**Purpose:** Reads and returns the cloth linear velocity multiplier value held by the this instance.
...
**Purpose:** Determines whether the this instance already holds cloth.
