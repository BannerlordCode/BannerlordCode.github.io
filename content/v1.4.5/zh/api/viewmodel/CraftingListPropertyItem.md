...
description: "CraftingListPropertyItem 的自动生成类参考。"
---
...
**Base:** `ViewModel`
**File:** `bin/TaleWorlds.CampaignSystem.ViewModelCollection/TaleWorlds.CampaignSystem.ViewModelCollection.WeaponCrafting/CraftingListPropertyItem.cs`
...
```csharp
// 先通过子系统 API 拿到 CraftingListPropertyItem 实例
