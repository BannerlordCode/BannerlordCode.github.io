...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 face gen filter 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 haircut indices 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 facial hair indices 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 available stages 的结果。
