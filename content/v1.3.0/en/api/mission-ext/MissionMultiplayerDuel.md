...
**Purpose:** Verifies whether if player can despawn holds true for the this instance.
...
**Purpose:** Executes the DuelRequestReceived logic.
...
**Purpose:** Executes the DuelRequestAccepted logic.
...
**Purpose:** Reads and returns the duel area index if duel team value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the duel still valid state or condition.
...
**Purpose:** Determines whether the this instance is in the peer in this duel state or condition.
...
**Purpose:** Executes the IncreaseWinCount logic.
