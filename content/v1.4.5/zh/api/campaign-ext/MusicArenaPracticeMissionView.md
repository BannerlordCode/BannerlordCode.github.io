...
description: "MusicArenaPracticeMissionView 的自动生成类参考。"
---
...
**Base:** `MissionView`
**File:** `Modules.SandBox/SandBox.View/SandBox.View.Missions.Sound.Components/MusicArenaPracticeMissionView.cs`
...
```csharp
// 先通过子系统 API 拿到 MusicArenaPracticeMissionView 实例
...
**用途 / Purpose:** **用途 / Purpose:** 在 updated 事件触发时调用此回调。
