...
description: "PersonaIronicTag 的自动生成类参考。"
---
# PersonaIronicTag
...
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Conversation.Tags/PersonaIronicTag.cs`
...
```csharp
// 先通过子系统 API 拿到 PersonaIronicTag 实例
