...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的potential strength。
...
**用途 / Purpose:** 调用 OwnerClanEconomyEffectOnGarrisonSizeConstant 对应的操作。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的ideal garrison strength per walled center。
...
**用途 / Purpose:** 结束all related hostile actions of noble to faction流程并执行必要的收尾工作。
...
**用途 / Purpose:** 结束all related hostile actions of faction to faction流程并执行必要的收尾工作。
...
**用途 / Purpose:** 结束all related hostile actions流程并执行必要的收尾工作。
...
**用途 / Purpose:** 调用 AdjustFactionStancesForClanJoiningKingdom 对应的操作。
...
**用途 / Purpose:** 生成clan namefor player的实例、数据或表示。
...
**用途 / Purpose:** 调用 ChooseHeirClanForFiefs 对应的操作。
