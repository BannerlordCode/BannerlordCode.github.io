...
**用途 / Purpose:** 调用 WarmupEnding 对应的操作。
...
**用途 / Purpose:** 调用 PreparationStarted 对应的操作。
...
**用途 / Purpose:** 调用 FlagsXRemoved 对应的操作。
...
**用途 / Purpose:** 调用 FlagXRemaining 对应的操作。
...
**用途 / Purpose:** 调用 FlagsWillBeRemovedInXSeconds 对应的操作。
...
**用途 / Purpose:** 调用 FlagXCapturedByTeamX 对应的操作。
...
**用途 / Purpose:** 调用 GoldCarriedFromPreviousRound 对应的操作。
...
**用途 / Purpose:** 调用 PlayerIsInactive 对应的操作。
...
**用途 / Purpose:** 将ion auto follow enforced格式化为适合显示或存储的字符串。
...
**用途 / Purpose:** 调用 PollRejected 对应的操作。
...
**用途 / Purpose:** 调用 PlayerKicked 对应的操作。
