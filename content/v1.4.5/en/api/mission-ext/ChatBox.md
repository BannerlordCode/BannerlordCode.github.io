...
**Purpose:** Executes the SendMessageToAll logic.
...
**Purpose:** Executes the SendMessageToTeam logic.
...
**Purpose:** Executes the SendMessageToWhisperTarget logic.
...
**Purpose:** Executes the ServerSendServerMessageToEveryone logic.
...
**Purpose:** Determines whether the this instance is in the player muted from platform state or condition.
...
**Purpose:** Determines whether the this instance is in the player muted from game state or condition.
