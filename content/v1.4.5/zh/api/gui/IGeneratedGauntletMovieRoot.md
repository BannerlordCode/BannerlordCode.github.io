...
**Base:** 无
**File:** `bin/TaleWorlds.GauntletUI.Data/TaleWorlds.GauntletUI.Data/IGeneratedGauntletMovieRoot.cs`

## 概述

`IGeneratedGauntletMovieRoot` 位于 `TaleWorlds.GauntletUI.Data`，它通过这组公开成员把对应子系统的状态、行为或流程入口暴露给 mod 开发者。阅读时先看属性代表“它持有什么状态”，再看方法代表“它允许你做什么”。
...
```csharp
// 通常通过依赖注入或工厂方法获得实现
IIGeneratedGauntletMovieRoot service = ...;
```
