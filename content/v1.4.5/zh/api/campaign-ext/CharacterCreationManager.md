...
**用途 / Purpose:** 将character creation content handler注册到当前系统，以便后续监听或分发。
...
**用途 / Purpose:** 调用 DeleteNarrativeMenuWithId 对应的操作。
...
**用途 / Purpose:** 启动narrative stage流程或状态机。
