...
**用途 / Purpose:** 判断leader party and attached parties contain这一条件在当前对象上是否成立。
...
**用途 / Purpose:** 提升cohesion with influence的数值或强度。
...
**用途 / Purpose:** 重新计算army morale以反映最新状态。
...
**用途 / Purpose:** 结束army objective流程并执行必要的收尾工作。
