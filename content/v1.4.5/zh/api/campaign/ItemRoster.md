...
**用途 / Purpose:** 调用 RosterUpdatedEventDelegate 对应的操作。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的index of item。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的index。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的index first after xth element。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的index of element。
...
**用途 / Purpose:** 调用 RostersAreIdentical 对应的操作。
...
**用途 / Purpose:** 调用 SelectRandomIndex 对应的操作。
...
**用途 / Purpose:** 计算cached stats on load的当前值或结果。
