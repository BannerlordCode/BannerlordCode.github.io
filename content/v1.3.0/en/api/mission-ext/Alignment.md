...
`Alignment` lives in `TaleWorlds.MountAndBlade.View.Tableaus.Thumbnails`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
```csharp
Alignment example = Alignment.Center;
```
