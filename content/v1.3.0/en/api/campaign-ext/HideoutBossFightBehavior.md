...
**Purpose:** Reads and returns the player frames value held by the this instance.
...
**Purpose:** Reads and returns the boss frames value held by the this instance.
...
**Purpose:** Reads and returns the allies initial frame value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the world point inside camera volume state or condition.
...
**Purpose:** Executes the ClampWorldPointToCameraVolume logic.
