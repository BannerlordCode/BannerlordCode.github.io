...
**用途 / Purpose:** **用途 / Purpose:** 检查achievement system activity在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 在 radagos duel won 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 停用achievements对应的资源、状态或功能。
