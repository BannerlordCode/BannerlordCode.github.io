<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `ArtisanOverpricedGoodsIssueBehavior`
...
> This is an auto-generated stub. `ArtisanOverpricedGoodsIssueBehavior` is a class in the `TaleWorlds.CampaignSystem.Issues` namespace.
