...
**Purpose:** Executes the FillLocalValuesFrom logic.
...
**Purpose:** Reads and returns the visual scale value held by the this instance.
...
**Purpose:** Executes the DrawBoundingBox logic.
...
**Purpose:** Executes the DrawCorners logic.
...
**Purpose:** Reads and returns the cached origin value held by the this instance.
...
**Purpose:** Reads and returns the cached matrix frame value held by the this instance.
...
**Purpose:** Reads and returns the cached visual matrix frame value held by the this instance.
...
**Purpose:** Reads and returns the center value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the identical state or condition.
...
**Purpose:** Determines whether the this instance is in the sub rect of state or condition.
...
**Purpose:** Executes the TransformScreenPositionToLocal logic.
...
**Purpose:** Executes the TransformLocalPositionToScreen logic.
...
**Purpose:** Executes the DoRectanglesIntersect logic.
