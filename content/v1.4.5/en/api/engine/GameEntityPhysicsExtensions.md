...
**Purpose:** **Purpose:** Determines whether the this instance already holds body.
...
**Purpose:** **Purpose:** Adds sphere as body to the current collection or state.
...
**Purpose:** **Purpose:** Adds capsule as body to the current collection or state.
...
**Purpose:** **Purpose:** Recalculates and stores the latest representation of body rest offset.
...
**Purpose:** **Purpose:** Executes the PushCapsuleShapeToEntityBody logic.
...
**Purpose:** **Purpose:** Executes the PopCapsuleShapeFromEntityBody logic.
...
**Purpose:** **Purpose:** Removes physics from the current collection or state.
...
**Purpose:** **Purpose:** Reads and returns the physics state value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the physics triangle count value held by the this instance.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds physics definition without flags.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds physics body.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds dynamic rigid body.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds kinematic rigid body.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds static physics body.
...
**Purpose:** **Purpose:** Determines whether the this instance already holds dynamic rigid body and active simulation.
...
**Purpose:** **Purpose:** Constructs a new variable rate physics entity and returns it to the caller.
...
**Purpose:** **Purpose:** Assigns a new value to physics state and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to physics state only variable and updates the object's internal state.
...
**Purpose:** **Purpose:** Removes engine physics from the current collection or state.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the engine body sleeping state or condition.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the dynamic body stationary state or condition.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the dynamic body stationary m t state or condition.
...
**Purpose:** **Purpose:** Executes the ReplacePhysicsBodyWithQuadPhysicsBody logic.
...
**Purpose:** **Purpose:** Reads and returns the body shape value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to body shape and updates the object's internal state.
...
**Purpose:** **Purpose:** Adds physics to the current collection or state.
...
**Purpose:** **Purpose:** Assigns a new value to velocity limits and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to max depenetration velocity and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to solver iteration counts and updates the object's internal state.
...
**Purpose:** **Purpose:** Applies the effect of local impulse to dynamic body to the this instance.
...
**Purpose:** **Purpose:** Applies the effect of force to dynamic body to the this instance.
...
**Purpose:** **Purpose:** Applies the effect of global force at local pos to dynamic body to the this instance.
...
**Purpose:** **Purpose:** Applies the effect of torque to dynamic body to the this instance.
...
**Purpose:** **Purpose:** Applies the effect of local force at local pos to dynamic body to the this instance.
...
**Purpose:** **Purpose:** Applies the effect of acceleration to dynamic body to the this instance.
...
**Purpose:** **Purpose:** Executes the DisableDynamicBodySimulation logic.
...
**Purpose:** **Purpose:** Executes the DisableDynamicBodySimulationMT logic.
...
**Purpose:** **Purpose:** Converts dynamic body to ray cast into another representation or type.
...
**Purpose:** **Purpose:** Assigns a new value to physics move to batched and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the EnableDynamicBody logic.
...
**Purpose:** **Purpose:** Reads and returns the mass value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to mass and update inertia and center of mass and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to center of mass and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the mass space inertia value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the mass space inverse inertia value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to mass space inertia and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to damping and updates the object's internal state.
...
**Purpose:** **Purpose:** Assigns a new value to damping m t and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the DisableGravity logic.
...
**Purpose:** **Purpose:** Determines whether the this instance is in the gravity disabled state or condition.
...
**Purpose:** **Purpose:** Reads and returns the linear velocity value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to linear velocity and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the linear velocity m t value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the angular velocity value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the angular velocity m t value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to angular velocity and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the local physics bounding box value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the linear velocity at global point for entity with dynamic body value held by the this instance.
...
**Purpose:** **Purpose:** Executes the ComputeVelocityDeltaFromImpulse logic.
