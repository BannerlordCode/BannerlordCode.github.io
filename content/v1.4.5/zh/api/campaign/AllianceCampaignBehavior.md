...
**用途 / Purpose:** 调用 AutoGeneratedStaticCollectObjectsAlliance 对应的操作。
...
**用途 / Purpose:** 调用 AutoGeneratedStaticCollectObjectsCallToWarAgreement 对应的操作。
...
**用途 / Purpose:** 调用 EndAlliance 对应的操作。
...
**用途 / Purpose:** 启动call to war agreement流程或状态机。
...
**用途 / Purpose:** 调用 EndCallToWarAgreement 对应的操作。
...
**用途 / Purpose:** 调用 DenyCallToWarAgreement 对应的操作。
