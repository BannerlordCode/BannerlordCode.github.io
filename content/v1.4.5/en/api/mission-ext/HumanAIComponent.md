...
**Purpose:** Assigns a new value to scripted position and direction timed and updates the object's internal state.
...
**Purpose:** Executes the DisableTimedScriptedMovement logic.
