...
本页比较 `Agent` 在 **1.3.0 / 1.3.15 / 1.4.5** 三个版本的可访问 API 变化（public/protected/internal，不含 private），数据由 [`tools/class-version-diff.mjs`](https://github.com/BannerlordCode/BannerlordCode.github.io/tree/main/tools/class-version-diff.mjs) 从源码自动提取。该模块属于“精选跨版本对比”集合，而不是全站所有类型的全量对比表。

This page compares the accessible API of `Agent` across **1.3.0 / 1.3.15 / 1.4.5** (public/protected/internal, excluding private), extracted from source by `tools/class-version-diff.mjs`. It is part of a selected cross-version set, not a full matrix of every type in the site.
...
|------|------|------|
| v1.3.0 | 🇨🇳 中文 | [v1.3.0 Agent](/v1.3.0/zh/api/mission/Agent) |
| v1.3.0 | 🇬🇧 English | [v1.3.0 Agent](/v1.3.0/en/api/mission/Agent) |
| v1.3.15 | 🇨🇳 中文 | [v1.3.15 Agent](/v1.3.15/zh/api/mission/Agent) |
| v1.3.15 | 🇬🇧 English | [v1.3.15 Agent](/v1.3.15/en/api/mission/Agent) |
| v1.4.5 | 🇨🇳 中文 | [v1.4.5 Agent](/v1.4.5/zh/api/mission/Agent) |
| v1.4.5 | 🇬🇧 English | [v1.4.5 Agent](/v1.4.5/en/api/mission/Agent) |
