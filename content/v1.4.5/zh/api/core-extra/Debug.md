...
**用途 / Purpose:** **用途 / Purpose:** 调用 ReportMemoryBookmark 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintWarning 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintError 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DisplayDebugMessage 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 WatchVariable 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RenderDebugLineWithThickness 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 debug vector 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 debug vector 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 test mode enabled 赋新值，并同步更新对象内部状态。
