...
description: "PlayerIsNobleTag 的自动生成类参考。"
---
# PlayerIsNobleTag
...
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.Conversation.Tags/PlayerIsNobleTag.cs`
...
```csharp
// 先通过子系统 API 拿到 PlayerIsNobleTag 实例
