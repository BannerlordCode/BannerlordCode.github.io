...
description: "MercenaryJoinKingdomBarterable 的自动生成类参考。"
---
...
**Base:** `Barterable`
**File:** `TaleWorlds.CampaignSystem/BarterSystem/Barterables/MercenaryJoinKingdomBarterable.cs`
...
```csharp
// 先通过子系统 API 拿到 MercenaryJoinKingdomBarterable 实例
