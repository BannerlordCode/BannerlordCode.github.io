...
**Purpose:** Reads and returns the effects list value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the hero assignable for role state or condition.
