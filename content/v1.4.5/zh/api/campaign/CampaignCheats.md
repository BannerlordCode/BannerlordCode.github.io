...
**用途 / Purpose:** **用途 / Purpose:** 检查parameters在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 检查help在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 separated names 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ConcatenateString 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ImportMainHero 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ExportMainHero 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 crafting stamina 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 hero culture 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 clan culture 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 将 skill xp to hero 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintPlayerTrait 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 显示settlements对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 为 skills of given hero 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 隐藏settlements对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 为 skill main hero 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 skill companion 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 all skills of all companions 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 all hero skills 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 loyalty of settlement 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 prosperity of settlement 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 militia of settlement 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 security of settlement 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 food of settlement 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 hearth of settlement 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 显示hero relation对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 将 hero relation 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintMainPartyPosition 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 crafting materials 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 HealMainParty 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 item to player party 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DeclarePeace 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 influence 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 gold to hero 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 development 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 激活all policies对应的资源、状态或功能。
...
**用途 / Purpose:** **用途 / Purpose:** 为 player reputation trait 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GiveSettlementToPlayer 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GiveSettlementToKingdom 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 power to notable 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 LeadYourFaction 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintHeroesSuitableForMarriage 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MarryPlayerWithHero 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MarryHeroWithHero 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 hero suitable for marriage with player 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 player kingdom 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 构建一个新的 random clan 实体并返回给调用方。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 LeadKingdom 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 把若干kingdom连接成一个整体。
...
**用途 / Purpose:** **用途 / Purpose:** 把若干kingdom as mercenary连接成一个整体。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MakeTradeAgreement 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintCriminalRatings 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 main hero age 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 main party attackable 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 将 morale to party 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 提升cohesion of army的数值或强度。
...
**用途 / Purpose:** **用途 / Purpose:** 将 focus point cheat 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 attribute points cheat 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintSettlementsWithTournament 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 把list to multi line转换为另一种表示或类型。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintAllIssues 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GiveWorkshopToPlayer 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 MakePregnant 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 生成child的实例、数据或表示。
...
**用途 / Purpose:** **用途 / Purpose:** 将 prisoner to party 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 清空当前对象中的settlement defense。
...
**用途 / Purpose:** **用途 / Purpose:** 将 prisoners xp 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 为 hero trait 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 militias from settlement。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 cel quest cheat 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 KickCompanionFromParty 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 troops xp 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintGameplayStatistics 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 all armies and parties visible 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintStrengthOfLordParties 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ToggleInformationRestrictions 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 PrintStrengthOfFactions 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 将 supporters for main hero 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 为 campaign speed 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 显示hideouts对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 隐藏hideouts对应的界面或元素。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 UnlockCraftingPieces 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 rebellion enabled 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 将 troops to party 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 party suitable to use cheat 状态或条件。
