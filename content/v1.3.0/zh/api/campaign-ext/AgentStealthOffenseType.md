...
---
<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `AgentStealthOffenseType`
- [← 本领域 / 返回 campaign-ext](./)
- [↑ API 目录](../)
- [🏠 首页 v1.3.0](../../)
- [⭐ 版本架构](../../architecture/)
...
`AgentStealthOffenseType` 位于 `SandBox.ViewModelCollection.Missions.MainAgentDetection`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
