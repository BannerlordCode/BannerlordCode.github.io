...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 item total price 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 player accept trader offer 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 bought items 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 sold items 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 inventory capacity increase 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 can item increase inventory capacity 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 average price factor item category 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 player complete transaction 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 slaughter item 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 slaughterable 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 donate item 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 donatable 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 为 inventory listener 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 cost of item roster element 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 将 transfer command 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 将 transfer commands 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 检查item roster has element在当前对象中是否成立。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 equipment side 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 SlaughterItem 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DonateItem 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TransferOne 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 element count on side 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 elements in initial roster 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 elements in roster 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的item from side。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 TotalAmountChangeDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ProcessResultListDelegate 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 为 reference 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 equal 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 RecordTransaction 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 last transaction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 last transfer 的结果。
