...
**Purpose:** Reads and returns the `combined u long enum flags value` value held by the current object.
...
**Purpose:** Reads and returns the `combined u int enum flags value` value held by the current object.
