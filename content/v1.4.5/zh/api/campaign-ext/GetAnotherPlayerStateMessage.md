...
description: "GetAnotherPlayerStateMessage 的自动生成类参考。"
---
...
**Base:** `Message`
**File:** `bin/TaleWorlds.MountAndBlade.Diamond/Messages.FromClient.ToLobbyServer/GetAnotherPlayerStateMessage.cs`
