...
**用途 / Purpose:** 调用 hostile_action_village_on_init 对应的操作。
...
**用途 / Purpose:** 调用 wait_menu_raiding_village_on_tick 对应的操作。
...
**用途 / Purpose:** 调用 wait_menu_start_raiding_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 wait_menu_end_raiding_on_consequence 对应的操作。
...
**用途 / Purpose:** 调用 game_menu_village_raid_ended_menu_sound_on_init 对应的操作。
