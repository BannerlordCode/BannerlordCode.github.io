<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `CreateFreeMountAgent`
...
**File:** `Bannerlord.Source/bin/TaleWorlds.MountAndBlade/NetworkMessages.FromServer/CreateFreeMountAgent.cs`
...
```csharp
var example = new CreateFreeMountAgent();
```
