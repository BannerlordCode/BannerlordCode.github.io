...
**用途 / Purpose:** 调用 taking_food_from_villagers_wait_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 press_into_service_confirm_on_condition 对应的操作。
...
**用途 / Purpose:** 调用 taking_food_from_villagers_wait_on_tick 对应的操作。
...
**用途 / Purpose:** 调用 press_into_service_confirm_on_tick 对应的操作。
...
**用途 / Purpose:** 调用 taking_food_from_villagers_wait_on_consequence 对应的操作。
