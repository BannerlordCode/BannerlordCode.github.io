<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `EquipmentSetsTutorial`
...
**File:** `Bannerlord.Source/Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/EquipmentSetsTutorial.cs`
...
```csharp
var value = new EquipmentSetsTutorial();
