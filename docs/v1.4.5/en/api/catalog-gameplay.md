...
This page lists every public type in this area from the 1.4.5 source, grouped by namespace. **819** types total, **11** with a deep doc page (linked). Auto-generated by `tools/gen-class-catalog.mjs`.
...
| C | [AgentNavigator](/v1.3.15/en/api/mission-ext/AgentNavigator.md) | 🔗 |
