...
**用途 / Purpose:** 清空当前对象中的g p u memory。
...
**用途 / Purpose:** 关闭marriage offer popup对应的资源或界面。
...
**用途 / Purpose:** 调用 BeginParleyWith 对应的操作。
...
**用途 / Purpose:** 调用 FastMoveCameraToPosition 对应的操作。
...
**用途 / Purpose:** 调用 RestartAmbientSounds 对应的操作。
...
**用途 / Purpose:** 调用 PauseAmbientSounds 对应的操作。
...
**用途 / Purpose:** 调用 DeletePeriodicUIEvent 对应的操作。
...
**用途 / Purpose:** 打开encyclopedia对应的资源或界面。
...
**用途 / Purpose:** 打开save load对应的资源或界面。
...
**用途 / Purpose:** 关闭escape menu对应的资源或界面。
...
**用途 / Purpose:** 关闭gameplay cheats对应的资源或界面。
...
**用途 / Purpose:** 关闭campaign options对应的资源或界面。
...
**用途 / Purpose:** 打开facegen screen aux对应的资源或界面。
...
**用途 / Purpose:** 调用 FastMoveCameraToMainParty 对应的操作。
...
**用途 / Purpose:** 调用 TeleportCameraToMainParty 对应的操作。
