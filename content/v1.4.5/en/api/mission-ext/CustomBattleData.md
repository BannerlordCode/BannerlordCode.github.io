...
**Purpose:** Reads and returns the all attacker melee machines value held by the this instance.
...
**Purpose:** Reads and returns the all defender ranged machines value held by the this instance.
...
**Purpose:** Reads and returns the all attacker ranged machines value held by the this instance.
