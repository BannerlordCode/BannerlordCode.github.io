...
**用途 / Purpose:** 调用 LordWillConspireWithLord 对应的操作。
...
**用途 / Purpose:** 调用 UnderPlayerCommand 对应的操作。
...
**用途 / Purpose:** 调用 OrderHeroesOnPlayerSideByPriority 对应的操作。
...
**用途 / Purpose:** 调用 WillLordAttack 对应的操作。
...
**用途 / Purpose:** 调用 SpawnHeroForTheFirstTime 对应的操作。
...
**用途 / Purpose:** 调用 DefaultRelation 对应的操作。
...
**用途 / Purpose:** 调用 NPCPoliticalDifferencesWithNPC 对应的操作。
...
**用途 / Purpose:** 调用 NPCPersonalityClashWithNPC 对应的操作。
...
**用途 / Purpose:** 调用 TraitHarmony 对应的操作。
...
**用途 / Purpose:** 计算reliability constant的当前值或结果。
...
**用途 / Purpose:** 调用 HeroCanRecruitFromHero 对应的操作。
...
**用途 / Purpose:** 启动recruiting money limit流程或状态机。
...
**用途 / Purpose:** 启动recruiting money limit for clan leader流程或状态机。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的a suitable settlement to teleport for hero。
