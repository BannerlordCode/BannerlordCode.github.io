...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的point around position。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的reachable point around position。
...
**用途 / Purpose:** 在当前集合/范围内查找满足条件的point inside area。
