...
**用途 / Purpose:** 将 by transferring 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by trade 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by looting 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by production 的效果应用到当前对象。
...
**用途 / Purpose:** 将 by mobile party creation 的效果应用到当前对象。
