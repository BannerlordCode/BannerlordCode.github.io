...
**Type:** `public struct MissionInitializerRecord : ISerializableObject`
**Base:** `ISerializableObject`
**File:** `TaleWorlds.Core/MissionInitializerRecord.cs`
...
```csharp
var example = new MissionInitializerRecord();
```
