...
6. [Gauntlet UI System](./gauntlet-ui) - Creating custom UI with GauntletMovie, GauntletSystem, ScreenManager
7. [Mission System](./mission-system) - Mission, MissionBehavior, Agent, Formation, Team
8. [Campaign System](./campaign-system) - MobileParty, Kingdom, Clan, Settlement
9. [Save System](./save-system-guide) - Complete guide to v1.3.15's new SaveSystem
10. [Asset Pipeline](./asset-pipeline) - Adding custom meshes, textures, sounds
11. [Localization](./localization) - Multi-language support with MBTextManager
12. [Common Patterns](./common-patterns) - Bannerlord modding best practices
13. [Game Systems Overview](./game-systems-overview) - What can be customized
14. [Troubleshooting](./troubleshooting) - Expanded debug scenarios
...
- View [Gauntlet UI System](./gauntlet-ui) - Create custom interfaces
- View [Mission System](./mission-system) - Customize battles and missions
- View [Campaign System](./campaign-system) - Modify world map gameplay
- View [Save System](./save-system-guide) - Ensure your data saves correctly
