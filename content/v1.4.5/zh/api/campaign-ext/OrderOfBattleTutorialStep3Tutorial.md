...
description: "OrderOfBattleTutorialStep3Tutorial 的自动生成类参考。"
---
...
**File:** `Modules.StoryMode/StoryMode.GauntletUI/StoryMode.GauntletUI.Tutorial/OrderOfBattleTutorialStep3Tutorial.cs`
...
```csharp
// 先通过子系统 API 拿到 OrderOfBattleTutorialStep3Tutorial 实例
