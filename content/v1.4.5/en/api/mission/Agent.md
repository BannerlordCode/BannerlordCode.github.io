...
**Purpose:** Reads and returns the `base formation frame` value held by the current object.
...
**Purpose:** Checks whether the current object meets the preconditions for `perform brace`.
