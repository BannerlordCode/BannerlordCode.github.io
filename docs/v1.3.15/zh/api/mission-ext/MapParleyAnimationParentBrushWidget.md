<!-- BEGIN BREADCRUMB -->
**首页** → **API 目录** → **本领域** → `MapParleyAnimationParentBrushWidget`
- [← 本领域 / 返回 mission-ext](./)
- [↑ API 目录](../)
...
```csharp
// MapParleyAnimationParentBrushWidget (Widget) 的典型用法
// 声明/访问一个 MapParleyAnimationParentBrushWidget
var widget = root.GetChild("mapParleyAnimationParentBrushWidget");;
```
