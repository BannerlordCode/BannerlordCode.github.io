...
**Base:** none
**File:** `bin/TaleWorlds.CampaignSystem/Helpers/FactionHelper.cs`
...
**Purpose:** Reads and returns the enemy kingdoms value held by the this instance.
...
**Purpose:** Reads and returns the stances value held by the this instance.
...
**Purpose:** Reads and returns the power ratio to enemies value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the clan name applicable state or condition.
...
**Purpose:** Determines whether the this instance is in the kingdom name applicable state or condition.
...
**Purpose:** Reads and returns the power ratio to tribute payed kingdoms value held by the this instance.
...
**Purpose:** Checks whether the this instance meets the preconditions for clan be granted fief.
...
**Purpose:** Checks whether the this instance meets the preconditions for player enter faction.
...
**Purpose:** Reads and returns the total enemy kingdom power value held by the this instance.
...
**Purpose:** Reads and returns the total tribute payed kingdoms power value held by the this instance.
...
**Purpose:** Reads and returns the kingdom armies value held by the this instance.
...
**Purpose:** Executes the OwnerClanEconomyEffectOnGarrisonSizeConstant logic.
...
**Purpose:** Executes the AdjustFactionStancesForClanJoiningKingdom logic.
...
**Purpose:** Reads and returns the term used by other faction value held by the this instance.
...
**Purpose:** Reads and returns the formal name for faction culture value held by the this instance.
...
**Purpose:** Reads and returns the informal name for faction culture value held by the this instance.
...
**Purpose:** Reads and returns the adjective for faction culture value held by the this instance.
...
**Purpose:** Reads and returns the adjective for faction value held by the this instance.
...
**Purpose:** Reads and returns the distance to closest non ally fortification of faction value held by the this instance.
...
**Purpose:** Reads and returns the mid settlement of faction value held by the this instance.
...
**Purpose:** Reads and returns the possible kingdoms to declare war value held by the this instance.
...
**Purpose:** Reads and returns the possible kingdoms to declare peace value held by the this instance.
...
**Purpose:** Reads and returns the ally minor factions value held by the this instance.
...
**Purpose:** Executes the ChooseHeirClanForFiefs logic.
...
**Purpose:** Checks whether the this instance meets the preconditions for player offer mercenary service.
...
**Purpose:** Checks whether the this instance meets the preconditions for player offer vassalage.
...
**Purpose:** Determines whether the this instance is in the main clan member available for recall state or condition.
...
**Purpose:** Determines whether the this instance is in the main clan member available for party leader change state or condition.
...
**Purpose:** Determines whether the this instance is in the main clan member available for sending settlement state or condition.
...
**Purpose:** Determines whether the this instance is in the main clan member available for sending settlement as governor state or condition.
