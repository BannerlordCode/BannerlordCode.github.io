...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 companion with most kills 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 companion with most issues solved 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 most expensive item crafted 的结果。
