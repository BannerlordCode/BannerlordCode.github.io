...
**用途 / Purpose:** 处理与 「blend func separate delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「active texture delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「bind vertex array delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「gen vertex arrays delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「vertex attrib pointer delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「enable vertex attrib array delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「disable vertex attrib array delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「gen buffers delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「bind buffer delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「buffer data delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「buffer sub data delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「detach shader delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「delete shader delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「uniform4f delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「uniform1i delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「uniform1f delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「uniform2f delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「use program delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「delete program delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「link program delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「attach shader delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「compile shader delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「wgl create context attribs delegate」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「shader source」 相关的逻辑。
...
**用途 / Purpose:** 处理与 「uniform matrix4fv」 相关的逻辑。
