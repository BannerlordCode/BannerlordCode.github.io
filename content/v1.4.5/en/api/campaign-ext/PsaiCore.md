...
**Purpose:** Determines whether the this instance is in the instance initialized state or condition.
...
**Purpose:** Executes the ReturnToLastBasicMood logic.
...
**Purpose:** Executes the HoldCurrentIntensity logic.
...
**Purpose:** Reads and returns the version value held by the this instance.
...
**Purpose:** Reads and returns the volume value held by the this instance.
...
**Purpose:** Reads and returns the current intensity value held by the this instance.
...
**Purpose:** Reads and returns the psai info value held by the this instance.
...
**Purpose:** Reads and returns the soundtrack info value held by the this instance.
...
**Purpose:** Reads and returns the theme info value held by the this instance.
...
**Purpose:** Reads and returns the segment info value held by the this instance.
...
**Purpose:** Reads and returns the current segment id value held by the this instance.
...
**Purpose:** Reads and returns the current theme id value held by the this instance.
...
**Purpose:** Reads and returns the remaining milliseconds of current segment playback value held by the this instance.
...
**Purpose:** Reads and returns the remaining milliseconds until next segment start value held by the this instance.
...
**Purpose:** Executes the MenuModeEnter logic.
...
**Purpose:** Executes the MenuModeLeave logic.
...
**Purpose:** Executes the MenuModeIsActive logic.
...
**Purpose:** Executes the CutSceneIsActive logic.
...
**Purpose:** Executes the CutSceneEnter logic.
...
**Purpose:** Executes the CutSceneLeave logic.
...
**Purpose:** Executes the PlaySegment logic.
