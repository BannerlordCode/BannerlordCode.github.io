...
**Purpose:** **Purpose:** Adds skill bonus for skill level to the current collection or state.
...
**Purpose:** **Purpose:** Adds skill bonus for party to the current collection or state.
...
**Purpose:** **Purpose:** Adds skill bonus for town to the current collection or state.
...
**Purpose:** **Purpose:** Adds skill bonus for character to the current collection or state.
...
**Purpose:** **Purpose:** Reads and returns the effect description for skill level value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the effective party leader for skill value held by the this instance.
