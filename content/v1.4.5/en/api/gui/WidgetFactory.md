...
**Purpose:** Reads and returns the prefab names value held by the this instance.
...
**Purpose:** Reads and returns the widget types value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the builtin type state or condition.
...
**Purpose:** Reads and returns the builtin type value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the custom type state or condition.
...
**Purpose:** Reads and returns the custom type path value held by the this instance.
...
**Purpose:** Reads and returns the custom type value held by the this instance.
