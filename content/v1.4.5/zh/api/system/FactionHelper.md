...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的potential strength。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 enemy kingdoms 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 stances 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 power ratio to enemies 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 clan name applicable 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 kingdom name applicable 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 power ratio to tribute payed kingdoms 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 clan be granted fief 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 player enter faction 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 total enemy kingdom power 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 total tribute payed kingdoms power 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 kingdom armies 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 tlement prosperity effect on garrison size constant 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 为 tlement food potential effect on garrison size constant 赋新值，并同步更新对象内部状态。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 OwnerClanEconomyEffectOnGarrisonSizeConstant 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 在当前集合/范围内查找满足条件的ideal garrison strength per walled center。
...
**用途 / Purpose:** **用途 / Purpose:** 结束all related hostile actions of noble to faction流程并执行必要的收尾工作。
...
**用途 / Purpose:** **用途 / Purpose:** 结束all related hostile actions of faction to faction流程并执行必要的收尾工作。
...
**用途 / Purpose:** **用途 / Purpose:** 结束all related hostile actions流程并执行必要的收尾工作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AdjustFactionStancesForClanJoiningKingdom 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 term used by other faction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 formal name for faction culture 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 informal name for faction culture 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 adjective for faction culture 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 adjective for faction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 生成clan namefor player的实例、数据或表示。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 distance to closest non ally fortification of faction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 mid settlement of faction 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 possible kingdoms to declare war 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 possible kingdoms to declare peace 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 ally minor factions 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ChooseHeirClanForFiefs 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 player offer mercenary service 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 检查当前对象是否满足 player offer vassalage 的前置条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 main clan member available for recall 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 main clan member available for party leader change 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 main clan member available for sending settlement 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 main clan member available for sending settlement as governor 状态或条件。
