...
| `CurrentMortalityState` | `public MortalityState CurrentMortalityState { get; }` |
...
| `AIStateFlags` | `public AIStateFlag AIStateFlags { get; set; }` |
| `Frame` | `public MatrixFrame Frame { get; }` |
| `MovementFlags` | `public MovementControlFlag MovementFlags { get; set; }` |
...
| `CurrentWatchState` | `public WatchState CurrentWatchState { get; }` |
...
| `EventControlFlags` | `public EventControlFlag EventControlFlags { get; set; }` |
...
**Purpose:** Reads and returns the has on ai input set callback value held by the this instance.
...
**Purpose:** Reads and returns the missile range with height difference aux value held by the this instance.
...
**Purpose:** Reads and returns the sound and collision info class name value held by the this instance.
...
**Purpose:** Executes the DebugGetHealth logic.
...
**Purpose:** Determines whether the this instance is in the alarm state normal state or condition.
...
**Purpose:** Determines whether the this instance is in the cautious state or condition.
...
**Purpose:** Determines whether the this instance is in the patrolling cautious state or condition.
...
**Purpose:** Determines whether the this instance is in the alarmed state or condition.
...
**Purpose:** Executes the EndRagdollAsCorpse logic.
...
**Purpose:** Determines whether the this instance is in the added as corpse state or condition.
...
**Purpose:** Applies the effect of force on ragdoll to the this instance.
...
**Purpose:** Reads and returns the a i last suspicious position value held by the this instance.
...
**Purpose:** Reads and returns the a i move destination value held by the this instance.
...
**Purpose:** Reads and returns the a i move start tolerance value held by the this instance.
...
**Purpose:** Reads and returns the a i move stop tolerance value held by the this instance.
...
**Purpose:** Reads and returns the base formation frame value held by the this instance.

```csharp
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
var result = agent.GetBaseFormationFrame(formationPosition, formationDirection);
```

### IsAIAtMoveDestination
`public bool IsAIAtMoveDestination()`

**Purpose:** Determines whether the this instance is in the a i at move destination state or condition.
...
**Purpose:** Invoked when the conversation started event is raised.
...
**Purpose:** Determines whether the this instance is in the crouching allowed state or condition.
...
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.SetScriptedPositionAndDirection(scriptedPosition, 0, false, aIScriptedFrameFlags.None);
```
...
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.SetScriptedPosition(position, false, aIScriptedFrameFlags.None);
```
...
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.SetScriptedTargetEntity(target, aISpecialCombatModeFlags.None, false);
```
...
**Purpose:** Reads and returns the firing order value held by the this instance.
...
**Purpose:** Reads and returns the riding order value held by the this instance.
...
**Purpose:** Reads and returns the selected mount index value held by the this instance.
...
**Purpose:** Reads and returns the target formation index value held by the this instance.
...
**Purpose:** Reads and returns the battle importance value held by the this instance.
...
**Purpose:** Reads and returns the traits mask value held by the this instance.
...
**Purpose:** Reads and returns the target position value held by the this instance.
...
**Purpose:** Reads and returns the target direction value held by the this instance.
...
**Purpose:** Reads and returns the aiming timer value held by the this instance.
...
**Purpose:** Reads and returns the interaction distance to usable value held by the this instance.
...
**Purpose:** Reads and returns the primary wielded item index value held by the this instance.
...
**Purpose:** Reads and returns the offhand wielded item index value held by the this instance.
...
**Purpose:** Reads and returns the maximum forward unlimited speed value held by the this instance.
...
**Purpose:** Reads and returns the weapon entity from equipment slot value held by the this instance.
...
**Purpose:** Reads and returns the retreat pos value held by the this instance.
...
**Purpose:** Reads and returns the scripted flags value held by the this instance.
...
**Purpose:** Reads and returns the scripted combat flags value held by the this instance.
...
**Purpose:** Reads and returns the stepped entity value held by the this instance.
...
**Purpose:** Reads and returns the stepped root entity value held by the this instance.
...
**Purpose:** Reads and returns the stepped body flags value held by the this instance.
...
**Purpose:** Reads and returns the current animation flag value held by the this instance.
...
**Purpose:** Reads and returns the current action value held by the this instance.
...
**Purpose:** Reads and returns the current action type value held by the this instance.
...
**Purpose:** Reads and returns the current action stage value held by the this instance.
...
**Purpose:** Reads and returns the current action direction value held by the this instance.
...
**Purpose:** Reads and returns the current action priority value held by the this instance.
...
**Purpose:** Reads and returns the current action progress value held by the this instance.
...
**Purpose:** Reads and returns the action channel weight value held by the this instance.
...
**Purpose:** Reads and returns the action channel current action weight value held by the this instance.
...
**Purpose:** Reads and returns the world frame value held by the this instance.
...
**Purpose:** Reads and returns the look down limit value held by the this instance.
...
**Purpose:** Reads and returns the eye global height value held by the this instance.
...
**Purpose:** Reads and returns the maximum speed limit value held by the this instance.
...
**Purpose:** Reads and returns the current velocity value held by the this instance.
...
**Purpose:** Reads and returns the turn speed value held by the this instance.
...
**Purpose:** Reads and returns the current speed limit value held by the this instance.
...
**Purpose:** Reads and returns the real global velocity value held by the this instance.
...
**Purpose:** Reads and returns the average real global velocity value held by the this instance.
...
**Purpose:** Reads and returns the movement direction value held by the this instance.
...
**Purpose:** Reads and returns the cur weapon offset value held by the this instance.
...
**Purpose:** Reads and returns the is left stance value held by the this instance.
...
**Purpose:** Reads and returns the path distance to point value held by the this instance.
...
**Purpose:** Reads and returns the current navigation face id value held by the this instance.
...
**Purpose:** Reads and returns the world position value held by the this instance.
...
**Purpose:** Reads and returns the ground material for collision effect value held by the this instance.
...
**Purpose:** Reads and returns the look agent value held by the this instance.
...
**Purpose:** Reads and returns the target agent value held by the this instance.
...
**Purpose:** Reads and returns the agent flags value held by the this instance.
...
**Purpose:** Reads and returns the agent facial animation value held by the this instance.
...
**Purpose:** Reads and returns the agent voice definition value held by the this instance.
...
**Purpose:** Reads and returns the eye global position value held by the this instance.
...
**Purpose:** Reads and returns the chest global position value held by the this instance.
...
**Purpose:** Reads and returns the defend movement flag value held by the this instance.
...
**Purpose:** Reads and returns the attack direction value held by the this instance.
...
**Purpose:** Reads and returns the wielded weapon info value held by the this instance.
...
**Purpose:** Reads and returns the body rotation constraint value held by the this instance.
...
**Purpose:** Reads and returns the total encumbrance value held by the this instance.
...
**Purpose:** Reads and returns the total mass value held by the this instance.
...
**Purpose:** Reads and returns the agent driven property value value held by the this instance.
...
**Purpose:** Reads and returns the stepped machine value held by the this instance.
...
**Purpose:** Reads and returns the attached weapon bone index value held by the this instance.
...
**Purpose:** Executes the DeleteAttachedWeapon logic.
...
**Purpose:** Determines whether the this instance already holds ranged weapon.
...
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
var result = agent.GetBoneEntitialFrame(0, false);
```

### GetFormationFileAndRankInfo
`public void GetFormationFileAndRankInfo(out int fileIndex, out int rankIndex)`

**Purpose:** Reads and returns the formation file and rank info value held by the this instance.
...
**Purpose:** Executes the ToggleInvulnerable logic.
...
**Purpose:** Reads and returns the arm length value held by the this instance.
...
**Purpose:** Reads and returns the arm weight value held by the this instance.
...
**Purpose:** Reads and returns the running simulation data until maximum speed reached value held by the this instance.
...
**Purpose:** Reads and returns the base armor effectiveness for body part value held by the this instance.
...
**Purpose:** Reads and returns the last target visibility state value held by the this instance.
...
**Purpose:** Reads and returns the missile range value held by the this instance.
...
**Purpose:** Reads and returns the weapon to replace on quick action value held by the this instance.
...
**Purpose:** Reads and returns the assisting hitter value held by the this instance.
...
**Purpose:** Checks whether the this instance meets the preconditions for reach agent.
...
**Purpose:** Checks whether the this instance meets the preconditions for interact with agent.
...
**Purpose:** Checks whether the this instance meets the preconditions for be assigned for scripted movement.
...
**Purpose:** Checks whether the this instance meets the preconditions for reach and use object.
...
**Purpose:** Checks whether the this instance meets the preconditions for reach object.
...
**Purpose:** Checks whether the this instance meets the preconditions for reach object from position.
...
**Purpose:** Checks whether the this instance meets the preconditions for use object.
...
**Purpose:** Checks whether the this instance meets the preconditions for move directly to position.
...
**Purpose:** Checks whether the this instance meets the preconditions for interactable weapon be picked up.
...
**Purpose:** Checks whether the this instance meets the preconditions for quick pick up.
...
**Purpose:** Checks whether the this instance meets the preconditions for teleport.
...
**Purpose:** Determines whether the this instance is in the retreating state or condition.
...
**Purpose:** Determines whether the this instance is in the fading out state or condition.
...
**Purpose:** Determines whether the this instance is in the on land state or condition.
...
**Purpose:** Determines whether the this instance is in the in water state or condition.
...
**Purpose:** Determines whether the this instance is in the able to use machine state or condition.
...
**Purpose:** Determines whether the this instance is in the agent parent entity same as state or condition.
...
**Purpose:** Determines whether the this instance is in the sliding state or condition.
...
**Purpose:** Determines whether the this instance is in the sitting state or condition.
...
**Purpose:** Determines whether the this instance is in the releasing chain attack in multiplayer state or condition.
...
**Purpose:** Determines whether the this instance is in the camera attachable state or condition.
...
**Purpose:** Determines whether the this instance is in the synched prefab component visible state or condition.
...
**Purpose:** Reads and returns the distance to value held by the this instance.
...
**Purpose:** Verifies whether path to a i target agent passes through navigation face id from direction holds true for the this instance.
...
**Purpose:** Determines whether the this instance is in the target navigation face id between state or condition.
...
**Purpose:** Verifies whether equipment for cape cloth simulation state change holds true for the this instance.
...
**Purpose:** Verifies whether to drop flagged item holds true for the this instance.
...
**Purpose:** Verifies whether skill for mounting holds true for the this instance.
...
**Purpose:** Executes the ForceUpdateCachedAndFormationValues logic.
...
**Purpose:** Recalculates and stores the latest representation of direction change tendency.
...
**Purpose:** Executes the InvalidateTargetAgent logic.
...
**Purpose:** Executes the InvalidateAIWeaponSelections logic.
...
**Purpose:** Removes all target frame from the this instance.
...
**Purpose:** Removes all equipment from the this instance.
...
**Purpose:** Removes all hand inverse kinematics from the this instance.
...
**Purpose:** Removes all attached weapons from the this instance.
...
**Purpose:** Attempts to retrieve set formation frame, usually returning success through an out parameter.

```csharp
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
var result = agent.TrySetFormationFrame(formationPosition, formationDirection);
```

### EnforceShieldUsage
`public void EnforceShieldUsage(UsageDirection shieldDirection)`

**Purpose:** Executes the EnforceShieldUsage logic.
...
**Purpose:** Executes the ObjectHasVacantPosition logic.
...
**Purpose:** Executes the InteractingWithAnyGameObject logic.
...
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.StopUsingGameObjectMT(false, stopUsingGameObjectFlags.AutoAttachAfterStoppingUsingGameObject);
```
...
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.StopUsingGameObject(false, stopUsingGameObjectFlags.AutoAttachAfterStoppingUsingGameObject);
```
...
**Purpose:** Checks whether the this instance meets the preconditions for thrust attack stick to bone.
...
**Purpose:** Reads and returns the old wielded item info value held by the this instance.
...
**Purpose:** Executes the UseGameObject logic.
...
**Purpose:** Determines whether the this instance is in the wandering state or condition.
...
**Purpose:** Reads and returns the render check enabled value held by the this instance.
...
**Purpose:** Executes the ComputeAnimationDisplacement logic.
...
**Purpose:** Executes the LockAgentReplicationTableDataWithCurrentReliableSequenceNo logic.
...
**Purpose:** Executes the TeleportToPosition logic.
...
**Purpose:** Executes the DisableScriptedMovement logic.
...
**Purpose:** Executes the DisableScriptedCombatMovement logic.
...
**Purpose:** Executes the ForceAiBehaviorSelection logic.
...
**Purpose:** Determines whether the this instance already holds path through navigation face id from direction m t.
...
**Purpose:** Determines whether the this instance already holds path through navigation face id from direction.
...
**Purpose:** Executes the DisableLookToPointOfInterest logic.
...
**Purpose:** Executes the YellAfterDelay logic.
...
**Purpose:** Executes the WieldNextWeapon logic.

```csharp
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.WieldNextWeapon(weaponIndex, weaponWieldActionType.WithAnimation);
```

### AttackDirectionToMovementFlag
`public MovementControlFlag AttackDirectionToMovementFlag(UsageDirection direction)`

**Purpose:** Executes the AttackDirectionToMovementFlag logic.
...
**Purpose:** Executes the DefendDirectionToMovementFlag logic.
...
**Purpose:** Executes the KickClear logic.
...
**Purpose:** Executes the PlayerAttackDirection logic.
...
**Purpose:** Executes the DropItem logic.
...
**Purpose:** Executes the EquipItemsFromSpawnEquipment logic.
...
**Purpose:** Executes the WieldInitialWeapons logic.

```csharp
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.WieldInitialWeapons(weaponWieldActionType.InstantAfterPickUp, taleWorlds.Core.Equipment.InitialWeaponEquipPreference.Any);
```

### ChangeWeaponHitPoints
`public void ChangeWeaponHitPoints(EquipmentIndex slotIndex, short hitPoints)`

**Purpose:** Executes the ChangeWeaponHitPoints logic.
...
**Purpose:** Executes the AttachWeaponToBone logic.
...
**Purpose:** Executes the RestoreShieldHitPoints logic.
...
**Purpose:** Executes the Die logic.

```csharp
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
agent.Die(b, killInfo.Invalid);
```

### MakeDead
`public void MakeDead(bool isKilled, ActionIndexCache actionIndex, int corpsesToFadeIndex = -1)`

**Purpose:** Executes the MakeDead logic.
...
**Purpose:** Executes the Mount logic.
...
**Purpose:** Executes the EquipWeaponToExtraSlotAndWield logic.
...
**Purpose:** Executes the EquipWeaponWithNewEntity logic.
...
**Purpose:** Executes the EquipWeaponFromSpawnedItemEntity logic.
...
**Purpose:** Executes the WillDropWieldedShield logic.
...
**Purpose:** Executes the HadSameTypeOfConsumableOrShieldOnSpawn logic.
...
**Purpose:** Determines whether the this instance already holds lost shield.
...
**Purpose:** Checks whether the this instance meets the preconditions for perform brace.

```csharp
// Obtain an instance of Agent from the subsystem API first
Agent agent = ...;
var result = agent.CanPerformBrace();
```
...
**Purpose:** Executes the YellingBehaviour logic.
...
**Purpose:** Determines whether the this instance already holds path through navigation faces i d from direction.
...
**Purpose:** Determines whether the this instance already holds path through navigation faces i d from direction m t.
...
**Purpose:** Removes all target z from the this instance.
...
**Purpose:** Reads and returns the action direction value held by the this instance.
...
**Purpose:** Reads and returns the monster usage index value held by the this instance.
...
**Purpose:** Reads and returns the sound parameter for armor type value held by the this instance.
