...
**用途 / Purpose:** **用途 / Purpose:** 将 tournament 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 从当前容器或状态中移除 tournament。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 tournament game 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 在 player join match 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 player join tournament 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 player watch tournament 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 player win match 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 在 player win tournament 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 leaderboard 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 leader board rank 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 leader board leader 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 为 leaderboard entry 初始化必要的资源、状态或绑定。
...
**用途 / Purpose:** **用途 / Purpose:** 将 leaderboard entry 添加到当前容器或状态中。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 DeleteLeaderboardEntry 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 ResolveTournament 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 GivePrizeToWinner 对应的操作。
