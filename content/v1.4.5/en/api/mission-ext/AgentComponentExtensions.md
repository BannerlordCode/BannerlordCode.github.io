...
**Purpose:** **Purpose:** Reads and returns the morale value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to morale and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the ChangeMorale logic.
...
**Purpose:** **Purpose:** Stops the retreating morale component flow or state machine.
...
**Purpose:** **Purpose:** Assigns a new value to a i behavior values and updates the object's internal state.
...
**Purpose:** **Purpose:** Executes the AIMoveToGameObjectEnable logic.
...
**Purpose:** **Purpose:** Executes the AIMoveToGameObjectDisable logic.
...
**Purpose:** **Purpose:** Executes the AIMoveToGameObjectIsEnabled logic.
...
**Purpose:** **Purpose:** Executes the AIDefendGameObjectEnable logic.
...
**Purpose:** **Purpose:** Executes the AIDefendGameObjectDisable logic.
...
**Purpose:** **Purpose:** Executes the AIDefendGameObjectIsEnabled logic.
...
**Purpose:** **Purpose:** Executes the AIInterestedInAnyGameObject logic.
...
**Purpose:** **Purpose:** Executes the AIInterestedInGameObject logic.
...
**Purpose:** **Purpose:** Executes the AIUseGameObjectEnable logic.
...
**Purpose:** **Purpose:** Executes the AIUseGameObjectDisable logic.
...
**Purpose:** **Purpose:** Executes the AIUseGameObjectIsEnabled logic.
...
**Purpose:** **Purpose:** Reads and returns the followed unit value held by the this instance.
...
**Purpose:** **Purpose:** Assigns a new value to followed unit and updates the object's internal state.
