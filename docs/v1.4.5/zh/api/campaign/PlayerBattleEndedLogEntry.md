...
**Base:** `LogEntry`
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.LogEntries/PlayerBattleEndedLogEntry.cs`
...
```csharp
var value = new PlayerBattleEndedLogEntry();
