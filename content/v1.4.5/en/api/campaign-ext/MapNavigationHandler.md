...
**Purpose:** Reads and returns the elements value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the any element active state or condition.
...
**Purpose:** Reads and returns the element value held by the this instance.
