...
description: "WorkshopsCharactersCampaignBehavior 的自动生成类参考。"
---
...
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CampaignBehaviors/WorkshopsCharactersCampaignBehavior.cs`
...
```csharp
// 先通过子系统 API 拿到 WorkshopsCharactersCampaignBehavior 实例
