...
**用途 / Purpose:** **用途 / Purpose:** 调用 conversation_town_or_village_escort_complete_on_condition 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 conversation_town_or_village_escort_complete_on_consequence 对应的操作。
