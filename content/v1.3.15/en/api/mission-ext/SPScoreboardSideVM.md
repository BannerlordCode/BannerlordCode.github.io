...
**Purpose:** Reads and returns the party add if not exists value held by the this instance.
...
**Purpose:** Reads and returns the party value held by the this instance.
...
**Purpose:** Reads and returns the ship add if not exists value held by the this instance.
