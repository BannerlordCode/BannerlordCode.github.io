...
description: "ProposeCallToWarAgreementDecision 的自动生成类参考。"
---
...
```csharp
// 先通过子系统 API 拿到 ProposeCallToWarAgreementDecision 实例
...
// 先通过子系统 API 拿到 ProposeCallToWarAgreementDecision 实例
ProposeCallToWarAgreementDecision proposeCallToWarAgreementDecision = ...;
var result = proposeCallToWarAgreementDecision.CanMakeDecision(reason, false);
```
...
ProposeCallToWarAgreementDecision proposeCallToWarAgreementDecision = ...;
proposeCallToWarAgreementDecision.GetDecisionTitle();
```
