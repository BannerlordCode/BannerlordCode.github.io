...
**Base:** `MissionObject`
**File:** `Bannerlord.Source/Modules.SandBox/SandBox/SandBox.Objects/DynamicPatrolAreaParent.cs`

## Overview

`DynamicPatrolAreaParent` lives in `SandBox.Objects` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
