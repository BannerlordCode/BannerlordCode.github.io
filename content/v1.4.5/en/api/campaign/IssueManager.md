...
**Purpose:** Executes the ChangeIssueOwner logic.
...
**Purpose:** Verifies whether for issues holds true for the this instance.
...
**Purpose:** Determines whether the this instance is in the there active issue with type in settlement state or condition.
...
**Purpose:** Reads and returns the num of available issues in settlement value held by the this instance.
...
**Purpose:** Reads and returns the num of active issues in settlement value held by the this instance.
...
**Purpose:** Verifies whether issue for menu locations holds true for the this instance.
...
**Purpose:** Executes the ToggleAllIssueTracks logic.
...
**Purpose:** Determines whether the this instance already holds issue cool down.
...
**Purpose:** Executes the FillIssueCountsPerSettlement logic.
...
**Purpose:** Reads and returns the issues in settlement value held by the this instance.
...
**Purpose:** Reads and returns the issue of quest value held by the this instance.
...
**Purpose:** Executes the FillIssueCountsPerClan logic.
