...
**File:** `bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CampaignBehaviors/MapTracksCampaignBehavior.cs`
...
**用途 / Purpose:** 调用 RequestTrack 对应的操作。
...
**用途 / Purpose:** 调用 RequestMapArrow 对应的操作。
...
**用途 / Purpose:** 调用 ReleaseTrack 对应的操作。
...
MapTracksCampaignBehavior mapTracksCampaignBehavior = ...;
mapTracksCampaignBehavior.RequestTrack(party, trackPosition, trackDirection);
```
