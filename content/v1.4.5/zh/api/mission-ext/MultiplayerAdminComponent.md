...
**用途 / Purpose:** 调用 ChangeAdminMenuActiveState 对应的操作。
...
**用途 / Purpose:** 调用 GlobalMuteUnmutePlayer 对应的操作。
...
**用途 / Purpose:** 调用 ChangeWelcomeMessage 对应的操作。
...
**用途 / Purpose:** 调用 AdminAnnouncement 对应的操作。
...
**用途 / Purpose:** 调用 AdminEndMission 对应的操作。
...
**用途 / Purpose:** 调用 MPAdminAnnouncement 对应的操作。
...
**用途 / Purpose:** 调用 MPAdminKickPlayer 对应的操作。
...
**用途 / Purpose:** 调用 MPAdminBanPlayer 对应的操作。
...
**用途 / Purpose:** 调用 MPAdminChangeWelcomeMessage 对应的操作。
...
**用途 / Purpose:** 调用 MPAdminChangeClassRestriction 对应的操作。
...
**用途 / Purpose:** 调用 MPHostRestartGame 对应的操作。
...
**用途 / Purpose:** 调用 MPAdminChangeServerSlots 对应的操作。
