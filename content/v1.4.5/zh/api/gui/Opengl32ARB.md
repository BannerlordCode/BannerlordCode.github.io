...
**用途 / Purpose:** 调用 BlendFuncSeparateDelegate 对应的操作。
...
**用途 / Purpose:** 调用 ActiveTextureDelegate 对应的操作。
...
**用途 / Purpose:** 调用 BindVertexArrayDelegate 对应的操作。
...
**用途 / Purpose:** 调用 GenVertexArraysDelegate 对应的操作。
...
**用途 / Purpose:** 调用 VertexAttribPointerDelegate 对应的操作。
...
**用途 / Purpose:** 调用 EnableVertexAttribArrayDelegate 对应的操作。
...
**用途 / Purpose:** 调用 DisableVertexAttribArrayDelegate 对应的操作。
...
**用途 / Purpose:** 调用 GenBuffersDelegate 对应的操作。
...
**用途 / Purpose:** 调用 BindBufferDelegate 对应的操作。
...
**用途 / Purpose:** 调用 BufferDataDelegate 对应的操作。
...
**用途 / Purpose:** 调用 BufferSubDataDelegate 对应的操作。
...
**用途 / Purpose:** 调用 DetachShaderDelegate 对应的操作。
...
**用途 / Purpose:** 调用 DeleteShaderDelegate 对应的操作。
...
**用途 / Purpose:** 调用 Uniform4fDelegate 对应的操作。
...
**用途 / Purpose:** 调用 Uniform1iDelegate 对应的操作。
...
**用途 / Purpose:** 调用 Uniform1fDelegate 对应的操作。
...
**用途 / Purpose:** 调用 Uniform2fDelegate 对应的操作。
...
**用途 / Purpose:** 调用 UseProgramDelegate 对应的操作。
...
**用途 / Purpose:** 调用 DeleteProgramDelegate 对应的操作。
...
**用途 / Purpose:** 调用 LinkProgramDelegate 对应的操作。
...
**用途 / Purpose:** 调用 AttachShaderDelegate 对应的操作。
...
**用途 / Purpose:** 调用 CompileShaderDelegate 对应的操作。
...
**用途 / Purpose:** 调用 wglCreateContextAttribsDelegate 对应的操作。
