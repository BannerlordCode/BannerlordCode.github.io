...
description: "Auto-generated class reference for CommentOnChangeRomanticStateBehavior."
---
...
**File:** `TaleWorlds.CampaignSystem/CampaignBehaviors/CommentBehaviors/CommentOnChangeRomanticStateBehavior.cs`

## Overview

`CommentOnChangeRomanticStateBehavior` lives in `TaleWorlds.CampaignSystem.CampaignBehaviors.CommentBehaviors` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
```csharp
// Obtain an instance of CommentOnChangeRomanticStateBehavior from the subsystem API first
