...
**Purpose:** Reads and returns the localized name value held by the this instance.
...
**Purpose:** Reads and returns the troop usage flags value held by the this instance.
...
**Purpose:** Reads and returns the troop type for regular formation value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the default formation class state or condition.
...
**Purpose:** Determines whether the this instance is in the regular formation class state or condition.
...
**Purpose:** Executes the FallbackClass logic.
