...
**Purpose:** **Purpose:** Reads and returns the base formation frame value held by the this instance.
...
**Purpose:** **Purpose:** Invoked when the conversation started event is raised.
...
**Purpose:** **Purpose:** Assigns a new value to scripted target entity and updates the object's internal state.
...
**Purpose:** **Purpose:** Reads and returns the ground material for collision effect value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the total mass value held by the this instance.
...
**Purpose:** **Purpose:** Recalculates and stores the latest representation of direction change tendency.
...
**Purpose:** **Purpose:** Attempts to retrieve attach to formation, usually returning success through an out parameter.
...
**Purpose:** **Purpose:** Attempts to retrieve remove all detachment scores, usually returning success through an out parameter.
...
**Purpose:** **Purpose:** Attempts to retrieve set formation frame, usually returning success through an out parameter.
...
**Purpose:** **Purpose:** Assigns a new value to is physics force closed and updates the object's internal state.
...
**Purpose:** **Purpose:** Checks whether the this instance meets the preconditions for perform brace.
...
**Purpose:** **Purpose:** Reads and returns the sound parameter for armor type value held by the this instance.
