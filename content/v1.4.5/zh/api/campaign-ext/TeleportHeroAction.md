...
**用途 / Purpose:** **用途 / Purpose:** 将 immediate teleport to settlement 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 immediate teleport to party 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 immediate teleport to party as party leader 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 delayed teleport to settlement 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 delayed teleport to party 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 delayed teleport to settlement as governor 的效果应用到当前对象。
...
**用途 / Purpose:** **用途 / Purpose:** 将 delayed teleport to party as party leader 的效果应用到当前对象。
