...
**Base:** none
**File:** `Bannerlord.Source/bin/TaleWorlds.CampaignSystem/TaleWorlds.CampaignSystem.CharacterCreationContent/CharacterCreationContent.cs`
...
value.TryGetEquipmentIdDelegate("example", equipmentId);
```
