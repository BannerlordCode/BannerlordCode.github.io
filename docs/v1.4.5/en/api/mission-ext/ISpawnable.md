<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `ISpawnable`
...
**Type:** `class`
**Base:** none
**File:** `Bannerlord.Source/bin/TaleWorlds.MountAndBlade/TaleWorlds.MountAndBlade.Objects.Siege/ISpawnable.cs`
...
```csharp
ISpawnable implementation = GetSpawnableImplementation();
```
