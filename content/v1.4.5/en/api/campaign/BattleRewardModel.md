...
**Purpose:** Reads and returns the capture member chances for winner parties value held by the this instance.
...
**Purpose:** Checks whether the this instance meets the preconditions for troop be taken prisoner.
