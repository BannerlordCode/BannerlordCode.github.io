...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `RecruitmentAgentSpawnBehavior`
...
**File:** `Bannerlord.Source/Modules.SandBox/SandBox/SandBox.CampaignBehaviors/RecruitmentAgentSpawnBehavior.cs`
