...
**File:** `Modules.StoryMode/StoryMode/StoryMode.GameComponents.CampaignBehaviors/StoryModeTutorialBoxCampaignBehavior.cs`
...
**用途 / Purpose:** **用途 / Purpose:** 在 reset all tutorials 事件触发时调用此回调。
