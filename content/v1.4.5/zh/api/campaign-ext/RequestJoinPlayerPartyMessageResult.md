...
description: "RequestJoinPlayerPartyMessageResult 的自动生成类参考。"
---
...
**Base:** `FunctionResult`
**File:** `bin/TaleWorlds.MountAndBlade.Diamond/Messages.FromLobbyServer.ToClient/RequestJoinPlayerPartyMessageResult.cs`
