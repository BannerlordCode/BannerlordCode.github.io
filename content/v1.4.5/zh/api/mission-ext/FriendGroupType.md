...
**类型:** `public enum FriendGroupType`
**领域:** mission-ext

## 概述

`FriendGroupType` 位于 `TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Lobby.Friends`，它的公开成员表明它是这一子系统暴露给 mod 的一个正式扩展或数据入口。
