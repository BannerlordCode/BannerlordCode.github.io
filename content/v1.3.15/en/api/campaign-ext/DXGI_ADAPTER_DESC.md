...
---
<!-- BEGIN BREADCRUMB -->
**Home** → **API Index** → **Area** → `DXGI_ADAPTER_DESC`
...
`DXGI_ADAPTER_DESC` lives in `TaleWorlds.TwoDimension.Standalone.Native.Windows`, and its public surface shows that it acts as a formal extension or data entry point for this subsystem.
...
DXGI_ADAPTER_DESC.CreateDXGIFactory(riid, factory);
```
