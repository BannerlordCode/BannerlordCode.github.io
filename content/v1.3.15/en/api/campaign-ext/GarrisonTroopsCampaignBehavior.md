...
**Purpose:** **Purpose:** Reads and returns the troops to leave data for army value held by the this instance.
...
**Purpose:** **Purpose:** Reads and returns the troops to take data for army value held by the this instance.
