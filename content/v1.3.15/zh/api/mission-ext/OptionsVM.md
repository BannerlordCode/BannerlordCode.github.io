...
**用途 / Purpose:** 执行 「close options」 对应的操作或工作流。
...
**用途 / Purpose:** 读取并返回当前对象中 「active category」 的结果。
...
**用途 / Purpose:** 读取并返回当前对象中 「index of category」 的结果。
...
**用途 / Purpose:** 判断当前对象是否处于 「options changed」 状态或条件。
