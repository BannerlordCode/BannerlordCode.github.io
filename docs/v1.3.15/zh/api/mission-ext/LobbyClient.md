...
**用途 / Purpose:** 处理 `join channel` 相关逻辑。
...
**用途 / Purpose:** 处理 `leave channel` 相关逻辑。
...
**用途 / Purpose:** 获取 `other players state` 的当前值。
