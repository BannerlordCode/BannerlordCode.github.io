...
**用途 / Purpose:** **用途 / Purpose:** 在 call to war agreement proposed by player kingdom 事件触发时调用此回调。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 ally with kingdom 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 启动alliance流程或状态机。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EndAlliance 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 判断当前对象是否处于 at war by call to war agreement 状态或条件。
...
**用途 / Purpose:** **用途 / Purpose:** 启动call to war agreement流程或状态机。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 EndCallToWarAgreement 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 读取并返回当前对象中 kingdoms to call to war against 的结果。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AutoGeneratedStaticCollectObjectsAlliance 对应的操作。
...
**用途 / Purpose:** **用途 / Purpose:** 调用 AutoGeneratedStaticCollectObjectsCallToWarAgreement 对应的操作。
