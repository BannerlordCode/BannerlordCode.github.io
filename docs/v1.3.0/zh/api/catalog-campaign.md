...
本页列出 1.3.0 源码中该领域全部公开类型，按命名空间分组。共 **1822** 个类型，其中 **1789** 个已有深度文档页（带链接）。由 `tools/gen-class-catalog.mjs` 从源码自动生成。
...
| C | [MapEventResultExplainer](/v1.3.15/zh/api/campaign-ext/MapEventResultExplainer.md) | 🔗 |
