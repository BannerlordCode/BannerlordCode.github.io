...
**Purpose:** Determines whether the this instance is in the cached inventory tableau scene used state or condition.
...
**Purpose:** Reads and returns the cached inventory tableau scene value held by the this instance.
...
**Purpose:** Executes the ReturnCachedInventoryTableauScene logic.
...
**Purpose:** Determines whether the this instance is in the cached map conversation tableau scene used state or condition.
...
**Purpose:** Reads and returns the cached map conversation tableau scene value held by the this instance.
...
**Purpose:** Executes the ReturnCachedMapConversationTableauScene logic.
...
**Purpose:** Reads and returns the number of pending requests value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the native memory cleared state or condition.
...
**Purpose:** Executes the ReleaseSandboxValues logic.
...
**Purpose:** Executes the DestroyTexture logic.
...
**Purpose:** Executes the ForceClearAllCache logic.
...
**Purpose:** Reads and returns the cached hero silhouette texture value held by the this instance.
...
**Purpose:** Removes all unused cache from the this instance.
