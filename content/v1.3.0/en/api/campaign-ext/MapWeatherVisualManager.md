...
**Purpose:** Reads and returns the rain prefab from pool value held by the this instance.
...
**Purpose:** Reads and returns the blizzard prefab from pool value held by the this instance.
...
**Purpose:** Executes the ReleaseRainPrefab logic.
...
**Purpose:** Executes the ReleaseBlizzardPrefab logic.
