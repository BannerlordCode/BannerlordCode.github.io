...
**Purpose:** Reads and returns the agent from index value held by the this instance.
...
**Purpose:** Reads and returns the m b team from team index value held by the this instance.
...
**Purpose:** Reads and returns the team from team index value held by the this instance.
...
**Purpose:** Reads and returns the mission object from mission object id value held by the this instance.
...
**Purpose:** Reads and returns the combat log data for combat log network message value held by the this instance.
...
**Purpose:** Executes the ComputeTroopBodyPropertiesDelegate logic.
...
**Purpose:** Removes all resources from the this instance.
...
**Purpose:** Executes the ConversationCharacterChanged logic.
...
**Purpose:** Reads and returns the average fps value held by the this instance.
...
**Purpose:** Reads and returns the fall avoid system active value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the position inside boundaries state or condition.
...
**Purpose:** Determines whether the this instance is in the position inside hard boundaries state or condition.
...
**Purpose:** Determines whether the this instance is in the position inside any blocker nav mesh face2 d state or condition.
...
**Purpose:** Determines whether the this instance is in the position on any blocker nav mesh face state or condition.
...
**Purpose:** Executes the RayCastForClosestAgent logic.
...
**Purpose:** Executes the RayCastForClosestAgentsLimbs logic.
...
**Purpose:** Executes the RayCastForGivenAgentsLimbs logic.
...
**Purpose:** Reads and returns the biggest agent collision padding value held by the this instance.
...
**Purpose:** Executes the MakeSound logic.
...
**Purpose:** Executes the MakeSoundOnlyOnRelatedPeer logic.
...
**Purpose:** Reads and returns the missile collision point value held by the this instance.
...
**Purpose:** Reads and returns the missile vertical aim correction value held by the this instance.
...
**Purpose:** Reads and returns the closest boundary position value held by the this instance.
...
**Purpose:** Reads and returns the free runtime mission object id value held by the this instance.
...
**Purpose:** Reads and returns the free scene mission object id value held by the this instance.
...
**Purpose:** Reads and returns the camera frame value held by the this instance.
...
**Purpose:** Reads and returns the requested time speed value held by the this instance.
...
**Purpose:** Removes all agent actions from the this instance.
...
**Purpose:** Removes all missiles from the this instance.
...
**Purpose:** Removes all corpses from the this instance.
...
**Purpose:** Determines whether the this instance is in the agent in proximity map state or condition.
...
**Purpose:** Removes all unreferenced resources from the this instance.
...
**Purpose:** Reads and returns the main agent max camera zoom value held by the this instance.
...
**Purpose:** Reads and returns the best slope towards direction value held by the this instance.
...
**Purpose:** Reads and returns the best slope angle height pos for defending value held by the this instance.
...
**Purpose:** Reads and returns the average position of agents value held by the this instance.
...
**Purpose:** Reads and returns the weighted point of enemies value held by the this instance.
...
**Purpose:** Reads and returns the path between positions value held by the this instance.
...
**Purpose:** Reads and returns the straight path to target value held by the this instance.
...
**Purpose:** Executes the SkipForwardMissionReplay logic.
...
**Purpose:** Reads and returns the debug agent value held by the this instance.
...
**Purpose:** Reads and returns the first person fov value held by the this instance.
...
**Purpose:** Reads and returns the water level at position m t value held by the this instance.
...
**Purpose:** Checks whether the this instance meets the preconditions for physics collide between two entities.
...
**Purpose:** Reads and returns the removed agent ratio for side value held by the this instance.
...
**Purpose:** Reads and returns the attacker weapons for friendly fire preventing value held by the this instance.
...
**Purpose:** Reads and returns the alternate position for navmeshless or out of bounds position value held by the this instance.
...
**Purpose:** Reads and returns the next dynamic nav mesh id start value held by the this instance.
...
**Purpose:** Reads and returns the agent troop class value held by the this instance.
...
**Purpose:** Reads and returns the closest flee position for agent value held by the this instance.
...
**Purpose:** Reads and returns the closest flee position for formation value held by the this instance.
...
**Purpose:** Reads and returns the flee positions for side value held by the this instance.
...
**Purpose:** Executes the ForceDisableOcclusion logic.
...
**Purpose:** Executes the RetreatMission logic.
...
**Purpose:** Executes the SurrenderMission logic.
...
**Purpose:** Executes the SpawnAttachedWeaponOnCorpse logic.
...
**Purpose:** Executes the SpawnWeaponAsDropFromMissile logic.
...
**Purpose:** Executes the SpawnWeaponAsDropFromAgentAux logic.
...
**Purpose:** Executes the SpawnAttachedWeaponOnSpawnedWeapon logic.
...
**Purpose:** Executes the SpawnWeaponWithNewEntity logic.
...
**Purpose:** Executes the SpawnWeaponWithNewEntityAux logic.
...
**Purpose:** Executes the AttachWeaponWithNewEntityToSpawnedWeapon logic.
...
**Purpose:** Reads and returns the current volume generator version value held by the this instance.
...
**Purpose:** Executes the MakeEnemiesFleeCheat logic.
...
**Purpose:** Executes the MakeTeamFleeCheat logic.
...
**Purpose:** Executes the EnableSpeedAdjustmentCommand logic.
...
**Purpose:** Reads and returns the mission end time in seconds value held by the this instance.
...
**Purpose:** Reads and returns the mission end timer value value held by the this instance.
...
**Purpose:** Reads and returns the member count of side value held by the this instance.
...
**Purpose:** Reads and returns the initial spawn path value held by the this instance.
...
**Purpose:** Reads and returns the initial spawn path data value held by the this instance.
...
**Purpose:** Reads and returns the troop spawn frame with index value held by the this instance.
...
**Purpose:** Reads and returns the formation spawn frame value held by the this instance.
...
**Purpose:** Reads and returns the spawn path frame value held by the this instance.
...
**Purpose:** Reads and returns the formation spawn position value held by the this instance.
...
**Purpose:** Reads and returns the formation spawn class value held by the this instance.
...
**Purpose:** Executes the SpawnAgent logic.
...
**Purpose:** Executes the SpawnMonster logic.
...
**Purpose:** Executes the SpawnTroop logic.
...
**Purpose:** Executes the ReplaceBotWithPlayer logic.
...
**Purpose:** Executes the EndMission logic.
...
**Purpose:** Determines whether the this instance is in the agent interaction allowed state or condition.
...
**Purpose:** Determines whether the this instance is in the order gestures enabled state or condition.
...
**Purpose:** Determines whether the this instance is in the player close to an enemy state or condition.
...
**Purpose:** Reads and returns the random position around point value held by the this instance.
...
**Purpose:** Reads and returns the closest enemy agent value held by the this instance.
...
**Purpose:** Reads and returns the closest ally agent value held by the this instance.
...
**Purpose:** Reads and returns the nearby enemy agent count value held by the this instance.
...
**Purpose:** Determines whether the this instance already holds any agents of side in range.
...
**Purpose:** Executes the AgentLookingAtAgent logic.
...
**Purpose:** Reads and returns the under attack type of agents value held by the this instance.
...
**Purpose:** Reads and returns the agent team value held by the this instance.
...
**Purpose:** Reads and returns the team value held by the this instance.
...
**Purpose:** Reads and returns the teams of side value held by the this instance.
...
**Purpose:** Executes the ComputeSpawnPathDeploymentOffset logic.
...
**Purpose:** Reads and returns the movement type of agents value held by the this instance.
...
**Purpose:** Checks whether the this instance meets the preconditions for agent rout.
...
**Purpose:** Executes the KillAgentsOnEntity logic.
...
**Purpose:** Executes the KillAgentCheat logic.
...
**Purpose:** Executes the KillCheats logic.
...
**Purpose:** Checks whether the this instance meets the preconditions for take control of agent.
...
**Purpose:** Executes the TakeControlOfAgent logic.
...
**Purpose:** Reads and returns the shoot difficulty value held by the this instance.
...
**Purpose:** Reads and returns the nearby ally agents count value held by the this instance.
...
**Purpose:** Reads and returns the nearby ally agents value held by the this instance.
...
**Purpose:** Reads and returns the nearby enemy agents value held by the this instance.
...
**Purpose:** Reads and returns the nearby agents value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the formation unit position available m t state or condition.
...
**Purpose:** Determines whether the this instance is in the order position available state or condition.
...
**Purpose:** Determines whether the this instance is in the formation unit position available state or condition.
...
**Purpose:** Determines whether the this instance already holds scene map patch.
...
**Purpose:** Reads and returns the patch scene encounter position value held by the this instance.
...
**Purpose:** Reads and returns the patch scene encounter direction value held by the this instance.
...
**Purpose:** Verifies whether if battle in retreat holds true for the this instance.
...
**Purpose:** Executes the KillNAllies logic.
...
**Purpose:** Executes the KillAllAllies logic.
...
**Purpose:** Executes the ToggleDisableDying logic.
...
**Purpose:** Executes the ToggleDisableDyingTeam logic.
...
**Purpose:** Executes the KillAgent logic.
...
**Purpose:** Executes the IncreaseBatteringRamSpeeds logic.
...
**Purpose:** Executes the IncreaseSiegeTowerSpeed logic.
