...
description: "Auto-generated class reference for Mat2BasicTypeSerializer."
---
...
`Mat2BasicTypeSerializer` lives in `TaleWorlds.SaveSystem.Definition` and exposes the state, behavior, or workflow entry points of that subsystem to mod developers through its public members. Read its properties as “what state it owns” and its methods as “what actions it allows”.
...
Mat2BasicTypeSerializer instance = ...;
```
