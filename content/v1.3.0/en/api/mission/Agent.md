...
**Purpose:** Executes the UndetachAndAttachToFormation logic.
...
**Purpose:** Executes the UndetachAndStopUsingObjects logic.
...
**Purpose:** Reads and returns the random pair of real blood burst bone indices value held by the this instance.
