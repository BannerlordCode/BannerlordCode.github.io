...
**Purpose:** Reads and returns the depth value held by the this instance.
...
**Purpose:** Executes the CacheTokens logic.
...
**Purpose:** Reads and returns the empty value held by the this instance.
...
**Purpose:** Determines whether the this instance is in the null or empty state or condition.
...
**Purpose:** Determines whether the this instance already holds same value.
...
**Purpose:** Reads and returns the variable value value held by the this instance.
...
**Purpose:** Reads and returns the value hash code value held by the this instance.
...
**Purpose:** Copies the text object state of the this instance to a target.
...
**Purpose:** Reads and returns the i d value held by the this instance.
