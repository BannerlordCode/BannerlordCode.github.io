...
description: "RecruitmentAgentSpawnBehavior 的自动生成类参考。"
---
...
**File:** `Modules.SandBox/SandBox/SandBox.CampaignBehaviors/RecruitmentAgentSpawnBehavior.cs`
...
```csharp
// 先通过子系统 API 拿到 RecruitmentAgentSpawnBehavior 实例
